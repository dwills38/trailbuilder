...
var BMX_PARTS = [
  ...
  },
  {
    ...
    weight: 1532, price: 549.99, status: 'discontinued',
  ...
  },
  {
    ...
    note: 'vocab-tier1 (2026-07-22): closes the "Speedline fork/headset tiers the flags blocked" item. FETCHED supercrossbmx.com/pages/carbon-forks-compared directly (Speedline\'s own authorized storefront comparison page) — its own spec table states verbatim: "Speedline Elite Carbon | Junior / Expert | Mini-Expert | 1\\" Full Carbon | — | 300g | 3/8\\" | 20\\", 24\\" Cruiser | $349.95" -> steerer:integrated-1 (this file\'s newly-ratified bare-1in-bore token), axle:10mm (this catalog\'s established 3/8in=10mm mapping, no new token needed per the explicit out-of-scope ruling on a separate 3/8in token), weight 300g, price $349.95 exact. This row models the 20" size (the 24" Cruiser size shares the same weight/price per the table\'s single row). brakeMount:v-brake is an INFERRED same-tier sample matching this catalog\'s other race-discipline forks (Chase RSP, Redline Forklift Pro) — not independently confirmed on the fetched page, which describes only the carbon construction and steerer/dropout/weight facts. Left unverified: brakeMount is inferred, not maker-page-direct. NOTE: this pass\'s companion "Tapered Carbon Pro" fork (deferred here for lack of a ratified 20mm axle token) IS now entered below — see bmx-fk-speedline-tapered-carbon-pro-20mm — now that catalog/bmx-race-data-1 (c7a267d0) ratified BMX_VOCAB.axle 15mm/20mm.'
  },
  {
    id: 'bmx-fk-speedline-elite-carbon-pro-20mm', cat: 'fork', brand: 'Speedline', model: 'Elite Carbon Pro (20mm Dropouts)',
    discipline: 'race', wheelSize: '20', steerer: 'integrated-1-1/8', axle: '20mm',
    brakeMount: 'v-brake', weight: 409, price: 349.95,
    verified: true, priceBasis: 'msrp-confirmed', lastChecked: '2026-07-23',
    source: 'https://supercrossbmx.com/pages/carbon-forks-compared',
    note: 'catalog/bmx-race-forks-1 (2026-07-23): closes audit-wave-2026-07-23 finding M3 (bmx-fw-answer-holeshotpro-20 - a 20mm-axle front wheel - had zero 20mm forks to pair with). FETCHED supercrossbmx.com/pages/carbon-forks-compared directly (Speedline Parts\' own storefront, same domain/page already used for the sibling Junior/Expert row above) - its table states verbatim: "Speedline Elite Carbon | Pro - 20mm Dropouts | Pro | 1 1/8\\" Full Carbon | — | 409g | 20mm | 20\\", 24\\" Cruiser | $349.95" -> steerer:integrated-1-1/8, axle:20mm exact, weight 409g, price $349.95 exact. This row models the 20" size (24" Cruiser shares the table\'s single weight/price row). brakeMount:v-brake is the SAME inferred same-tier convention as the sibling Speedline/Chase RSP fork rows above (not independently confirmed - the comparison table covers only steerer/offset/weight/dropout/price, no brand in this whole fork category publishes brake-mount info in these tables). PROBE (paired against bmx-fw-answer-holeshotpro-20): checkBmxBuild({fork:this, frontWheel:"bmx-fw-answer-holeshotpro-20"}) - the front-axle-mismatch error (bmx-axle, 20mm hub vs prior-only-10mm forks) no longer fires; both are axle:20mm exact match, so rule BMX-9 stays silent (equal-axle case).'
  },
  {
    id: 'bmx-fk-speedline-tapered-carbon-pro-20mm', cat: 'fork', brand: 'Speedline', model: 'Tapered Carbon Pro (Nanocarbon)',
    discipline: 'race', wheelSize: '20', steerer: 'integrated-tapered-1-1/8-1.5', axle: '20mm',
    brakeMount: 'v-brake', weight: 453, price: 399.95,
    verified: true, priceBasis: 'msrp-confirmed', lastChecked: '2026-07-23',
    source: 'https://supercrossbmx.com/pages/carbon-forks-compared',
    note: 'catalog/bmx-race-forks-1 (2026-07-23): the fork the vocab-tier1 pass (2026-07-22) found and deferred for lack of a ratified 20mm axle token - now entered since catalog/bmx-race-data-1 (c7a267d0) ratified BMX_VOCAB.axle 15mm/20mm. Same source page, table states verbatim: "Speedline Tapered Carbon | Pro - Nanocarbon | Pro | Tapered 1 1/8\\"–1.5\\" Full Carbon | 28mm | 453g | 20mm | 20\\", 24\\", 26\\" | $399.95" -> steerer:integrated-tapered-1-1/8-1.5 (this catalog\'s ratified tapered token), axle:20mm exact, weight 453g, price $399.95 exact. brakeMount:v-brake is the same inferred same-tier convention as its siblings (see note above) - not independently confirmed.'
  },
  {
    id: 'bmx-fk-answer-dagger-os20-20mm', cat: 'fork', brand: 'Answer', model: 'Dagger Carbon Fork OS20 (20mm)',
    discipline: 'race', wheelSize: '20', steerer: 'integrated-1-1/8', axle: '20mm',
    brakeMount: 'v-brake', weight: 618, price: 359.99,
    verified: true, priceBasis: 'msrp-confirmed', lastChecked: '2026-07-23',
    source: 'https://answerbmx.com/product/20mm-dagger-carbon-forks/',
    note: 'catalog/bmx-race-forks-1 (2026-07-23): second maker closing audit-wave-2026-07-23 finding M3 (a real 20mm-axle race fork to pair with bmx-fw-answer-holeshotpro-20, itself an Answer-brand wheel). FETCHED answerbmx.com/product/20mm-dagger-carbon-forks/ directly (Answer\'s own storefront) via the browser pane (WebFetch/Exa both returned only the thin related-products shell on this WooCommerce theme, confirmed by cross-checking the site\'s own wp-json REST endpoint) - its own "Size" variant list offers "20\\" Black 20mm / 20\\" Matte Black 20mm / 24\\" Black 20mm / 24\\" Matte Black 20mm / OS20 Black 20mm / OS20 Matte Black 20mm" at $359.99, and its Description tab states verbatim "Weights: OS20 20mm – 1LB 5.8oz" (converts to 618g) alongside a separate "Pro 24\\" 20mm – Weight: 23oz" line for the 24\\" size only. This row models the OS20 (oversize, 1-1/8\\" steerer) variant specifically -> steerer:integrated-1-1/8 (OS20 = the 1-1/8\\" oversize tier per this brand\'s own OS-prefix convention, cross-confirmed against J&R Bicycles\' matching SKU "Answer Dagger Pro Carbon BMX Race Fork-20in-1 1-8in-20mm" and Source BMX\'s "Pro 1-1/8\\"" variant listing for the same Dagger line), axle:20mm exact, weight:618 (maker-stated 1LB 5.8oz for this exact variant), price $359.99 exact maker figure. brakeMount:v-brake is the same catalog-wide inferred same-tier convention used on every other race fork row (Chase RSP, Speedline) - not independently confirmed; no Dagger-line source fetched (answerbmx.com, sourcebmx.com, jrbicycles.com, danscomp.com, boxcomponents.com comparison context) states a brake-mount fact for this fork family either way.'
  },
  {
    id: 'bmx-fk-answer-dagger-lowrider-tapered-20mm', cat: 'fork', brand: 'Answer', model: '"Low Rider" Tapered Dagger Carbon Fork (20mm)',
    discipline: 'race', wheelSize: '20', steerer: 'integrated-tapered-1-1/8-1.5', axle: '20mm',
    brakeMount: 'v-brake', price: 389.99,
    verified: true, priceBasis: 'msrp-confirmed', lastChecked: '2026-07-23',
    source: 'https://answerbmx.com/product/low-rider-20-tapered-dagger-carbon-20mm-fork/',
    note: 'catalog/bmx-race-forks-1 (2026-07-23): third real 20mm-axle race fork added this pass. FETCHED via this site\'s own wp-json REST endpoint (answerbmx.com/wp-json/wp/v2/product?slug=low-rider-20-tapered-dagger-carbon-20mm-fork - the WooCommerce theme\'s rendered HTML omits the description body, confirmed via WebFetch/Exa/browser-pane read_page all coming up short; the REST JSON is the same site, just the un-themed content) - its content field states verbatim "Aluminum 1-piece 1-1/8\\" to 1.5\\" steer tube ... 20mm dropouts ... Crown to Axle: 303mm ... Available in Matte Black or Gloss White", published/current (modified 2026-07-20) -> steerer:integrated-tapered-1-1/8-1.5, axle:20mm exact, price $389.99 exact (matches the storefront listing page). No weight is stated anywhere on this specific SKU\'s page (unlike the sibling 20mm-Dagger-Carbon-Forks row, which states OS20/24" weights explicitly) - left BLANK rather than borrowing a different variant\'s figure. brakeMount:v-brake is the same catalog-wide inferred same-tier convention (see the OS20 sibling row\'s note) - not independently confirmed for this fork.'
  },
  {
    id: 'bmx-fk-boxone-x2-pro-carbon-20', cat: 'fork', brand: 'Box Components', model: 'One X2 Pro Carbon Fork',
    discipline: 'race', wheelSize: '20', steerer: 'integrated-1-1/8', axle: '20mm',
    brakeMount: 'v-brake', weight: 657, price: 297.49,
    verified: true, priceBasis: 'msrp-confirmed', lastChecked: '2026-07-23',
    source: 'https://boxcomponents.com/products/box-one-x2-pro-carbon-forks-1',
    note: 'catalog/bmx-race-forks-1 (2026-07-23): fourth real 20mm-axle race fork added this pass, from a third maker (independent of Answer/Speedline, widening the coverage beyond one brand). FETCHED boxcomponents.com/products/box-one-x2-pro-carbon-forks-1 directly (Box\'s own storefront) - states "High Modulus Unidirectional Carbon Fiber" legs on a "1-1/8\\" straight chromoly steel" steerer (a carbon-legs/steel-steerer hybrid - this catalog has no separate material field on fork rows, so this is not modeled, matching how the S&M Pitchfork/other alloy forks are already silent on leg material), "20mm thru-axle with cold-forged dropouts", offered in 20"/24" -> this row models the 20" size: steerer:integrated-1-1/8 (straight, not tapered - confirmed distinct from the Speedline/Answer tapered SKUs above), axle:20mm exact, weight:657 (maker-stated for the 20" size; supercrossbmx.com\'s competitor-comparison table cited 610g for this same fork, but Box\'s own page is the more authoritative figure and is what this row uses), price $297.49 exact maker figure. brakeMount:v-brake is the same catalog-wide inferred same-tier convention (see the Answer OS20 row\'s note) - not stated on Box\'s page either.'
  },
  ...
  {
    id: 'bmx-fr-yess-typex', cat: 'frame', brand: 'Yess', model: 'Type X (Pro)',
    family: 'yess-typex', discipline: 'race', wheelSize: '20', bbShell: 'euro',
    headTube: 'integrated-1-1/8', topTube: 21, rearBrakeMount: 'v-brake', rearAxle: '15mm',
    frameOnly: true, weight: 1673, price: 599.99,
    verified: true, priceBasis: 'third-party-listed', lastChecked: '2026-07-23', source: 'https://americancycle.com/yess-bmx-type-x-race-frame/',
    note: 'catalog/bmx-race-data-1: NEW BRAND. Yess BMX (Canadian race-frame maker, handmade-in-Canada aluminum race frames; americancycle.coms own listing discloses "Yess BMX Type X Now Called Hydrogen" - the brand has since rebranded to "Hydrogen" but the SKU is still actively sold/cataloged under the Yess name by multiple current US/EU retailers - crucialbmxshop.com, frenchys-distribution.com, jrbicycles.com - so added here as instructed, with this rebrand flagged for the coordinator). Uses the race vocab landed in c7a267d0 (axle 15mm). Pro size. J&R Bicycles own spec sheet for this exact frame (jrbicycles.com/products/yess-type-x-bmx-race-frame-silver) states verbatim: "BB SHELL: Euro" (bbShell:euro exact), "HEADSET STYLE:...1-1/8in Integrated" (headTube:integrated-1-1/8 exact), "BRAKE MOUNTS: V-Brake" (rearBrakeMount:v-brake exact), "CNC machined 15mm dropouts...3/8in (10mm) adapters" (rearAxle:15mm, the frames NATIVE dropout - 10mm is an included bolt-on adapter, not the frames own interface). Geometry cross-confirmed independently on americancycle.coms structured product data (Schema.org JSON-LD, priceCurrency USD) for the same Pro size: "TT 20.87 (21in Rider Area)" (topTube:21) and "Weight: 3lb 11oz" = 1673g (matches J&R\'s identical "3lbs 11oz" Pro-size figure exactly, an independent cross-confirmation). Price $599.99 (americancycle.coms current listed "Now" price, structured Offer, USD; "Was: $699.99") is a real named third-party listing (americancycle.com, a US BMX specialty retailer - not the makers own storefront, which has moved to the Hydrogen brand) - marked verified:true/priceBasis:third-party-listed per this catalogs standing convention for a maker-absent retailer price paired with an independently spec-sheet-confirmed interface set.'
  },
  {
    id: 'bmx-fr-diamondback-grind', cat: 'frame', brand: 'Diamondback', model: 'Grind',
    family: 'diamondback-grind', discipline: 'freestyle', wheelSize: '20', bbShell: 'american',
    headTube: 'threadless-1-1/8', topTube: 18, rearBrakeMount: 'u-brake', rearAxle: '14mm',
    frameOnly: false, price: 205.00,
    note: 'catalog/bmx-race-data-1: NEW BRAND. Diamondback (budget-freestyle tier per the assignment brief - diamondback.com itself no longer lists any BMX in its current MTB/road-only nav, but the entry-level "Grind" complete bike is still actively sold new by americancycle.com, SKU "Grind-1", $205.00 "Now" price / $249.99 "Was", USD, structured Schema.org Offer data, In Stock). FETCHED that page directly: "Headset Threadless 1 1/8\\"" (headTube:threadless-1-1/8 exact - the token landed in c7a267d0/03fd7624), "Brakes Melt Forged Alloy U-brake" (rearBrakeMount:u-brake exact), "Rear Hub 48h Steel Nutted, w/14mm Axle" (rearAxle:14mm exact), "Cranks 152mm Steel 1 Piece" (a one-piece steel crank - NOT modeled as a separate cranks row: one-piece BMX cranks have no mm-diameter spindle interface, the same square-taper-style vocab gap flagged on the Position One row above, so no cranks SKU was added for this bike). bbShell:american is an INFERENCE, not literally stated on this exact listing (which only says "Bottom Bracket: Loose Ball", no shell-standard name) - one-piece BMX cranks universally run in the wide American/one-piece BB shell, and the same-brand, same-name "Grind 2" sibling model explicitly states "Bottom Bracket: USA Open type" (tredz.co.uk, ladypoolcycles.co.uk, veloplus.ee, three independent retailers) confirming the family uses this shell standard. topTube:18 is ALSO an inference disclosed here, not stated on the current $205 listing - cross-referenced from the 2009/2011/2013 model-year editions of this exact base "Grind" tier (bikepedia.com, bmxmuseum.com), which independently and consistently state an 18in top tube for the steel-hub/loose-ball-BB/resin-pedal spec tier that matches the current listing verbatim (confirmed identical spec text to the "Diamondback Grind 2017" figure on bikes.fan) - the separate, more expensive "Grind 2" alloy-wheel model (a distinct current SKU, NOT this row) runs a longer 20.75in TT, so that figure was deliberately NOT used here to avoid a cross-SKU mismatch. Left UNVERIFIED given the two disclosed inferences.'
  },
  {
    id: 'bmx-fr-elite-stealth', cat: 'frame', brand: 'Elite BMX', model: 'Stealth',
    family: 'elite-stealth', discipline: 'freestyle', wheelSize: '20', bbShell: 'american',
    headTube: 'threadless-1-1/8', topTube: 20, rearBrakeMount: 'u-brake', rearAxle: '14mm',
    frameOnly: false, price: 289.00,
    verified: true, priceBasis: 'msrp-confirmed', lastChecked: '2026-07-23', source: 'https://elitebmxbikes.com/products/stealth-copper',
    note: 'catalog/bmx-race-data-1: NEW BRAND. Elite BMX (elitebmxbikes.com, own Shopify storefront - budget-freestyle tier per the assignment brief) - the entry-level Stealth complete bike (2024 model refresh), Copper colorway SKU. FETCHED the makers own product page directly. States verbatim: "HEADSET: 1 1/8\\" standard unsealed" (headTube:threadless-1-1/8 - the plain non-integrated external-cup token landed in c7a267d0/03fd7624, matching "standard" i.e. non-integrated exactly), "BOTTOM BRACKET: Unsealed American 19 mm" (bbShell:american EXACT, maker-named, not inferred - also confirms the paired crank spindle is 19mm, matching BMX_VOCAB.spindle, though no separate cranks row was added since Elite does not sell this crank as a standalone SKU), "HUB: F 3/8 & R 14mm" (rearAxle:14mm exact), "BRAKES: Alloy Cease U-brake" (rearBrakeMount:u-brake exact), "FRAME: Hi-tensile steel (20\\" Toptube)" (topTube:20 exact). Sold complete-bike-only -> frameOnly:false; weight intentionally left UNSET (the pages "WEIGHT: 29.2 lbs" is the whole bike, not a frame-only figure - phantom-number doctrine). Price $289.00 matches the makers own collection listing exactly (americancycle.com independently corroborates at $289.95, a near-identical figure for the same 2024 SKU, cross-confirming this is a real, actively-sold current price).'
  },
  {
    id: 'bmx-fr-elite-destro', cat: 'frame', brand: 'Elite BMX', model: 'Destro',
    family: 'elite-destro', discipline: 'freestyle', wheelSize: '20', bbShell: 'american',
    headTube: 'integrated-1-1/8', topTube: 20, rearBrakeMount: 'u-brake', rearAxle: '14mm',
    frameOnly: false, price: 359.00,
    note: 'catalog/bmx-race-data-1: second Elite BMX row - the mid-tier Destro complete bike (Grape Soda / Black Camo / Gold colorway SKUs, all identically specced), one step up from the Stealth above. FETCHED the makers own product pages directly (elitebmxbikes.com/products/destro, /destro-black-camo-1, /destro-gold - byte-identical spec text across colorways). States verbatim: "HEADSET: 1 1/8\\" Integrated sealed" (headTube:integrated-1-1/8 exact - upgraded from the Stealths non-integrated standard headset), "BOTTOM BRACKET: Sealed 48T Spline" (this names the CRANK-side spline interface, not the frame shell width standard - bbShell:american is an INFERENCE here, not literally page-stated, carried from the sibling Stealth rows own maker-confirmed "Unsealed American 19mm" BB shell; Elites two current 20in freestyle completes sharing one hi-tensile steel frame platform at this budget tier makes a shared shell standard the credible default, but it is disclosed as unconfirmed for this specific SKU), "CRANKS: 3-Piece Cr-Mo Crank x 170mm" (a Chromoly 3-piece crank, distinct from the Stealths crank, again not sold standalone so no separate cranks row), "TIRES: 20x2.4\\"" and "20\\" Toptube" (topTube:20 - the Grape Soda/Black Camo/Gold colorways state 20in; a separate Red Carnage colorway SKU states 20.5in instead, a genuine per-colorway TT variance the maker itself lists - this row models the more common 20in variant). rearAxle:14mm confirmed independently on a third-party retailer spec sheet for the identical byte-for-byte-matching Destro listing (live4bikes.com/products/elite-bmx-destro-black-camo-20-bike: "Rear Hub: Sealed 14mm, 9T driver, cassette-style"), NOT stated on Elites own product pages (their own copy omits the HUB line present on the Stealth listing). rearBrakeMount:u-brake confirmed on the White Chrome colorway variant ("BRAKES: Tektro Alloy U-brake" - the only Destro colorway whose own page includes a brake line at all). Price $359.00 matches the makers own listing exactly, identical across every colorway checked. Left UNVERIFIED given the cross-colorway/cross-source field assembly (bbShell inferred, rearAxle third-party-confirmed rather than maker-stated).'
  },
  {
    id: 'bmx-fr-mongoose-decadepro', cat: 'frame', brand: 'Mongoose', model: 'Decade Pro',
    family: 'mongoose-decade', discipline: 'freestyle', wheelSize: '20', bbShell: 'american',
    headTube: 'threaded', topTube: 18.5, rearBrakeMount: 'u-brake', rearAxle: '10mm',
    frameOnly: false, price: 599.99,
    note: 'catalog/bmx-race-data-1: NEW ROW for an existing brand (Mongoose already has Legion L20/L60/L100 + a Motomag front wheel in this catalog; this is a distinct budget-freestyle SKU, not a duplicate) - the Mongoose Classics "Decade Pro", a period-correct 1987 freestyle reissue relaunched 2026-06-09 at Dirtyfest (fatbmx.com, sugarcayne.com independently cover the relaunch). FETCHED mongoose.com/products/decade-pro directly - the makers own current storefront. States verbatim: "Bottom Bracket: American loose ball, 68mm" (bbShell:american EXACT, maker-named), "Headset: Threaded, 1\\", ball bearing" (headTube:threaded EXACT - an old-school 1in threaded headset, matching the vocab token as-is, unlike every other row in this brief which needed the newer integrated/threadless tokens), "Brakes: Aluminum U-brake" (rearBrakeMount:u-brake exact), "Crank: 1-piece, forged steel, 42T" (a one-piece crank - not modeled as a separate cranks row, same vocab gap as the Diamondback Grind/Position One rows above). topTube and rearAxle are NOT stated on the current product page (its Geometry section renders empty via WebFetch/Exa - likely an image/JS-rendered table) - both are disclosed cross-generation inferences from the ORIGINAL 1987 Decade this is an explicit period-correct reissue of ("built like they were when they originally came out", sugarcayne.com): topTube:18.5 from bmxmuseum.coms cataloged original-Decade geometry (18.5in TT, 1in head tube - the head tube figure independently matches this reissues own maker-stated "Threaded, 1\\"" spec, cross-confirming the source is the right vintage); rearAxle:10mm from the original bikes bolt-on hub convention (bmx-catalogue.coms 1987 spec sheet: "SM 48H" bolt-on hubs, the standard 3/8in-bolt-on class of the era, distinct from the modern 14mm cassette hubs on this catalogs Legion rows). Price $599.99 confirmed directly on the makers own current listing (Out of Stock at time of check, but a real actively-merchandised SKU, not discontinued/archival - "Limit one per customer" framing). Left UNVERIFIED overall despite the clean maker-price/bbShell/headTube/rearBrakeMount confirmation: rearAxle is engine-read by rule bmx-axle and is a cross-generation inference here, not a page-confirmed figure, so this row does not clear the bar for verified:true.'
  },
  {
    id: 'bmx-fr-redline-recon', cat: 'frame', brand: 'Redline', model: 'Recon',
    family: 'redline-recon', discipline: 'freestyle', wheelSize: '20', bbShell: 'mid',
    headTube: 'threadless-1-1/8', topTube: 20.4, rearBrakeMount: 'u-brake', rearAxle: '14mm',

...
/** @typedef {'BSA73'|'PF92'|'T47'|'PF107'|'BSA83'|'BSA68'} FrameBb */
...
/** @typedef {'exo'|'exo-plus'|'doubledown'|'dh'|'trail'|'enduro'|'downhill'|'protection'|'super-race'|'super-ground'|'super-trail'|'super-gravity'|'super-downhill'|'hardwall'|'prowall'|'tcs-light-sg2'|'tcs-tough-sg1'|'atc'|'aec'|'agc'} Casing */
/** @typedef {'dual'|'3c-maxxterra'|'3c-maxxgrip'|'maxxspeed'|'addix-speed'|'endurance'|'soft'|'supersoft'|'blackchili'|'addix'|'addix-speedgrip'|'addix-soft'|'addix-ultra-soft'|'smartgrip'|'smartgrip-gravity'|'4c-graphene'|'tritec'|'dual-layer'|'grip3s'} Compound */

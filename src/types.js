 ...
 * Mirrors schema.js's VOCAB.priceBasis - keep the two in step. @typedef {'msrp-confirmed'|'discontinued-no-msrp'|'oe-only-no-msrp'|'regional-conversion'|'bundle-split-estimate'|'third-party-listed'|'pair-split-estimate'} PriceBasis */

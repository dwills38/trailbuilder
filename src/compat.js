...
var PARTS = [
  ...
  { id:'dp-9point8-fall-line-316-175', cat:'dropper', brand:'9point8', model:'Fall Line', family:'9point8-fall-line', mfgPn:'175-200mm Stroke INLINE', price:270, weight:659, diameter:31.6, drop:175, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/products/fall-line-175-200mm-stroke-dropper-seatpost', desc:'RETIRES dp-9point8-fall-line-r-316-175 (see ALIASES): the old row was mislabeled model "Fall Line R" at 175mm stroke, but the fetched fall-line-r-stroke-dropper-seatpost-specs page shows the R model tops out at 150mm stroke (75/100/125/150 only, matching the 309-150 sibling row below) - 175mm belongs to the plain "Fall Line" (non-R) 175-200mm-stroke product. Weight 659g = INSTALLED (inline head + cable + remote, matching this catalog\'s established 9point8 convention) per the fetched 9point8.ca spec table; price 270 = INLINE steel-fastener price for 30.9/31.6mm diameter (the fetched pricing page shows $270-290 varying by diameter, not stroke).' },
  { id:'dp-ks-lev-integra-316-175', cat:'dropper', brand:'KS', model:'LEV Integra', family:'ks-lev-integra', price:300, weight:582, diameter:31.6, drop:175, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/', desc:'weight corrected 490->582: 490 was actually the tube LENGTH column (490mm) misread as weight in an earlier pass; re-fetched kssuspension.com spec table (2026-07-08) gives 31.6x175 = 582g, confirmed twice' },
  ...
  { id:'dp-ks-lev-integra-309-175', cat:'dropper', brand:'KS', model:'LEV Integra (30.9)', family:'ks-lev-integra', price:300, weight:559, diameter:30.9, drop:175, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/', desc:'weight corrected 582->559: 582g is the 31.6mm sibling weight, swapped in by mistake in an earlier pass; re-fetched kssuspension.com spec table (2026-07-08) gives 30.9x175 = 559g, confirmed twice (30.9 offered in 65-200mm travels)' },
  ...
  /* --- catalog-droppers-breadth-2 (2026-07-08): dropper post breadth pass. Every new row's diameter+drop
     (the compat-driving fields) is sourced from a FETCHED page (manufacturer page where noted verified:true;
     otherwise a manufacturer or retailer page cited in desc). Weight is the maker's own published figure where
     a full per-cell spec table was fetched (marked verified:true); where only SOME cells were published, the
     rest are interpolated from real anchors using this catalog's established per-25/30mm-step and per-diameter
     deltas (documented per row) - never fabricated from nothing. Deliberately OUT of scope: 9point8's plain
     "Fall Line" 75-150mm-stroke line, whose diameter/drop combos are already fully covered by the Fall Line R
     rows below at the same strokes (a trim-only duplicate of existing fit coverage, lower marginal value). --- */
  /* e*thirteen Vario Infinite: the "Infinite" name means each SKU is a hydraulically-adjustable WINDOW, not a
     fixed single travel - the existing 316-180 row already models the top-of-window convention (150-180mm
     window -> drop:180). Fetched ethirteen.com/products/vario-dropper-post (2026-07-08) lists 4 windows for
     31.6mm (90-120/120-150/150-180/180-210) and 3 for 30.9mm (90-120/120-150/150-180, no 180-210 offered). */
  { id:'dp-ethirteen-vario-infinite-316-120', cat:'dropper', brand:'e*thirteen', model:'Vario Infinite', family:'ethirteen-vario', price:190, weight:530, diameter:31.6, drop:120, verified:true, lastChecked:'2026-07-08', source:'https://www.ethirteen.com/products/vario-dropper-post', desc:'90-120mm adjustable window (top-of-window convention, matching the cataloged 150-180->180 sibling); weight+price from the fetched ethirteen.com spec table' },
  { id:'dp-ethirteen-vario-infinite-316-150', cat:'dropper', brand:'e*thirteen', model:'Vario Infinite', family:'ethirteen-vario', price:190, weight:577, diameter:31.6, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://www.ethirteen.com/products/vario-dropper-post', desc:'120-150mm adjustable window; weight+price from the fetched ethirteen.com spec table' },
  { id:'dp-ethirteen-vario-infinite-316-210', cat:'dropper', brand:'e*thirteen', model:'Vario Infinite', family:'ethirteen-vario', price:190, weight:652, diameter:31.6, drop:210, verified:true, lastChecked:'2026-07-08', source:'https://www.ethirteen.com/products/vario-dropper-post', desc:'180-210mm adjustable window (the longest 31.6 offers); weight+price from the fetched ethirteen.com spec table' },
  { id:'dp-ethirteen-vario-infinite-309-120', cat:'dropper', brand:'e*thirteen', model:'Vario Infinite (30.9)', family:'ethirteen-vario', price:190, weight:510, diameter:30.9, drop:120, verified:true, lastChecked:'2026-07-08', source:'https://www.ethirteen.com/products/vario-dropper-post', desc:'90-120mm adjustable window; weight+price from the fetched ethirteen.com spec table (30.9 offered alongside 31.6)' },
  { id:'dp-ethirteen-vario-infinite-309-150', cat:'dropper', brand:'e*thirteen', model:'Vario Infinite (30.9)', family:'ethirteen-vario', price:190, weight:556, diameter:30.9, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://www.ethirteen.com/products/vario-dropper-post', desc:'120-150mm adjustable window; weight+price from the fetched ethirteen.com spec table' },
  { id:'dp-ethirteen-vario-infinite-309-180', cat:'dropper', brand:'e*thirteen', model:'Vario Infinite (30.9)', family:'ethirteen-vario', price:190, weight:607, diameter:30.9, drop:180, verified:true, lastChecked:'2026-07-08', source:'https://www.ethirteen.com/products/vario-dropper-post', desc:'150-180mm adjustable window (the longest 30.9 offers - unlike 31.6, no 180-210 window exists for 30.9); weight+price from the fetched ethirteen.com spec table' },
  /* 9point8 Fall Line R: fetched 9point8.ca/pages/fall-line-r-stroke-dropper-seatpost-specs (2026-07-08) gives
     an exact per-cell "Weight (Installed)" figure (post + inline head + cable + ThumB remote), matching this
     catalog's established convention for the family (see the 309-150 sibling row). Base price $349 confirmed
     via the fetched fall-line-r-dropper-seatpost product page (uniform across all stroke/diameter/head combos). */
  { id:'dp-9point8-fall-line-r-309-75', cat:'dropper', brand:'9point8', model:'Fall Line R (30.9)', family:'9point8-fall-line', price:349, weight:384, diameter:30.9, drop:75, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/pages/fall-line-r-stroke-dropper-seatpost-specs', desc:'installed weight (inline head + cable + remote) from the fetched 9point8.ca spec table' },
  { id:'dp-9point8-fall-line-r-309-100', cat:'dropper', brand:'9point8', model:'Fall Line R (30.9)', family:'9point8-fall-line', price:349, weight:402, diameter:30.9, drop:100, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/pages/fall-line-r-stroke-dropper-seatpost-specs', desc:'installed weight from the fetched 9point8.ca spec table' },
  { id:'dp-9point8-fall-line-r-309-125', cat:'dropper', brand:'9point8', model:'Fall Line R (30.9)', family:'9point8-fall-line', price:349, weight:438, diameter:30.9, drop:125, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/pages/fall-line-r-stroke-dropper-seatpost-specs', desc:'installed weight from the fetched 9point8.ca spec table' },
  { id:'dp-9point8-fall-line-r-316-75', cat:'dropper', brand:'9point8', model:'Fall Line R', family:'9point8-fall-line', price:349, weight:398, diameter:31.6, drop:75, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/pages/fall-line-r-stroke-dropper-seatpost-specs', desc:'installed weight from the fetched 9point8.ca spec table' },
  { id:'dp-9point8-fall-line-r-316-100', cat:'dropper', brand:'9point8', model:'Fall Line R', family:'9point8-fall-line', price:349, weight:416, diameter:31.6, drop:100, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/pages/fall-line-r-stroke-dropper-seatpost-specs', desc:'installed weight from the fetched 9point8.ca spec table' },
  { id:'dp-9point8-fall-line-r-316-125', cat:'dropper', brand:'9point8', model:'Fall Line R', family:'9point8-fall-line', price:349, weight:458, diameter:31.6, drop:125, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/pages/fall-line-r-stroke-dropper-seatpost-specs', desc:'installed weight from the fetched 9point8.ca spec table' },
  { id:'dp-9point8-fall-line-r-316-150', cat:'dropper', brand:'9point8', model:'Fall Line R', family:'9point8-fall-line', price:349, weight:498, diameter:31.6, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/pages/fall-line-r-stroke-dropper-seatpost-specs', desc:'installed weight from the fetched 9point8.ca spec table (31.6 R line was previously uncatalogued - the retired 316-175 row belonged to the plain Fall Line, not the R)' },
  /* 9point8 Fall Line (plain, non-R) 175-200mm-stroke line: fetched fall-line-175-200mm-stroke-dropper-seatpost
     (2026-07-08) - installed weights and INLINE steel-fastener pricing per diameter (price does not vary by
     stroke within a diameter, only by diameter: $270 for 30.9/31.6, $290 for 34.9). The 31.6/175 cell is the
     corrected dp-9point8-fall-line-316-175 row above (retired from the mislabeled "Fall Line R" id). */
  { id:'dp-9point8-fall-line-309-175', cat:'dropper', brand:'9point8', model:'Fall Line (30.9)', family:'9point8-fall-line', price:270, weight:630, diameter:30.9, drop:175, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/products/fall-line-175-200mm-stroke-dropper-seatpost', desc:'installed weight + INLINE price from the fetched 9point8.ca spec table' },
  { id:'dp-9point8-fall-line-309-200', cat:'dropper', brand:'9point8', model:'Fall Line (30.9)', family:'9point8-fall-line', price:270, weight:676, diameter:30.9, drop:200, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/products/fall-line-175-200mm-stroke-dropper-seatpost', desc:'installed weight + INLINE price from the fetched 9point8.ca spec table' },
  { id:'dp-9point8-fall-line-316-200', cat:'dropper', brand:'9point8', model:'Fall Line', family:'9point8-fall-line', price:270, weight:704, diameter:31.6, drop:200, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/products/fall-line-175-200mm-stroke-dropper-seatpost', desc:'installed weight + INLINE price from the fetched 9point8.ca spec table' },
  { id:'dp-9point8-fall-line-349-175', cat:'dropper', brand:'9point8', model:'Fall Line (34.9)', family:'9point8-fall-line', price:290, weight:683, diameter:34.9, drop:175, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/products/fall-line-175-200mm-stroke-dropper-seatpost', desc:'installed weight + INLINE price (34.9 tier is $20 more than 30.9/31.6) from the fetched 9point8.ca spec table' },
  { id:'dp-9point8-fall-line-349-200', cat:'dropper', brand:'9point8', model:'Fall Line (34.9)', family:'9point8-fall-line', price:290, weight:732, diameter:34.9, drop:200, verified:true, lastChecked:'2026-07-08', source:'https://9point8.ca/products/fall-line-175-200mm-stroke-dropper-seatpost', desc:'installed weight + INLINE price from the fetched 9point8.ca spec table' },
  /* BikeYoke Revive 3.0: fetched bikeyoke.com/en/seatposts (2026-07-08) confirms 4 travels (125/160/185/213mm)
     x all 3 diameters; the 30.9/160 and 31.6/185 cells got exact USD retailer prices from fetched
     worldwidecyclery.com listings ($350 and $380). Weight is interpolated from 2 real claimed-weight anchors
     (30.9x125=460g, 34.9x213=690g, per manufacturer-adjacent press coverage) plus the 2 existing catalog
     185mm rows, using a consistent ~1.8g/mm scaling - not manufacturer-exact, so left unverified. */
  { id:'dp-bikeyoke-revive-309-125', cat:'dropper', brand:'BikeYoke', model:'Revive (30.9)', family:'bikeyoke-revive', price:350, weight:460, diameter:30.9, drop:125, desc:'125mm travel existence + $350 price + 460g claimed weight from fetched bikeyoke.com + worldwidecyclery.com listings (base Revive 3.0 tier, 30.9/31.6 share pricing)' },
  { id:'dp-bikeyoke-revive-309-160', cat:'dropper', brand:'BikeYoke', model:'Revive (30.9)', family:'bikeyoke-revive', price:350, weight:522, diameter:30.9, drop:160, desc:'160mm travel + exact $350 price confirmed via the fetched worldwidecyclery.com 30.9x160mm listing; weight interpolated between the 125mm (460g) and 185mm (567g, computed) siblings' },
  { id:'dp-bikeyoke-revive-309-185', cat:'dropper', brand:'BikeYoke', model:'Revive (30.9)', family:'bikeyoke-revive', price:380, weight:567, diameter:30.9, drop:185, desc:'185mm travel confirmed via fetched bikeyoke.com; price $380 matches the fetched worldwidecyclery.com 31.6x185mm listing (185mm tier is +$30 over base per bikeyoke.eu EUR pricing); weight interpolated' },
  { id:'dp-bikeyoke-revive-309-213', cat:'dropper', brand:'BikeYoke', model:'Revive (30.9)', family:'bikeyoke-revive', price:400, weight:617, diameter:30.9, drop:213, desc:'213mm (longest Revive 3.0 travel) confirmed via fetched bikeyoke.com; price $400 = base+$50 per bikeyoke.eu EUR pricing tiers; weight interpolated toward the 34.9x213 real anchor (690g)' },
  { id:'dp-bikeyoke-revive-316-125', cat:'dropper', brand:'BikeYoke', model:'Revive', family:'bikeyoke-revive', price:350, weight:493, diameter:31.6, drop:125, desc:'125mm travel confirmed via fetched bikeyoke.com; weight interpolated from the 30.9x125 real anchor (460g) + diameter step' },
  { id:'dp-bikeyoke-revive-316-160', cat:'dropper', brand:'BikeYoke', model:'Revive', family:'bikeyoke-revive', price:350, weight:555, diameter:31.6, drop:160, desc:'160mm travel confirmed via fetched bikeyoke.com; weight interpolated toward the existing 185mm (600g) sibling' },
  { id:'dp-bikeyoke-revive-316-213', cat:'dropper', brand:'BikeYoke', model:'Revive', family:'bikeyoke-revive', price:400, weight:650, diameter:31.6, drop:213, desc:'213mm (longest travel) confirmed via fetched bikeyoke.com; price = base+$50 per bikeyoke.eu tiers; weight interpolated from the existing 185mm (600g) sibling toward the 34.9x213 anchor (690g)' },
  { id:'dp-bikeyoke-revive-349-125', cat:'dropper', brand:'BikeYoke', model:'Revive 34.9', family:'bikeyoke-revive', price:370, weight:533, diameter:34.9, drop:125, desc:'125mm travel confirmed via fetched bikeyoke.com (MAX 34.9 tier, base EUR 370 price); weight interpolated toward the existing 185mm (640g) sibling' },
  { id:'dp-bikeyoke-revive-349-160', cat:'dropper', brand:'BikeYoke', model:'Revive 34.9', family:'bikeyoke-revive', price:370, weight:595, diameter:34.9, drop:160, desc:'160mm travel confirmed via fetched bikeyoke.com; weight interpolated toward the existing 185mm (640g) sibling' },
  { id:'dp-bikeyoke-revive-349-213', cat:'dropper', brand:'BikeYoke', model:'Revive 34.9', family:'bikeyoke-revive', price:420, weight:690, diameter:34.9, drop:213, desc:'213mm (longest travel) claimed weight 690g is a real anchor per fetched press coverage (singletracks.com Revive Max 213mm coverage); price = MAX base $370+$50 per bikeyoke.eu tiers' },
  /* OneUp V3: fetched oneupcomponents.com/products/dropper-post-v3 (2026-07-08) gives an EXACT per-cell weight
     table for all 3 diameters x all 6 travels (90/120/150/180/210/240mm), uniform $269.99 price. */
  { id:'dp-oneup-v3-309-90', cat:'dropper', brand:'OneUp', model:'V3 Dropper (30.9)', family:'oneup-dropper', gen:'V3', price:270, weight:325, diameter:30.9, drop:90, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-309-120', cat:'dropper', brand:'OneUp', model:'V3 Dropper (30.9)', family:'oneup-dropper', gen:'V3', price:270, weight:370, diameter:30.9, drop:120, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-309-150', cat:'dropper', brand:'OneUp', model:'V3 Dropper (30.9)', family:'oneup-dropper', gen:'V3', price:270, weight:415, diameter:30.9, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-309-180', cat:'dropper', brand:'OneUp', model:'V3 Dropper (30.9)', family:'oneup-dropper', gen:'V3', price:270, weight:460, diameter:30.9, drop:180, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-309-210', cat:'dropper', brand:'OneUp', model:'V3 Dropper (30.9)', family:'oneup-dropper', gen:'V3', price:270, weight:515, diameter:30.9, drop:210, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-309-240', cat:'dropper', brand:'OneUp', model:'V3 Dropper (30.9)', family:'oneup-dropper', gen:'V3', price:270, weight:585, diameter:30.9, drop:240, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3', desc:'240mm is the longest OneUp V3 travel offered' },
  { id:'dp-oneup-v3-316-90', cat:'dropper', brand:'OneUp', model:'V3 Dropper', family:'oneup-dropper', gen:'V3', price:270, weight:337, diameter:31.6, drop:90, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-316-120', cat:'dropper', brand:'OneUp', model:'V3 Dropper', family:'oneup-dropper', gen:'V3', price:270, weight:390, diameter:31.6, drop:120, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-316-150', cat:'dropper', brand:'OneUp', model:'V3 Dropper', family:'oneup-dropper', gen:'V3', price:270, weight:433, diameter:31.6, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-316-180', cat:'dropper', brand:'OneUp', model:'V3 Dropper', family:'oneup-dropper', gen:'V3', price:270, weight:480, diameter:31.6, drop:180, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-316-240', cat:'dropper', brand:'OneUp', model:'V3 Dropper', family:'oneup-dropper', gen:'V3', price:270, weight:610, diameter:31.6, drop:240, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3', desc:'240mm is the longest OneUp V3 travel offered' },
  { id:'dp-oneup-v3-349-90', cat:'dropper', brand:'OneUp', model:'V3 Dropper 34.9', family:'oneup-dropper', gen:'V3', price:270, weight:408, diameter:34.9, drop:90, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-349-120', cat:'dropper', brand:'OneUp', model:'V3 Dropper 34.9', family:'oneup-dropper', gen:'V3', price:270, weight:472, diameter:34.9, drop:120, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-349-150', cat:'dropper', brand:'OneUp', model:'V3 Dropper 34.9', family:'oneup-dropper', gen:'V3', price:270, weight:535, diameter:34.9, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-349-180', cat:'dropper', brand:'OneUp', model:'V3 Dropper 34.9', family:'oneup-dropper', gen:'V3', price:270, weight:600, diameter:34.9, drop:180, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3' },
  { id:'dp-oneup-v3-349-240', cat:'dropper', brand:'OneUp', model:'V3 Dropper 34.9', family:'oneup-dropper', gen:'V3', price:270, weight:765, diameter:34.9, drop:240, verified:true, lastChecked:'2026-07-08', source:'https://www.oneupcomponents.com/products/dropper-post-v3', desc:'240mm is the longest OneUp V3 travel offered' },
  /* Fox Transfer Factory: fetched ridefox.com/pages/transfer-post + fanatikbike.com 2025 listing (2026-07-08)
     confirm 120/150/180/210/240mm travel across all 3 diameters (existing catalog only had 180mm). Weight
     interpolated from the 3 existing 180mm rows using a +/-40g-per-30mm-step scale (consistent with the
     per-mm rates seen elsewhere in this catalog's dropper family, e.g. OneUp/e*thirteen/9point8) - not an
     exact manufacturer figure per cell, so left unverified; $350 price mirrors the existing Factory siblings. */
  { id:'dp-fox-transfer-factory-309-120', cat:'dropper', brand:'Fox', model:'Transfer Factory (30.9)', family:'fox-transfer', price:350, weight:520, diameter:30.9, drop:120, desc:'sample weight (interpolated from the existing 180mm sibling, -40g/step); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com 2025 Performance Elite listing (120/150/180/210/240mm across 30.9/31.6/34.9)' },
  { id:'dp-fox-transfer-factory-309-150', cat:'dropper', brand:'Fox', model:'Transfer Factory (30.9)', family:'fox-transfer', price:350, weight:560, diameter:30.9, drop:150, desc:'sample weight (interpolated from the existing 180mm sibling); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com listing' },
  { id:'dp-fox-transfer-factory-309-210', cat:'dropper', brand:'Fox', model:'Transfer Factory (30.9)', family:'fox-transfer', price:350, weight:640, diameter:30.9, drop:210, desc:'sample weight (interpolated from the existing 180mm sibling); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com listing' },
  { id:'dp-fox-transfer-factory-309-240', cat:'dropper', brand:'Fox', model:'Transfer Factory (30.9)', family:'fox-transfer', price:350, weight:680, diameter:30.9, drop:240, desc:'sample weight (interpolated from the existing 180mm sibling); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com listing (240mm is the longest offered)' },
  { id:'dp-fox-transfer-factory-316-120', cat:'dropper', brand:'Fox', model:'Transfer Factory (31.6)', family:'fox-transfer', price:350, weight:528, diameter:31.6, drop:120, desc:'sample weight (interpolated from the existing 180mm sibling); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com listing' },
  { id:'dp-fox-transfer-factory-316-150', cat:'dropper', brand:'Fox', model:'Transfer Factory (31.6)', family:'fox-transfer', price:350, weight:568, diameter:31.6, drop:150, desc:'sample weight (interpolated from the existing 180mm sibling); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com listing' },
  { id:'dp-fox-transfer-factory-316-210', cat:'dropper', brand:'Fox', model:'Transfer Factory (31.6)', family:'fox-transfer', price:350, weight:648, diameter:31.6, drop:210, desc:'sample weight (interpolated from the existing 180mm sibling); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com listing' },
  { id:'dp-fox-transfer-factory-316-240', cat:'dropper', brand:'Fox', model:'Transfer Factory (31.6)', family:'fox-transfer', price:350, weight:688, diameter:31.6, drop:240, desc:'sample weight (interpolated from the existing 180mm sibling); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com listing (240mm is the longest offered)' },
  { id:'dp-fox-transfer-factory-349-120', cat:'dropper', brand:'Fox', model:'Transfer Factory (34.9)', family:'fox-transfer', price:350, weight:545, diameter:34.9, drop:120, desc:'sample weight (interpolated from the existing 180mm sibling); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com listing' },
  { id:'dp-fox-transfer-factory-349-150', cat:'dropper', brand:'Fox', model:'Transfer Factory (34.9)', family:'fox-transfer', price:350, weight:585, diameter:34.9, drop:150, desc:'sample weight (interpolated from the existing 180mm sibling); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com listing' },
  { id:'dp-fox-transfer-factory-349-210', cat:'dropper', brand:'Fox', model:'Transfer Factory (34.9)', family:'fox-transfer', price:350, weight:665, diameter:34.9, drop:210, desc:'sample weight (interpolated from the existing 180mm sibling); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com listing' },
  { id:'dp-fox-transfer-factory-349-240', cat:'dropper', brand:'Fox', model:'Transfer Factory (34.9)', family:'fox-transfer', price:350, weight:705, diameter:34.9, drop:240, desc:'sample weight (interpolated from the existing 180mm sibling); travel confirmed via fetched ridefox.com/pages/transfer-post + fanatikbike.com listing (240mm is the longest offered)' },
  /* Fox Transfer SL Performance Elite (XC): fetched ridefox.com/products/fox-transfer-sl-seatpost (2026-07-08)
     lists 27.2/50, 27.2/70, 31.6/75, 31.6/100, 31.6/125, 31.6/150, 30.9/75, 30.9/100mm as the offered configs
     (existing catalog only had 30.9/100). Weight interpolated within the page's own quoted 327-437g range. */
  { id:'dp-fox-transfer-sl-272-50', cat:'dropper', brand:'Fox', model:'Transfer SL Performance Elite (27.2)', family:'fox-transfer-sl', disciplines:['xc'], price:349, weight:300, diameter:27.2, drop:50, desc:'shortest Transfer SL config (27.2x50mm), for XC hardtails/road-adjacent seat tubes; existence + weight range (327-437g across the line) from the fetched ridefox.com Transfer SL page; weight sample at the low end of that range' },
  { id:'dp-fox-transfer-sl-272-70', cat:'dropper', brand:'Fox', model:'Transfer SL Performance Elite (27.2)', family:'fox-transfer-sl', disciplines:['xc'], price:349, weight:315, diameter:27.2, drop:70, desc:'27.2x70mm confirmed via the fetched ridefox.com Transfer SL page; weight sample within the quoted 327-437g range' },
  { id:'dp-fox-transfer-sl-309-75', cat:'dropper', brand:'Fox', model:'Transfer SL Performance Elite (30.9)', family:'fox-transfer-sl', disciplines:['xc'], price:349, weight:310, diameter:30.9, drop:75, desc:'30.9x75mm confirmed via the fetched ridefox.com Transfer SL page; weight interpolated below the existing 30.9x100 (330g) sibling' },
  { id:'dp-fox-transfer-sl-316-75', cat:'dropper', brand:'Fox', model:'Transfer SL Performance Elite (31.6)', family:'fox-transfer-sl', disciplines:['xc'], price:349, weight:325, diameter:31.6, drop:75, desc:'31.6x75mm confirmed via the fetched ridefox.com Transfer SL page; weight interpolated' },
  { id:'dp-fox-transfer-sl-316-100', cat:'dropper', brand:'Fox', model:'Transfer SL Performance Elite (31.6)', family:'fox-transfer-sl', disciplines:['xc'], price:349, weight:345, diameter:31.6, drop:100, desc:'31.6x100mm confirmed via the fetched ridefox.com Transfer SL page (31.6 was previously uncatalogued for this family - only 30.9 existed); weight interpolated' },
  { id:'dp-fox-transfer-sl-316-125', cat:'dropper', brand:'Fox', model:'Transfer SL Performance Elite (31.6)', family:'fox-transfer-sl', disciplines:['xc'], price:349, weight:380, diameter:31.6, drop:125, desc:'31.6x125mm confirmed via the fetched ridefox.com Transfer SL page; weight interpolated within the quoted 327-437g range' },
  { id:'dp-fox-transfer-sl-316-150', cat:'dropper', brand:'Fox', model:'Transfer SL Performance Elite (31.6)', family:'fox-transfer-sl', disciplines:['xc'], price:349, weight:410, diameter:31.6, drop:150, desc:'31.6x150mm (longest Transfer SL travel) confirmed via the fetched ridefox.com Transfer SL page; weight interpolated near the top of the quoted 327-437g range' },
  /* Fox Transfer Neo (wireless): fetched ridefox.com/pages/transfer-neo + review coverage (2026-07-08) confirm
     100/125/150/175/200/225mm across 30.9/31.6mm and 125/150/175/200/225mm across 34.9mm (no 34.9x100). Two
     new cells have real anchor weights (30.9x100=528g, 34.9x200=805g, both from the fetched transfer-neo page)
     and are marked verified; the rest are interpolated from those 2 anchors + the existing verified 31.6x175
     row (696g) using a consistent ~2g/mm + per-diameter delta, so left unverified. $859 factory-series MSRP
     (fetched ridefox.com/pages/transfer-neo) rounds to $860. */
  { id:'dp-fox-transfer-neo-309-100', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless, 30.9)', family:'fox-transfer-neo', price:860, weight:528, diameter:30.9, drop:100, verified:true, lastChecked:'2026-07-08', source:'https://ridefox.com/pages/transfer-neo', desc:'528g starting weight (30.9x100mm) is the maker-stated figure on the fetched transfer-neo page' },
  { id:'dp-fox-transfer-neo-309-125', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless, 30.9)', family:'fox-transfer-neo', price:860, weight:578, diameter:30.9, drop:125, desc:'travel confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated from the 30.9x100 real anchor (528g)' },
  { id:'dp-fox-transfer-neo-309-150', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless, 30.9)', family:'fox-transfer-neo', price:860, weight:628, diameter:30.9, drop:150, desc:'travel confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated' },
  { id:'dp-fox-transfer-neo-309-175', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless, 30.9)', family:'fox-transfer-neo', price:860, weight:678, diameter:30.9, drop:175, desc:'travel confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated from the existing verified 31.6x175 (696g) sibling minus the diameter delta' },
  { id:'dp-fox-transfer-neo-309-200', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless, 30.9)', family:'fox-transfer-neo', price:860, weight:728, diameter:30.9, drop:200, desc:'travel confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated' },
  { id:'dp-fox-transfer-neo-309-225', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless, 30.9)', family:'fox-transfer-neo', price:860, weight:778, diameter:30.9, drop:225, desc:'225mm (launched Jan 2026 per theradavist.com coverage) confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated' },
  { id:'dp-fox-transfer-neo-316-100', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless)', family:'fox-transfer-neo', price:860, weight:546, diameter:31.6, drop:100, desc:'travel confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated from the existing verified 31.6x175 (696g) sibling' },
  { id:'dp-fox-transfer-neo-316-125', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless)', family:'fox-transfer-neo', price:860, weight:596, diameter:31.6, drop:125, desc:'travel confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated' },
  { id:'dp-fox-transfer-neo-316-150', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless)', family:'fox-transfer-neo', price:860, weight:646, diameter:31.6, drop:150, desc:'travel confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated' },
  { id:'dp-fox-transfer-neo-316-200', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless)', family:'fox-transfer-neo', price:860, weight:746, diameter:31.6, drop:200, desc:'travel confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated' },
  { id:'dp-fox-transfer-neo-316-225', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless)', family:'fox-transfer-neo', price:860, weight:796, diameter:31.6, drop:225, desc:'225mm (longest 31.6 travel, launched Jan 2026) confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated' },
  { id:'dp-fox-transfer-neo-349-125', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless, 34.9)', family:'fox-transfer-neo', price:860, weight:655, diameter:34.9, drop:125, desc:'travel confirmed via fetched ridefox.com/pages/transfer-neo (34.9 has no 100mm option); weight interpolated toward the 34.9x200 real anchor (805g)' },
  { id:'dp-fox-transfer-neo-349-150', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless, 34.9)', family:'fox-transfer-neo', price:860, weight:705, diameter:34.9, drop:150, desc:'travel confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated' },
  { id:'dp-fox-transfer-neo-349-175', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless, 34.9)', family:'fox-transfer-neo', price:860, weight:755, diameter:34.9, drop:175, desc:'travel confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated' },
  { id:'dp-fox-transfer-neo-349-200', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless, 34.9)', family:'fox-transfer-neo', price:860, weight:805, diameter:34.9, drop:200, verified:true, lastChecked:'2026-07-08', source:'https://ridefox.com/pages/transfer-neo', desc:'805g (34.9x200mm) is the maker-stated figure on the fetched transfer-neo page' },
  { id:'dp-fox-transfer-neo-349-225', cat:'dropper', brand:'Fox', model:'Transfer Neo (wireless, 34.9)', family:'fox-transfer-neo', price:860, weight:855, diameter:34.9, drop:225, desc:'225mm (longest 34.9 travel, launched Jan 2026) confirmed via fetched ridefox.com/pages/transfer-neo; weight interpolated from the 34.9x200 real anchor (805g)' },
  /* RockShox Reverb AXS B1: a DISTINCT, newer generation from the existing (unlabeled, original-gen) 170mm-only
     rows above - fetched sram.com/en/rockshox/models/sp-rvb-axs-b1 (2026-07-08) confirms 30.9/31.6/34.9mm x
     100/125/150/175/200/225/250mm (25mm steps, no 170mm at all - zero id collision with the existing rows) and
     MSRP $599 (matching shop.sram.com's listed regular price). One real anchor: 712g at 31.6x200mm WITHOUT
     battery (battery +25g, SRAM's own convention per DATA-ENTRY-TEMPLATE); other cells interpolated at
     ~20g/25mm-step and +/-8-17g per diameter step (consistent with this catalog's other AXS/dropper deltas). */
  { id:'dp-rockshox-reverb-axs-b1-309-100', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (30.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:624, diameter:30.9, drop:100, desc:'B1 generation (new 100-250mm 25mm-step range, distinct from the original 170mm-only Reverb AXS rows above); travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated from the 31.6x200 real anchor (712g w/o battery)' },
  { id:'dp-rockshox-reverb-axs-b1-309-125', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (30.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:644, diameter:30.9, drop:125, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-309-150', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (30.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:664, diameter:30.9, drop:150, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-309-175', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (30.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:684, diameter:30.9, drop:175, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-309-200', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (30.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:704, diameter:30.9, drop:200, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated from the 31.6x200 real anchor (712g) minus the diameter delta' },
  { id:'dp-rockshox-reverb-axs-b1-309-225', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (30.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:724, diameter:30.9, drop:225, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-309-250', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (30.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:744, diameter:30.9, drop:250, desc:'250mm is the longest dropper travel in this catalog (B1\'s headline feature); travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-316-100', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:632, diameter:31.6, drop:100, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated from the 200mm real anchor (712g)' },
  { id:'dp-rockshox-reverb-axs-b1-316-125', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:652, diameter:31.6, drop:125, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-316-150', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:672, diameter:31.6, drop:150, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-316-175', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:692, diameter:31.6, drop:175, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-316-200', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:712, diameter:31.6, drop:200, verified:true, lastChecked:'2026-07-08', source:'https://www.sram.com/en/rockshox/models/sp-rvb-axs-b1', desc:'712g without battery (battery +25g per SRAM) is the maker-stated figure on the fetched SP-RVB-AXS-B1 model page - the real anchor for this whole B1 sub-family' },
  { id:'dp-rockshox-reverb-axs-b1-316-225', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:732, diameter:31.6, drop:225, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated from the 200mm real anchor (712g)' },
  { id:'dp-rockshox-reverb-axs-b1-316-250', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:752, diameter:31.6, drop:250, desc:'250mm is the longest dropper travel in this catalog; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-349-100', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (34.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:649, diameter:34.9, drop:100, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated from the 31.6x200 real anchor (712g) plus the diameter delta' },
  { id:'dp-rockshox-reverb-axs-b1-349-125', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (34.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:669, diameter:34.9, drop:125, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-349-150', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (34.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:689, diameter:34.9, drop:150, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-349-175', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (34.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:709, diameter:34.9, drop:175, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-349-200', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (34.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:729, diameter:34.9, drop:200, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-349-225', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (34.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:749, diameter:34.9, drop:225, desc:'B1 generation; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  { id:'dp-rockshox-reverb-axs-b1-349-250', cat:'dropper', brand:'RockShox', model:'Reverb AXS B1 (34.9)', family:'rockshox-reverb-axs', gen:'B1', price:599, weight:769, diameter:34.9, drop:250, desc:'250mm is the longest dropper travel in this catalog; travel/diameter/price from the fetched sram.com model page SP-RVB-AXS-B1; weight interpolated' },
  /* PNW Loam Gen 2: fetched pnwcomponents.com/products/loam-dropper-post (2026-07-08) gives an EXACT per-cell
     table (diameter x travel x weight x price, uniform $229) - 30.9 (125/150/175/200/225), 31.6 (125/150/175/
     200/225 - previously entirely uncatalogued), 34.9 (125/150/175/200/225, though 150 is currently sold out
     with no weight published). */
  { id:'dp-pnw-loam-309-125', cat:'dropper', brand:'PNW', model:'Loam 30.9', family:'pnw-loam', price:229, weight:452, diameter:30.9, drop:125, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post' },
  { id:'dp-pnw-loam-309-150', cat:'dropper', brand:'PNW', model:'Loam 30.9', family:'pnw-loam', price:229, weight:490, diameter:30.9, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post' },
  { id:'dp-pnw-loam-309-200', cat:'dropper', brand:'PNW', model:'Loam 30.9', family:'pnw-loam', price:229, weight:560, diameter:30.9, drop:200, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post' },
  { id:'dp-pnw-loam-309-225', cat:'dropper', brand:'PNW', model:'Loam 30.9', family:'pnw-loam', price:229, weight:614, diameter:30.9, drop:225, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post', desc:'225mm is the longest 30.9 Loam travel' },
  { id:'dp-pnw-loam-316-125', cat:'dropper', brand:'PNW', model:'Loam', family:'pnw-loam', price:229, weight:470, diameter:31.6, drop:125, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post', desc:'31.6mm was previously entirely uncatalogued for this family (only 30.9 and 34.9 existed)' },
  { id:'dp-pnw-loam-316-150', cat:'dropper', brand:'PNW', model:'Loam', family:'pnw-loam', price:229, weight:510, diameter:31.6, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post' },
  { id:'dp-pnw-loam-316-175', cat:'dropper', brand:'PNW', model:'Loam', family:'pnw-loam', price:229, weight:544, diameter:31.6, drop:175, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post' },
  { id:'dp-pnw-loam-316-200', cat:'dropper', brand:'PNW', model:'Loam', family:'pnw-loam', price:229, weight:580, diameter:31.6, drop:200, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post' },
  { id:'dp-pnw-loam-316-225', cat:'dropper', brand:'PNW', model:'Loam', family:'pnw-loam', price:229, weight:636, diameter:31.6, drop:225, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post', desc:'225mm is the longest 31.6 Loam travel' },
  { id:'dp-pnw-loam-349-125', cat:'dropper', brand:'PNW', model:'Loam 34.9', family:'pnw-loam', price:229, weight:516, diameter:34.9, drop:125, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post' },
  { id:'dp-pnw-loam-349-150', cat:'dropper', brand:'PNW', model:'Loam 34.9', family:'pnw-loam', price:229, weight:556, diameter:34.9, drop:150, desc:'150mm/34.9 is a real listed SKU but was shown Sold Out with no weight published on the fetched pnwcomponents.com page; weight interpolated between the 125mm (516g) and 175mm (596g) siblings' },
  { id:'dp-pnw-loam-349-175', cat:'dropper', brand:'PNW', model:'Loam 34.9', family:'pnw-loam', price:229, weight:596, diameter:34.9, drop:175, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post' },
  { id:'dp-pnw-loam-349-225', cat:'dropper', brand:'PNW', model:'Loam 34.9', family:'pnw-loam', price:229, weight:700, diameter:34.9, drop:225, verified:true, lastChecked:'2026-07-08', source:'https://www.pnwcomponents.com/products/loam-dropper-post', desc:'225mm is the longest 34.9 Loam travel' },
  /* Wolf Tooth Resolve rev2: wolftoothcomponents.com product pages render nav-only to fetch tools (same wall
     noted on the existing 309-200 row), so this uses fetched retailer/press pages (bike24.com, bikerumor.com,
     modernbike.com). rev2 ADDS the 34.9mm diameter + 242mm travel over rev1 (existing 200mm rows may be either
     gen since the id/fit didn't change) - tagged gen:'rev2' since these specific cells are rev2-exclusive.
     Real anchors: 30.9x125=441g, 31.6x125=457g, 31.6x160=510g (all from fetched press coverage); 34.9x160=584g,
     34.9x200=648g, 34.9x242=711g (bikerumor.com launch article). Other cells interpolated from those anchors. */
  { id:'dp-wolftooth-resolve-309-125', cat:'dropper', brand:'Wolf Tooth', model:'Resolve rev2 (30.9)', family:'wolftooth-resolve', gen:'rev2', price:350, weight:441, diameter:30.9, drop:125, desc:'441g is the maker-stated rev2 weight per a fetched WebSearch of official press coverage; $349.95 rev2 launch price (rounded to 350) confirmed via bikerumor.com' },
  { id:'dp-wolftooth-resolve-309-160', cat:'dropper', brand:'Wolf Tooth', model:'Resolve rev2 (30.9)', family:'wolftooth-resolve', gen:'rev2', price:350, weight:489, diameter:30.9, drop:160, desc:'160mm travel confirmed via fetched airparkbikeco.com/modernbike.com retailer listings; weight interpolated between the 125mm real anchor (441g) and the existing 200mm sibling (544g)' },
  { id:'dp-wolftooth-resolve-309-242', cat:'dropper', brand:'Wolf Tooth', model:'Resolve rev2 (30.9)', family:'wolftooth-resolve', gen:'rev2', price:350, weight:602, diameter:30.9, drop:242, desc:'242mm (rev2\'s new longest travel, "world\'s longest dropper" per bikerumor.com/bikepacking.com launch coverage) confirmed via fetched modernbike.com listing; weight extrapolated from the existing 200mm sibling (544g)' },
  { id:'dp-wolftooth-resolve-316-125', cat:'dropper', brand:'Wolf Tooth', model:'Resolve rev2', family:'wolftooth-resolve', gen:'rev2', price:350, weight:457, diameter:31.6, drop:125, desc:'457g is the maker-stated rev2 weight per fetched official press coverage' },
  { id:'dp-wolftooth-resolve-316-160', cat:'dropper', brand:'Wolf Tooth', model:'Resolve rev2', family:'wolftooth-resolve', gen:'rev2', price:350, weight:510, diameter:31.6, drop:160, desc:'510g (160mm, "2g lighter than rev1") is the maker-stated rev2 weight per the fetched bikerumor.com launch article' },
  { id:'dp-wolftooth-resolve-316-242', cat:'dropper', brand:'Wolf Tooth', model:'Resolve rev2', family:'wolftooth-resolve', gen:'rev2', price:350, weight:704, diameter:31.6, drop:242, desc:'242mm (rev2\'s new longest travel) confirmed via fetched modernbike.com "31.6, 242mm Travel" listing; weight extrapolated from the 160mm real anchor (510g) and the existing 200mm sibling (640g)' },
  { id:'dp-wolftooth-resolve-349-160', cat:'dropper', brand:'Wolf Tooth', model:'Resolve rev2 (34.9)', family:'wolftooth-resolve', gen:'rev2', price:350, weight:584, diameter:34.9, drop:160, desc:'584g is the maker-stated rev2 weight per the fetched bikerumor.com launch article (34.9 is a rev2-exclusive diameter - rev1 topped out at 31.6); NOTE: 34.9 does not offer 125mm travel (confirmed: "available in all of the same drop options apart from the shortest 125mm one")' },
  { id:'dp-wolftooth-resolve-349-200', cat:'dropper', brand:'Wolf Tooth', model:'Resolve rev2 (34.9)', family:'wolftooth-resolve', gen:'rev2', price:350, weight:648, diameter:34.9, drop:200, desc:'648g is the maker-stated rev2 weight per the fetched bikerumor.com launch article' },
  { id:'dp-wolftooth-resolve-349-242', cat:'dropper', brand:'Wolf Tooth', model:'Resolve rev2 (34.9)', family:'wolftooth-resolve', gen:'rev2', price:350, weight:711, diameter:34.9, drop:242, desc:'711g (242mm, rev2\'s new longest travel) is the maker-stated weight per the fetched bikerumor.com launch article' },
  /* Crankbrothers Highline 7: fetched crankbrothers.com/products/highline-7-dropper (2026-07-08) gives an EXACT
     per-cell table; the fetched 100/125/150/170/200mm figures match the existing verified 170mm rows exactly
     (583g/604g), confirming this page's reliability. No 34.9mm option exists for this model. */
  { id:'dp-crankbrothers-highline-7-309-100', cat:'dropper', brand:'Crankbrothers', model:'Highline 7 (30.9)', family:'crankbrothers-highline', price:290, weight:474, diameter:30.9, drop:100, verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/highline-7-dropper' },
  { id:'dp-crankbrothers-highline-7-309-125', cat:'dropper', brand:'Crankbrothers', model:'Highline 7 (30.9)', family:'crankbrothers-highline', price:290, weight:515, diameter:30.9, drop:125, verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/highline-7-dropper' },
  { id:'dp-crankbrothers-highline-7-309-150', cat:'dropper', brand:'Crankbrothers', model:'Highline 7 (30.9)', family:'crankbrothers-highline', price:290, weight:550, diameter:30.9, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/highline-7-dropper' },
  { id:'dp-crankbrothers-highline-7-316-100', cat:'dropper', brand:'Crankbrothers', model:'Highline 7', family:'crankbrothers-highline', price:290, weight:490, diameter:31.6, drop:100, verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/highline-7-dropper' },
  { id:'dp-crankbrothers-highline-7-316-125', cat:'dropper', brand:'Crankbrothers', model:'Highline 7', family:'crankbrothers-highline', price:290, weight:532, diameter:31.6, drop:125, verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/highline-7-dropper' },
  { id:'dp-crankbrothers-highline-7-316-150', cat:'dropper', brand:'Crankbrothers', model:'Highline 7', family:'crankbrothers-highline', price:290, weight:572, diameter:31.6, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/highline-7-dropper' },
  { id:'dp-crankbrothers-highline-7-316-200', cat:'dropper', brand:'Crankbrothers', model:'Highline 7', family:'crankbrothers-highline', price:290, weight:679, diameter:31.6, drop:200, verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/highline-7-dropper', desc:'200mm is the longest Highline 7 travel (31.6 only - 30.9 tops out at 170mm)' },
  /* Race Face Turbine R: no maker spec table fetch succeeded, so this uses fetched retailer SKU listings
     (universalcycles.com lists explicit SKUs SP21TURRDP{30.9,31.6}X{125,150,175}BLK + SP22TURRDP{...}X200BLK -
     confirming these exact diameter x travel combos exist; no 34.9mm SKU appears). One real weight anchor
     (30.9x150=545g per raceface.com); other cells interpolated. Real MSRP ~$309-314 (universalcycles.com). */
  { id:'dp-raceface-turbine-r-309-125', cat:'dropper', brand:'Race Face', model:'Turbine R (30.9)', family:'raceface-turbine-r', price:310, weight:520, diameter:30.9, drop:125, desc:'SKU SP21TURRDP30.9X125BLK confirmed via fetched universalcycles.com listing; weight interpolated from the 150mm real anchor (545g)' },
  { id:'dp-raceface-turbine-r-309-150', cat:'dropper', brand:'Race Face', model:'Turbine R (30.9)', family:'raceface-turbine-r', price:310, weight:545, diameter:30.9, drop:150, desc:'545g is the maker-stated weight (raceface.com) for this exact size (30.9x150mm); SKU SP21TURRDP30.9X150BLK confirmed via fetched universalcycles.com listing' },
  { id:'dp-raceface-turbine-r-309-175', cat:'dropper', brand:'Race Face', model:'Turbine R (30.9)', family:'raceface-turbine-r', price:310, weight:570, diameter:30.9, drop:175, desc:'SKU SP21TURRDP30.9X175BLK confirmed via fetched universalcycles.com listing; weight interpolated from the 150mm real anchor (545g)' },
  { id:'dp-raceface-turbine-r-309-200', cat:'dropper', brand:'Race Face', model:'Turbine R (30.9)', family:'raceface-turbine-r', price:314, weight:595, diameter:30.9, drop:200, desc:'SKU SP22TURRDP30.9X200BLK ($313.99) confirmed via fetched universalcycles.com listing; weight interpolated' },
  { id:'dp-raceface-turbine-r-316-125', cat:'dropper', brand:'Race Face', model:'Turbine R', family:'raceface-turbine-r', price:310, weight:535, diameter:31.6, drop:125, desc:'SKU SP21TURRDP31.6X125BLK confirmed via fetched universalcycles.com listing; weight interpolated from the +15g/diameter-step pattern used elsewhere in this catalog\'s dropper family' },
  { id:'dp-raceface-turbine-r-316-150', cat:'dropper', brand:'Race Face', model:'Turbine R', family:'raceface-turbine-r', price:310, weight:560, diameter:31.6, drop:150, desc:'SKU SP21TURRDP31.6X150BLK confirmed via fetched universalcycles.com listing; weight interpolated' },
  { id:'dp-raceface-turbine-r-316-200', cat:'dropper', brand:'Race Face', model:'Turbine R', family:'raceface-turbine-r', price:314, weight:610, diameter:31.6, drop:200, desc:'SKU SP22TURRDP31.6X200BLK ($313.99) confirmed via fetched universalcycles.com listing; weight interpolated' },
  /* SDG Tellis V2: fetched sdgcomponents.com/products/tellis-v2-dropper-post (2026-07-08) directly confirms
     ALL 3 diameters (30.9/31.6/34.9) offer ALL 7 travels (75/100/125/150/170/200/230mm) at a uniform $224.99 -
     both diameter/drop AND price are manufacturer-sourced. Weight is interpolated from 2 real per-size anchors
     (31.6x170=609g "with rail clamping hardware", 31.6x200=641g, both from fetched review coverage) using
     ~1.07g/mm and the same per-diameter deltas already established by the existing 170mm sibling rows. */
  { id:'dp-sdg-tellis-316-75', cat:'dropper', brand:'SDG', model:'Tellis V2', family:'sdg-tellis', price:225, weight:508, diameter:31.6, drop:75, desc:'75mm (shortest Tellis V2 travel) confirmed via fetched sdgcomponents.com product page; weight interpolated from the 170mm/200mm real anchors (609g/641g)' },
  { id:'dp-sdg-tellis-316-100', cat:'dropper', brand:'SDG', model:'Tellis V2', family:'sdg-tellis', price:225, weight:534, diameter:31.6, drop:100, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated' },
  { id:'dp-sdg-tellis-316-125', cat:'dropper', brand:'SDG', model:'Tellis V2', family:'sdg-tellis', price:225, weight:561, diameter:31.6, drop:125, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated' },
  { id:'dp-sdg-tellis-316-150', cat:'dropper', brand:'SDG', model:'Tellis V2', family:'sdg-tellis', price:225, weight:588, diameter:31.6, drop:150, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated' },
  { id:'dp-sdg-tellis-316-200', cat:'dropper', brand:'SDG', model:'Tellis V2', family:'sdg-tellis', price:225, weight:641, diameter:31.6, drop:200, desc:'641g is a real per-size anchor from fetched review coverage (theloamwolf.com/mbr.co.uk)' },
  { id:'dp-sdg-tellis-316-230', cat:'dropper', brand:'SDG', model:'Tellis V2', family:'sdg-tellis', price:225, weight:673, diameter:31.6, drop:230, desc:'230mm is the longest Tellis V2 travel ("one of the largest dropper travel ranges in the game" per sdgcomponents.com); weight extrapolated from the 200mm real anchor (641g)' },
  { id:'dp-sdg-tellis-309-75', cat:'dropper', brand:'SDG', model:'Tellis V2 (30.9)', family:'sdg-tellis', price:225, weight:494, diameter:30.9, drop:75, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated (30.9 runs ~14g under the 31.6 sibling, matching this catalog\'s existing 170mm 30.9/31.6 delta)' },
  { id:'dp-sdg-tellis-309-100', cat:'dropper', brand:'SDG', model:'Tellis V2 (30.9)', family:'sdg-tellis', price:225, weight:520, diameter:30.9, drop:100, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated' },
  { id:'dp-sdg-tellis-309-125', cat:'dropper', brand:'SDG', model:'Tellis V2 (30.9)', family:'sdg-tellis', price:225, weight:547, diameter:30.9, drop:125, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated' },
  { id:'dp-sdg-tellis-309-150', cat:'dropper', brand:'SDG', model:'Tellis V2 (30.9)', family:'sdg-tellis', price:225, weight:574, diameter:30.9, drop:150, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated' },
  { id:'dp-sdg-tellis-309-200', cat:'dropper', brand:'SDG', model:'Tellis V2 (30.9)', family:'sdg-tellis', price:225, weight:627, diameter:30.9, drop:200, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated from the 31.6x200 real anchor (641g)' },
  { id:'dp-sdg-tellis-309-230', cat:'dropper', brand:'SDG', model:'Tellis V2 (30.9)', family:'sdg-tellis', price:225, weight:659, diameter:30.9, drop:230, desc:'230mm is the longest Tellis V2 travel; weight extrapolated' },
  { id:'dp-sdg-tellis-349-75', cat:'dropper', brand:'SDG', model:'Tellis V2 (34.9)', family:'sdg-tellis', price:225, weight:528, diameter:34.9, drop:75, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated (34.9 runs ~20g over the 31.6 sibling, matching this catalog\'s existing 170mm 34.9/31.6 delta)' },
  { id:'dp-sdg-tellis-349-100', cat:'dropper', brand:'SDG', model:'Tellis V2 (34.9)', family:'sdg-tellis', price:225, weight:554, diameter:34.9, drop:100, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated' },
  { id:'dp-sdg-tellis-349-125', cat:'dropper', brand:'SDG', model:'Tellis V2 (34.9)', family:'sdg-tellis', price:225, weight:581, diameter:34.9, drop:125, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated' },
  { id:'dp-sdg-tellis-349-150', cat:'dropper', brand:'SDG', model:'Tellis V2 (34.9)', family:'sdg-tellis', price:225, weight:608, diameter:34.9, drop:150, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated' },
  { id:'dp-sdg-tellis-349-200', cat:'dropper', brand:'SDG', model:'Tellis V2 (34.9)', family:'sdg-tellis', price:225, weight:661, diameter:34.9, drop:200, desc:'confirmed via fetched sdgcomponents.com product page; weight interpolated from the 31.6x200 real anchor (641g)' },
  { id:'dp-sdg-tellis-349-230', cat:'dropper', brand:'SDG', model:'Tellis V2 (34.9)', family:'sdg-tellis', price:225, weight:693, diameter:34.9, drop:230, desc:'230mm is the longest Tellis V2 travel; weight extrapolated' },
  /* KS LEV Integra: fetched kssuspension.com/products/dropper-seat-posts/lev-integra/ (2026-07-08) gives an
     EXACT per-cell manufacturer table (diameter x travel x length x insert x weight) - the best-sourced brand
     in this whole pass, no interpolation needed anywhere. Confirms 30.9/31.6mm in 65/100/125/150/175/200mm and
     34.9mm in 125/150/175/200mm (no 65/100 for 34.9). Table also exposed + fixed the 175mm weight-swap error
     corrected earlier in this same commit (see the 316-175/309-175 rows above). */
  { id:'dp-ks-lev-integra-309-65', cat:'dropper', brand:'KS', model:'LEV Integra (30.9)', family:'ks-lev-integra', price:300, weight:364, diameter:30.9, drop:65, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/', desc:'65mm is the shortest LEV Integra travel; exact weight from the fetched kssuspension.com spec table' },
  { id:'dp-ks-lev-integra-309-100', cat:'dropper', brand:'KS', model:'LEV Integra (30.9)', family:'ks-lev-integra', price:300, weight:397, diameter:30.9, drop:100, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/' },
  { id:'dp-ks-lev-integra-309-125', cat:'dropper', brand:'KS', model:'LEV Integra (30.9)', family:'ks-lev-integra', price:300, weight:478, diameter:30.9, drop:125, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/' },
  { id:'dp-ks-lev-integra-309-150', cat:'dropper', brand:'KS', model:'LEV Integra (30.9)', family:'ks-lev-integra', price:300, weight:519, diameter:30.9, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/' },
  { id:'dp-ks-lev-integra-309-200', cat:'dropper', brand:'KS', model:'LEV Integra (30.9)', family:'ks-lev-integra', price:300, weight:590, diameter:30.9, drop:200, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/', desc:'200mm is the longest 30.9 LEV Integra travel' },
  { id:'dp-ks-lev-integra-316-65', cat:'dropper', brand:'KS', model:'LEV Integra', family:'ks-lev-integra', price:300, weight:375, diameter:31.6, drop:65, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/' },
  { id:'dp-ks-lev-integra-316-100', cat:'dropper', brand:'KS', model:'LEV Integra', family:'ks-lev-integra', price:300, weight:399, diameter:31.6, drop:100, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/' },
  { id:'dp-ks-lev-integra-316-125', cat:'dropper', brand:'KS', model:'LEV Integra', family:'ks-lev-integra', price:300, weight:496, diameter:31.6, drop:125, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/' },
  { id:'dp-ks-lev-integra-316-150', cat:'dropper', brand:'KS', model:'LEV Integra', family:'ks-lev-integra', price:300, weight:540, diameter:31.6, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/' },
  { id:'dp-ks-lev-integra-316-200', cat:'dropper', brand:'KS', model:'LEV Integra', family:'ks-lev-integra', price:300, weight:612, diameter:31.6, drop:200, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/', desc:'200mm is the longest 31.6 LEV Integra travel' },
  { id:'dp-ks-lev-integra-349-125', cat:'dropper', brand:'KS', model:'LEV Integra (34.9)', family:'ks-lev-integra', price:300, weight:558, diameter:34.9, drop:125, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/', desc:'34.9mm was previously entirely uncatalogued for this family (only 30.9/31.6 existed); no 65/100mm travel offered at 34.9 per the fetched spec table' },
  { id:'dp-ks-lev-integra-349-150', cat:'dropper', brand:'KS', model:'LEV Integra (34.9)', family:'ks-lev-integra', price:300, weight:615, diameter:34.9, drop:150, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/' },
  { id:'dp-ks-lev-integra-349-175', cat:'dropper', brand:'KS', model:'LEV Integra (34.9)', family:'ks-lev-integra', price:300, weight:657, diameter:34.9, drop:175, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/' },
  { id:'dp-ks-lev-integra-349-200', cat:'dropper', brand:'KS', model:'LEV Integra (34.9)', family:'ks-lev-integra', price:300, weight:712, diameter:34.9, drop:200, verified:true, lastChecked:'2026-07-08', source:'https://kssuspension.com/products/dropper-seat-posts/lev-integra/', desc:'200mm is the longest 34.9 LEV Integra travel' },
...
var ALIASES = {
  ...
  'dp-fallline': 'dp-9point8-fall-line-316-175',   // flattened (2026-07-08 model correction, was mislabeled "Fall Line R")
  'dp-9point8-fall-line-r-316-175': 'dp-9point8-fall-line-316-175',   // 2026-07-08: mislabeled model - 175mm stroke belongs to plain Fall Line, not Fall Line R (which tops out at 150mm)

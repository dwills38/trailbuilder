...
var PARTS = [
  ...
  { id:'fr-privateer-161-g2', cat:'frame', brand:'Privateer', model:'161', family:'privateer-161', gen:'Gen 2', disciplines:['enduro'], price:2500, weight:4830, wheelConfigs:['29','mullet'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'ZS44/28.6', headTubeLower:'ZS56/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:203, maxTire:2.5, suspension:'full', shockEye:205, shockStroke:60, shockMount:'trunnion', maxForkTravel:180, travel:161, udh:false, bundledShock:'sh-fox-float-x2-perf-elite-205x60-trun', sizes:{ P1:{maxInsert:240}, P2:{maxInsert:260}, P3:{maxInsert:290}, P4:{maxInsert:320} }, frameOnly:false, verified:true, lastChecked:'2026-07-08', source:'https://privateerbikes.com/products/privateer-161-frameset', desc:'VERIFIED 2026-07-08 vs re-fetched privateerbikes.com 161 Gen 2 frameset page: P2 4.83kg (without shock, axle, etc.) MAKER-STATED; 161mm (174 overstroked w/ 65mm shock), 29 or mixed, 205x60 trunnion (Fox trunnion metric size), 148x12, FSA ZS44/ZS56, 73mm threaded, 31.6 post, 203 max rotor (PM certain - no 203 flat-mount exists), 2.5in design tire, UDH: NO (adjustable rear centre + flip chips); frameset ships the custom-tuned Float X2 205x60. price = sample (GBP 1,977 RRP -> ~$2,500 USD-equiv; design fork 170mm)' },
  ...
  { id:'fr-canyon-spectral-cf', cat:'frame', brand:'Canyon', model:'Spectral CF', family:'canyon-spectral', disciplines:['trail'], price:2999, weight:2900, wheelConfigs:['29','mullet'], rearAxle:'Boost148', headset:'tapered', bb:'BSA73', seatTube:34.9, brakeMount:'PM', maxRotorR:200, suspension:'full', shockEye:230, shockStroke:60, shockMount:'std', maxForkTravel:160, travel:140, udh:true, bundledShock:null, sizes:{ S:{seatTubeLen:400,maxInsert:245}, M:{seatTubeLen:415,maxInsert:275}, L:{seatTubeLen:445,maxInsert:275}, XL:{seatTubeLen:455,maxInsert:315} }, frameOnly:false, desc:'price/weight/maxForkTravel = sample (sold as a complete bike, $5,099; stock fork 150mm); interfaces from the fetched canyon.com Spectral CF 8 spec page; 230x60 via mtbr hardware corroboration; UDH per Vital 2025 spec' },
  ...
  { id:'fr-commencal-frs', cat:'frame', brand:'Commencal', model:'FRS', family:'commencal-frs', modelYear:2025, disciplines:['dh'], price:2500, weight:4220, wheelConfigs:['275'], rearAxle:'150x12', headset:'straight-dc', headTubeUpper:'ZS44/28.6', headTubeLower:'ZS56/40', bb:'PF107', seatTube:31.6, brakeMount:'PM', maxRotorR:203, suspension:'full', shockEye:250, shockStroke:75, shockMount:'std', maxForkTravel:203, travel:200, udh:false, bundledShock:null, sizes:{ S:{seatTubeLen:420,maxInsert:125}, M:{seatTubeLen:420,maxInsert:125}, L:{seatTubeLen:420,maxInsert:125}, XL:{seatTubeLen:420,maxInsert:125} }, frameOnly:true, verified:true, lastChecked:'2026-07-08', source:'https://www.commencal.com/us/en/frame-commencal-frs-pure-white/FT4FRS3.html', desc:'VERIFIED 2026-07-08 vs re-fetched commencal.com FRS 2025 frame product page (FT4FRS3): "Frame weight: 4,22 kg / 9,3 lb" MAKER-STATED; full 27.5 F+R, 200mm, 250x75 std, rear axle 150x12 (maker-explicit), ZS44/ZS56, PF107, 31.6 post, 203 max rotor, UDH: No - all maker-confirmed; price + maxForkTravel = sample (configurator prices dynamically, EUR); completes ship a Fox 40 27.5 (straight-dc steerer via reducer lower cup), brakeMount PM certain at 203mm' },
  ...
  /* --- Specialized Epic 8 + Epic Hardtail: ENTERED 2026-07-08 then REVERTED same hour.
     ...
     premise "SRAM makes no flat-mount MTB caliper" - that premise was judged FALSE at the time
     (the Canyon Lux World Cup CF 8 ships SRAM Level Silver on an MBR-confirmed FLAT-MOUNT rear,
  ...
  /* --- catalog-shocks-breadth-2 batch 3: after batch 2 every full-suspension frame
     cleared >=4 compatible brands, but three brackets were still the catalog's thinnest
     (exactly 4 brands each) - one more targeted round on those, still real
     manufacturer-page-confirmed additions. --- */
  { id:'sh-ohlins-txc2air-190x45', cat:'shock', brand:'Öhlins', model:'TXC2Air (190x45 std)', family:'ohlins-txc2air', disciplines:['xc','trail'], price:643.50, weight:255, eye:190, stroke:45, mount:'std', spring:'air', desc:'widens the Forbidden Reya 190x45 std bracket (was RockShox/Fox/DVO/Cane Creek only). FETCHED ohlins.com/en-us/mountain-bike/rear-shocks/txc2air-190x45: model "TXC2Air 190x45", part MTBM 2325, standard (non-trunnion) mount, air spring, $643.50, weight "from 255 g" - a second, distinct Öhlins family from the existing TXC1Air/TTX22 m.2 rows (Öhlins sells TXC1Air and TXC2Air as separate tune-level products in the same XC/downcountry line). Page notes the SKU is currently out of stock, which does not affect existence.' },
  { id:'sh-fox-dhx2-225x75-trun', cat:'shock', brand:'Fox', model:'DHX2 Factory (225x75 trunnion)', family:'fox-dhx2', disciplines:['dh'], price:679, weight:615, eye:225, stroke:75, mount:'trunnion', spring:'coil', soldWithout:['spring'], desc:'widens the RAAW Yalla!! V2 225x75 trunnion bracket (was RockShox/Öhlins/EXT/Formula only). Existence confirmed via six independent retailers all listing the identical SKU description ("FOX DHX2 Factory Rear Shock - Trunnion Metric, 225 x 75 mm, Hard Chrome Coat" - Modern Bike, Northwest Bicycle, Maciag Offroad, eBay, TF Tuned, Bike24); ridefox.com/tech.ridefox.com pages for DHX2 didn\'t return a fetchable size chart (JS-rendered), so this leans on the consistent independent-retailer confirmation, same evidentiary bar already used elsewhere in this catalog (e.g. the Mara/Bomber CR rows). Price mirrors the 250x75 DHX2 sibling ($679 tier); weight = body-only sample scaled up slightly from the 230x65 std sibling for the longer trunnion DH body.' },
  { id:'sh-marzocchi-bomber-cr-225x75-trun', cat:'shock', brand:'Marzocchi', model:'Bomber CR (225x75 trunnion)', family:'marzocchi-bomber-cr', disciplines:['dh'], price:329, weight:415, eye:225, stroke:75, mount:'trunnion', spring:'coil', soldWithout:['spring'], desc:'widens the RAAW Yalla!! V2 225x75 trunnion bracket. Same FETCHED bike.marzocchi.com trunnion list already used for the 205x60/62.5 siblings ("185x52.5, 185x55, 205x60, 205x62.5, 225x75") - 225x75 is explicitly the longest trunnion size Marzocchi lists. Weight = body-only sample mirroring the family; price = family/$329 tier.' },
  ...
  /* --- catalog-wheels-breadth-2 sweep: Boost110/275 front was a hidden 1-brand
     (DT Swiss) combo - not flagged by breadth-gap.js (front wheel is fork-gated,
     not frame-gated, so its per-frame method can't see it), but real: Propain
     Spindrift CF and Commencal Clash V3 are full-27.5 frames (wheelConfigs:['275'],
     no mullet) that pair with a Boost110 27.5 fork. Both new rows are the 27.5
     siblings of an EXISTING catalog 29in front row from the same family, so
     price/rotorMount/intWidth mirror the sibling except where a fetched page gave
     a size-specific number. --- */
  { id:'fw-weareone-union-275', cat:'frontwheel', brand:'We Are One', model:'Union front 27.5', family:'weareone-union', disciplines:['enduro'], price:800, weight:900, wheel:'275', hub:'Boost110', rotorMount:'sixbolt', intWidth:30, maxTire:2.6, desc:'sample specs (mirror the 29in sibling fw-weareone-union-29); 27.5in option + Industry Nine 1/1 front hub in Boost 110x15 + 30mm internal per the fetched weareonecomposites.com Union wheelset page' },
  { id:'fw-spank-359-275', cat:'frontwheel', brand:'Spank', model:'359 front 27.5', family:'spank-359', disciplines:['enduro'], price:350, weight:1004, wheel:'275', hub:'Boost110', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'27.5in Boost: 1,004g, 30.5mm internal, $349.99 (all axle variants) - all from the fetched spank-ind.com 359 Vibrocore FRONT wheel page (which also lists a 20x110 front option at 992g, not entered here - no catalog fork uses 20x110 in 27.5 yet)' },
  ...
  /* --- catalog-wheels-breadth-2 continued sweep: the 20x110 Boost front-wheel category
     was still thin (only DT Swiss + Crankbrothers, 2 brands) even after the 150x12
     rear-wheel fix above - and it is real breadth, not a phantom gap: four in-catalog
     DH forks (RockShox BoXXer Ultimate x2, Fox 40 Factory, Öhlins DH38 m.2 x2) all use
     axle:'20x110'. Two more real brands added at the same axle, both already-cataloged
     families getting their natural DH-front sibling. --- */
  { id:'fw-ethirteen-lg1r-29', cat:'frontwheel', brand:'e*thirteen', model:'LG1r DH front (20x110)', family:'ethirteen-lg1r', disciplines:['dh'], price:584, weight:962, wheel:'29', hub:'20x110', rotorMount:'sixbolt', intWidth:31, maxTire:2.6, desc:'the front-wheel sibling of the already-cataloged rw-ethirteen-lg1r-* DH rear rows; native 20x110 Boost, 6-bolt, 31mm internal, 962g (29in), $584 - corroborated across multiple fetched/cached retailer SKU pages for the "LG1r Carbon Front Wheel" (treefortbikes.com, Amazon, Modern Bike, Alaska Bicycle Center all independently state 20x110mm/6-Bolt/31mm-internal for this exact product); widens 20x110 front from 2 brands (DT Swiss, Crankbrothers) to 3' },
  { id:'fw-ethirteen-lg1r-275', cat:'frontwheel', brand:'e*thirteen', model:'LG1r DH front 27.5 (20x110)', family:'ethirteen-lg1r', disciplines:['dh'], price:584, weight:961, wheel:'275', hub:'20x110', rotorMount:'sixbolt', intWidth:31, maxTire:2.6, desc:'27.5in sibling of fw-ethirteen-lg1r-29 (same fetched/retailer-corroborated 20x110 Boost/6-bolt/31mm-internal spec, 961g per the same SKU family); pairs with the existing rw-ethirteen-lg1r-275-150-xd rear for a complete 27.5 DH LG1r build' },
  { id:'fw-spank-359-29-20x110', cat:'frontwheel', brand:'Spank', model:'359 front 20x110', family:'spank-359', disciplines:['dh'], price:300, weight:1000, wheel:'29', hub:'20x110', rotorMount:'sixbolt', intWidth:31, maxTire:2.6, desc:'the 20x110 DH end-cap option of the same physical wheel as fw-spank-359-29 (Boost110 sibling): "15/20x110 Boost options... front hub is 15x110 but the wheels come with a 20x110 adapter too" per the fetched bike24.com "Spank 359 VibroCore 29 Inch Front Wheel - 6-Bolt - 15x110/20x110mm" listing (spank-ind.com\'s own 359 front-wheel page corroborates the dual-axle option); price/weight mirror the Boost sibling (same wheel, swapped end cap)' },
  { id:'fw-spank-359-275-20x110', cat:'frontwheel', brand:'Spank', model:'359 front 27.5 20x110', family:'spank-359', disciplines:['dh'], price:350, weight:992, wheel:'275', hub:'20x110', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'the 20x110 front option already noted-but-not-entered in the sibling fw-spank-359-275 row\'s own desc ("also lists a 20x110 front option at 992g, not entered here - no catalog fork uses 20x110 in 27.5 yet") - that blocker is now void: fk-rockshox-boxxer-ultimate-275-200 and fk-ohlins-dh38-m2-275-200 both use axle 20x110. 992g / $349.99 (all axle variants) per the same fetched spank-ind.com 359 Vibrocore FRONT wheel page the sibling row cites' },
  ...
  /* --- catalog-wheels-breadth-2 (2026-07-08): fixes the 12x150 rear-wheel 0/1-brand
     collapse on the Commencal FRS (275, 150x12) and YT Tues CF 29 (29, 150x12) - both
     previously resolved to DT Swiss (rw-dtswiss-fr-1500-*-150) alone. Adds THREE more
     real DH-capable brands at the exact 150x12 axle, each confirmed via its own fetched
     manufacturer/retailer page, plus their 157x12 SuperBoost end-cap siblings (same
     physical wheel, swapped end cap - the dtswiss-fr-1500-*-150/157 precedent) to also
     deepen the SuperBoost157/275 combo (previously DT Swiss only there too). --- */
  { id:'rw-hope-fortus-30-29-150-xd', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear (150/157, XD)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'29', hub:'150x12', freehub:'XD', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'same Fortus 30 Pro 5 platform as the Boost148 sibling rows, sold with interchangeable end caps for "135/142mm, 148mm Boost, 150mm & 157mm" per the fetched hopetech.com Fortus 30 Pro 5 page (30mm internal/35mm external, Centerlock or 6-bolt - 6-bolt kept for convention, Shimano Aluminium/Steel/MicroSpline/SRAM XD freehub options, rear $425.15 ex tax); weight = sample (mirrors the Boost148 sibling - no per-axle weight published)' },
  { id:'rw-hope-fortus-30-29-150-ms', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear (150/157, Micro Spline)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'29', hub:'150x12', freehub:'MicroSpline', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'sample specs (mirror XD sibling); Shimano MicroSpline is one of the freehub options on the same fetched hopetech.com Fortus 30 Pro 5 page' },
  { id:'rw-hope-fortus-30-275-150-xd', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear 27.5 (150/157, XD)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'275', hub:'150x12', freehub:'XD', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'same 27.5in Fortus 30 Pro 5 platform as the Boost148 sibling rows, with the 150/157 end-cap option per the fetched hopetech.com Fortus 30 Pro 5 page; weight = sample (mirror sibling)' },
  { id:'rw-hope-fortus-30-275-150-ms', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear 27.5 (150/157, Micro Spline)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'275', hub:'150x12', freehub:'MicroSpline', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'sample specs (mirror XD sibling); MicroSpline is one of the freehub options on the same fetched hopetech.com page' },
  { id:'rw-hope-fortus-30-29-157-xd', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear (150/157, SuperBoost, XD)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'29', hub:'SuperBoost157', freehub:'XD', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'the 157mm SuperBoost end-cap option of the same physical wheel as rw-hope-fortus-30-29-150-xd (DT Swiss FR1500 150/157 precedent) - "150mm & 157mm" both listed on the fetched hopetech.com Fortus 30 Pro 5 page' },
  { id:'rw-hope-fortus-30-29-157-ms', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear (150/157, SuperBoost, Micro Spline)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'29', hub:'SuperBoost157', freehub:'MicroSpline', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'157mm SuperBoost end-cap sibling of rw-hope-fortus-30-29-150-ms' },
  { id:'rw-hope-fortus-30-275-157-xd', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear 27.5 (150/157, SuperBoost, XD)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'275', hub:'SuperBoost157', freehub:'XD', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'157mm SuperBoost end-cap sibling of rw-hope-fortus-30-275-150-xd; fixes the SuperBoost157/275 combo (previously DT Swiss only)' },
  { id:'rw-hope-fortus-30-275-157-ms', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear 27.5 (150/157, SuperBoost, Micro Spline)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'275', hub:'SuperBoost157', freehub:'MicroSpline', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'157mm SuperBoost end-cap sibling of rw-hope-fortus-30-275-150-ms' },
  /* --- catalog-wheels-breadth-2 continued sweep: the Hope Fortus 30 Pro 5's own
     fetched hopetech.com page ("Shimano Aluminium, Shimano Steel, MicroSpline and
     Sram XD freehub body options available") was already cited by the XD/MS rows
     above, but no HG row was entered - leaving the HG-freehub slice of 150x12 and
     SuperBoost157 (both wheel sizes) as an e*thirteen-only 1-brand thinness. Filling
     in the missing HG siblings (no new fetch needed - same page, same platform). --- */
  { id:'rw-hope-fortus-30-29-150-hg', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear (150/157, Shimano HG)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'29', hub:'150x12', freehub:'HG', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'sample specs (mirror XD/MS siblings); Shimano HG (Aluminium/Steel) is one of the freehub options on the same fetched hopetech.com Fortus 30 Pro 5 page - fills the missing HG row (previously e*thirteen alone had an HG option at 150x12)' },
  { id:'rw-hope-fortus-30-275-150-hg', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear 27.5 (150/157, Shimano HG)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'275', hub:'150x12', freehub:'HG', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'27.5in sibling of rw-hope-fortus-30-29-150-hg' },
  { id:'rw-hope-fortus-30-29-157-hg', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear (150/157, SuperBoost, Shimano HG)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'29', hub:'SuperBoost157', freehub:'HG', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'157mm SuperBoost end-cap sibling of rw-hope-fortus-30-29-150-hg' },
  { id:'rw-hope-fortus-30-275-157-hg', cat:'rearwheel', brand:'Hope', model:'Fortus 30 Pro 5 rear 27.5 (150/157, SuperBoost, Shimano HG)', family:'hope-fortus', gen:'Pro 5', disciplines:['dh'], price:425, weight:1270, wheel:'275', hub:'SuperBoost157', freehub:'HG', rotorMount:'sixbolt', intWidth:30, maxTire:2.8, desc:'157mm SuperBoost end-cap sibling of rw-hope-fortus-30-275-150-hg; fixes the SuperBoost157/275 HG slice too' },
  { id:'rw-ethirteen-lg1r-29-150-xd', cat:'rearwheel', brand:'e*thirteen', model:'LG1r DH rear (XD)', family:'ethirteen-lg1r', disciplines:['dh'], price:715, weight:1485, wheel:'29', hub:'150x12', freehub:'XD', rotorMount:'sixbolt', intWidth:30, maxTire:2.6, desc:'e*thirteen\'s DH-specific LG1 Race Carbon wheel: native 150x12 rear axle (157x12 SuperBoost end-cap sibling below), front DH Boost 20x110, 30mm internal, 1,485g rear/29in - all from the fetched ethirteen.eu "LG1 Race Carbon Downhill Wheels" page; 6-bolt + SRAM XD/Shimano 11-speed freehub options confirmed via the fetched worldwidecyclery.com LG1r spec review (also the $715 rear price used here - the maker page\'s own price was a discounted sale figure, not a stable MSRP)' },
  { id:'rw-ethirteen-lg1r-29-150-hg', cat:'rearwheel', brand:'e*thirteen', model:'LG1r DH rear (Shimano HG)', family:'ethirteen-lg1r', disciplines:['dh'], price:715, weight:1485, wheel:'29', hub:'150x12', freehub:'HG', rotorMount:'sixbolt', intWidth:30, maxTire:2.6, desc:'sample specs (mirror XD sibling); "SRAM XD or Shimano 11-speed Freehub" per the fetched worldwidecyclery.com LG1r spec review - the 11-speed Shimano option is an HG-spline body' },
  { id:'rw-ethirteen-lg1r-275-150-xd', cat:'rearwheel', brand:'e*thirteen', model:'LG1r DH rear 27.5 (XD)', family:'ethirteen-lg1r', disciplines:['dh'], price:715, weight:1448, wheel:'275', hub:'150x12', freehub:'XD', rotorMount:'sixbolt', intWidth:30, maxTire:2.6, desc:'27.5in LG1 Race Carbon Downhill rear, 1,448g per the fetched ethirteen.eu page; same 150x12 native / 157x12 end-cap + freehub sourcing as the 29in sibling' },
  { id:'rw-ethirteen-lg1r-275-150-hg', cat:'rearwheel', brand:'e*thirteen', model:'LG1r DH rear 27.5 (Shimano HG)', family:'ethirteen-lg1r', disciplines:['dh'], price:715, weight:1448, wheel:'275', hub:'150x12', freehub:'HG', rotorMount:'sixbolt', intWidth:30, maxTire:2.6, desc:'sample specs (mirror XD sibling)' },
  { id:'rw-ethirteen-lg1r-29-157-xd', cat:'rearwheel', brand:'e*thirteen', model:'LG1r DH rear (SuperBoost, XD)', family:'ethirteen-lg1r', disciplines:['dh'], price:715, weight:1485, wheel:'29', hub:'SuperBoost157', freehub:'XD', rotorMount:'sixbolt', intWidth:30, maxTire:2.6, desc:'the 157x12 SuperBoost end-cap option of the same physical wheel as rw-ethirteen-lg1r-29-150-xd ("150x12 standard; 157x12 optional endcap available" per the fetched ethirteen.eu page)' },
  { id:'rw-ethirteen-lg1r-29-157-hg', cat:'rearwheel', brand:'e*thirteen', model:'LG1r DH rear (SuperBoost, Shimano HG)', family:'ethirteen-lg1r', disciplines:['dh'], price:715, weight:1485, wheel:'29', hub:'SuperBoost157', freehub:'HG', rotorMount:'sixbolt', intWidth:30, maxTire:2.6, desc:'157mm SuperBoost end-cap sibling of rw-ethirteen-lg1r-29-150-hg' },
  { id:'rw-ethirteen-lg1r-275-157-xd', cat:'rearwheel', brand:'e*thirteen', model:'LG1r DH rear 27.5 (SuperBoost, XD)', family:'ethirteen-lg1r', disciplines:['dh'], price:715, weight:1448, wheel:'275', hub:'SuperBoost157', freehub:'XD', rotorMount:'sixbolt', intWidth:30, maxTire:2.6, desc:'157mm SuperBoost end-cap sibling of rw-ethirteen-lg1r-275-150-xd; fixes the SuperBoost157/275 combo (previously DT Swiss only)' },
  { id:'rw-ethirteen-lg1r-275-157-hg', cat:'rearwheel', brand:'e*thirteen', model:'LG1r DH rear 27.5 (SuperBoost, Shimano HG)', family:'ethirteen-lg1r', disciplines:['dh'], price:715, weight:1448, wheel:'275', hub:'SuperBoost157', freehub:'HG', rotorMount:'sixbolt', intWidth:30, maxTire:2.6, desc:'157mm SuperBoost end-cap sibling of rw-ethirteen-lg1r-275-150-hg' },
  { id:'rw-spank-spike369-29-150-xd', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear (XD)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1264, wheel:'29', hub:'150x12', freehub:'XD', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'Spank\'s DH-oriented 369 Vibrocore rear (wider/stronger sibling of the catalog\'s 359): "12x148mm Boost" or "12x150/157mm (Superboost compatible)" rear axle, 6-bolt, 30.5mm internal, HG/XD/Microspline freehub options, $499.99 across all freehub variants - all from the fetched spank-ind.com SPIKE 369 Vibrocore rear wheel page; weight = midpoint of the page\'s per-size range (1,259-1,268g/29in "depending on freehub" - exact per-freehub split not published)' },
  { id:'rw-spank-spike369-29-150-ms', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear (Micro Spline)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1264, wheel:'29', hub:'150x12', freehub:'MicroSpline', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'sample specs (mirror XD sibling); Microspline is one of the freehub options on the same fetched spank-ind.com page' },
  { id:'rw-spank-spike369-275-150-xd', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear 27.5 (XD)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1215, wheel:'275', hub:'150x12', freehub:'XD', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'27.5in SPIKE 369 Vibrocore rear, weight = midpoint of the fetched page\'s 1,211-1,220g range ("depending on freehub")' },
  { id:'rw-spank-spike369-275-150-ms', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear 27.5 (Micro Spline)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1215, wheel:'275', hub:'150x12', freehub:'MicroSpline', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'sample specs (mirror XD sibling)' },
  { id:'rw-spank-spike369-29-157-xd', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear (SuperBoost, XD)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1264, wheel:'29', hub:'SuperBoost157', freehub:'XD', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'the 157mm Superboost-compatible option of the same physical wheel as rw-spank-spike369-29-150-xd per the fetched spank-ind.com page' },
  { id:'rw-spank-spike369-29-157-ms', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear (SuperBoost, Micro Spline)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1264, wheel:'29', hub:'SuperBoost157', freehub:'MicroSpline', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'157mm SuperBoost sibling of rw-spank-spike369-29-150-ms' },
  { id:'rw-spank-spike369-275-157-xd', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear 27.5 (SuperBoost, XD)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1215, wheel:'275', hub:'SuperBoost157', freehub:'XD', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'157mm SuperBoost sibling of rw-spank-spike369-275-150-xd; fixes the SuperBoost157/275 combo (previously DT Swiss only)' },
  { id:'rw-spank-spike369-275-157-ms', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear 27.5 (SuperBoost, Micro Spline)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1215, wheel:'275', hub:'SuperBoost157', freehub:'MicroSpline', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'157mm SuperBoost sibling of rw-spank-spike369-275-150-ms' },
  /* --- catalog-wheels-breadth-2 continued sweep: same HG gap on the SPIKE 369 -
     its own fetched spank-ind.com page (cited by the XD/MS rows above) lists
     "HG/XD/Microspline freehub options" but only XD/MS were entered. Filling in
     HG deepens the 150x12/SuperBoost157 HG slice to a third brand (e*thirteen,
     Hope, now Spank) - no new fetch needed, same already-cited page. --- */
  { id:'rw-spank-spike369-29-150-hg', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear (Shimano HG)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1264, wheel:'29', hub:'150x12', freehub:'HG', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'sample specs (mirror XD/MS siblings); HG is one of the freehub options on the same fetched spank-ind.com SPIKE 369 Vibrocore rear wheel page' },
  { id:'rw-spank-spike369-275-150-hg', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear 27.5 (Shimano HG)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1215, wheel:'275', hub:'150x12', freehub:'HG', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'27.5in sibling of rw-spank-spike369-29-150-hg' },
  { id:'rw-spank-spike369-29-157-hg', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear (SuperBoost, Shimano HG)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1264, wheel:'29', hub:'SuperBoost157', freehub:'HG', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'157mm SuperBoost end-cap sibling of rw-spank-spike369-29-150-hg' },
  { id:'rw-spank-spike369-275-157-hg', cat:'rearwheel', brand:'Spank', model:'SPIKE 369 Vibrocore rear 27.5 (SuperBoost, Shimano HG)', family:'spank-spike369', disciplines:['dh'], price:500, weight:1215, wheel:'275', hub:'SuperBoost157', freehub:'HG', rotorMount:'sixbolt', intWidth:30.5, maxTire:2.6, desc:'157mm SuperBoost end-cap sibling of rw-spank-spike369-275-150-hg' },
  ...
  { id:'rm-industrynine-endurosv2-275', cat:'rim', brand:'Industry Nine', model:'Enduro S V2 alloy rim (27.5)', family:'industrynine-enduro-s', price:200, weight:540, wheel:'275', intWidth:30, maxTire:2.6, desc:'540g (27.5in) per search-corroborated coverage of the Enduro S V2 rim refresh (pinkbike.com); price mirrors the 29in sibling sample (no distinct 27.5-specific rim price surfaced). Before this row, EVERY rim category row in the catalog was 29in-only, so no complete custom 27.5 wheel could be built via the fronthub/rearhub+rim path at all - this is the first 27.5 rim.' },
  /* --- catalog-wheels-breadth-2 continued sweep: a REAL 0-brand front-wheel/hub
     collapse, found independently of breadth-gap.js (which is frame-paired only
     and structurally can't see fork<->wheel gaps): fk-marzocchi-bomber-58-275-200
     uses axle:'20x110-nonboost' (per its own fetched bike.marzocchi.com page,
     "20x110 DH (non-Boost)") and NO frontwheel/fronthub row in the whole catalog
     carried that exact value - a prior session tried and came up dry ("Bomber 58
     unlock DRY" - Sun Ringlé/Halo/Spank/Düroc all checked, all turned out Boost).
     Industry Nine's own site lists a distinct Hydra2 6B 20x110 Non-Boost front hub
     as a standalone SKU (industrynine.com/hubs/mountain/hydra2-6b-20x110-non-boost-front/
     - blocked to a direct fetch, 404, but its spec is corroborated by search-engine
     coverage quoting the page directly: 299g, $230, 6-bolt or CL rotor - 6-bolt
     entered); its Boost sibling (Hydra2 6B 20x110 Boost front, 157g/$230, confirmed
     via the fetched worldwidecyclery.com retailer listing "20mm Thru x 110mm Boost")
     is added alongside, deepening the thin 20x110-Boost front category too. Both
     pair with the new 27.5 Enduro S V2 rim above via the hub+rim build-your-own-wheel
     path to form an actual compatible front wheel for the Bomber 58. --- */
  { id:'fh-industrynine-hydra2-20x110', cat:'fronthub', brand:'Industry Nine', model:'Hydra2 20x110 Boost front hub', family:'industrynine-hydra2', price:230, weight:157, hub:'20x110', rotorMount:'sixbolt', source:'https://www.worldwidecyclery.com/products/industry-nine-hydra-2-classic-front-hub-20-x-110mm-dh-boost-6-bolt-black-32h', desc:'"20mm Thru x 110mm Boost" axle, 6-Bolt Disc, 157g, $230 - all from the fetched worldwidecyclery.com retailer listing (industrynine.com\'s own hub product pages return 404 to a direct fetch, so the retailer listing is the primary source here); a real standalone I9 SKU, distinct from the 15x110 Hydra2 front used on their trail/enduro wheelsets' },
  { id:'fh-industrynine-hydra2-20x110-nonboost', cat:'fronthub', brand:'Industry Nine', model:'Hydra2 20x110 Non-Boost front hub', family:'industrynine-hydra2', price:230, weight:299, hub:'20x110-nonboost', rotorMount:'sixbolt', desc:'fixes a real 0-brand front-wheel/hub collapse on fk-marzocchi-bomber-58-275-200 (see block comment above). industrynine.com lists a dedicated "Hydra2 6B 20x110 Non-Boost" front hub (industrynine.com/hubs/mountain/hydra2-6b-20x110-non-boost-front/ - 404s to a direct fetch, so sourced via search-engine coverage quoting that same page: 299g / 0lb 10.5oz, $230, 6-bolt or CL rotor mount, 28/32 hole); lower-confidence sourcing than a direct fetch, flagged honestly - unverified' },
  ...
  /* --- catalog-rotors-breadth-2 pass: SRAM HS2/CenterLine/CenterLine X Center-Lock + size-gap
     fills, all confirmed via FETCHED sram.com model pages (rt-hs-2-a1, rt-cln-a2, rt-cln-x-a2 --
     each explicitly lists its size range + "6 bolt and Centerlock" availability); SRAM publishes
     no rotor weights (the known wall), so weight stays sample/scaled throughout, matching the
     existing HS2/CenterLine rows already in the catalog --- */
  { id:'ro-sram-hs2-160-cl', cat:'rotor', brand:'SRAM', model:'HS2 160mm (CL)', family:'sram-hs2', mfgPn:'RT-HS-2-A1', price:55, weight:145, size:160, mount:'CL', desc:'sample weight (SRAM publishes no rotor weights); Center Lock confirmed via the FETCHED sram.com model page (rt-hs-2-a1: "6 bolt and Centerlock" across 160/180/200/220mm, $60-75 MSRP) + Universal Cycles listing (SRAM CL part numbers 00.5018.176.004/.005/.007 for 160/180/220mm)' },
  { id:'ro-sram-hs2-180-cl', cat:'rotor', brand:'SRAM', model:'HS2 180mm (CL)', family:'sram-hs2', mfgPn:'RT-HS-2-A1', price:50, weight:165, size:180, mount:'CL', desc:'sample weight (SRAM publishes no rotor weights); Center Lock confirmed via the FETCHED sram.com model page (rt-hs-2-a1)' },
  { id:'ro-sram-hs2-200-cl', cat:'rotor', brand:'SRAM', model:'HS2 200mm (CL)', family:'sram-hs2', mfgPn:'RT-HS-2-A1', price:55, weight:185, size:200, mount:'CL', desc:'sample weight (SRAM publishes no rotor weights); Center Lock confirmed via the FETCHED sram.com model page (rt-hs-2-a1)' },
  { id:'ro-sram-hs2-220-cl', cat:'rotor', brand:'SRAM', model:'HS2 220mm (CL)', family:'sram-hs2', mfgPn:'RT-HS-2-A1', price:60, weight:205, size:220, mount:'CL', desc:'sample weight (SRAM publishes no rotor weights); Center Lock confirmed via the FETCHED sram.com model page (rt-hs-2-a1)' },
  { id:'ro-sram-centerline-140-6b', cat:'rotor', brand:'SRAM', model:'CenterLine 140mm (6-bolt)', family:'sram-centerline', mfgPn:'RT-CLN-A2', price:40, weight:92, size:140, mount:'sixbolt', desc:'sample weight (SRAM publishes no rotor weights); 140mm 6-bolt confirmed via the FETCHED sram.com model page (rt-cln-a2: sizes 140/160/180/200/220mm, both 6-bolt and Center Lock, $50-65 MSRP)' },
  { id:'ro-sram-centerline-140-cl', cat:'rotor', brand:'SRAM', model:'CenterLine 140mm (CL)', family:'sram-centerline', mfgPn:'RT-CLN-A2', price:42, weight:88, size:140, mount:'CL', desc:'sample weight (SRAM publishes no rotor weights); 140mm Center Lock confirmed via the FETCHED sram.com model page (rt-cln-a2)' },
  { id:'ro-sram-centerline-160-cl', cat:'rotor', brand:'SRAM', model:'CenterLine 160mm (CL)', family:'sram-centerline', mfgPn:'RT-CLN-A2', price:44, weight:110, size:160, mount:'CL', desc:'sample weight (SRAM publishes no rotor weights); 160mm Center Lock confirmed via the FETCHED sram.com model page (rt-cln-a2) -- distinct from the lighter CenterLine X 160mm CL already cataloged' },
  { id:'ro-sram-centerline-180-6b', cat:'rotor', brand:'SRAM', model:'CenterLine 180mm (6-bolt)', family:'sram-centerline', mfgPn:'RT-CLN-A2', price:42, weight:136, size:180, mount:'sixbolt', desc:'sample weight (SRAM publishes no rotor weights); 180mm 6-bolt confirmed via the FETCHED sram.com model page (rt-cln-a2)' },
  { id:'ro-sram-centerline-200-6b', cat:'rotor', brand:'SRAM', model:'CenterLine 200mm (6-bolt)', family:'sram-centerline', mfgPn:'RT-CLN-A2', price:45, weight:158, size:200, mount:'sixbolt', desc:'sample weight (SRAM publishes no rotor weights); 200mm 6-bolt confirmed via the FETCHED sram.com model page (rt-cln-a2)' },
  { id:'ro-sram-centerline-220-cl', cat:'rotor', brand:'SRAM', model:'CenterLine 220mm (CL)', family:'sram-centerline', mfgPn:'RT-CLN-A2', price:48, weight:170, size:220, mount:'CL', desc:'sample weight (SRAM publishes no rotor weights); 220mm Center Lock confirmed via the FETCHED sram.com model page (rt-cln-a2)' },
  { id:'ro-sram-centerline-x-140-6b', cat:'rotor', brand:'SRAM', model:'CenterLine X 140mm (6-bolt)', family:'sram-centerline', mfgPn:'RT-CLN-X-A2', disciplines:['xc'], price:70, weight:80, size:140, mount:'sixbolt', desc:'sample weight (SRAM publishes no rotor weights); 140mm 6-bolt confirmed via the FETCHED sram.com model page (rt-cln-x-a2: sizes 140/160/180mm, both 6-bolt and Center Lock, $70-90 MSRP)' },
  { id:'ro-sram-centerline-x-140-cl', cat:'rotor', brand:'SRAM', model:'CenterLine X 140mm (CL)', family:'sram-centerline', mfgPn:'RT-CLN-X-A2', disciplines:['xc'], price:75, weight:76, size:140, mount:'CL', desc:'sample weight (SRAM publishes no rotor weights); 140mm Center Lock confirmed via the FETCHED sram.com model page (rt-cln-x-a2)' },
  { id:'ro-sram-centerline-x-160-6b', cat:'rotor', brand:'SRAM', model:'CenterLine X 160mm (6-bolt)', family:'sram-centerline', mfgPn:'RT-CLN-X-A2', disciplines:['xc'], price:72, weight:100, size:160, mount:'sixbolt', desc:'sample weight (SRAM publishes no rotor weights); 160mm 6-bolt confirmed via the FETCHED sram.com model page (rt-cln-x-a2)' },
  { id:'ro-sram-centerline-x-180-6b', cat:'rotor', brand:'SRAM', model:'CenterLine X 180mm (6-bolt)', family:'sram-centerline', mfgPn:'RT-CLN-X-A2', disciplines:['xc'], price:78, weight:122, size:180, mount:'sixbolt', desc:'sample weight (SRAM publishes no rotor weights); 180mm 6-bolt confirmed via the FETCHED sram.com model page (rt-cln-x-a2)' },
  { id:'ro-sram-centerline-x-180-cl', cat:'rotor', brand:'SRAM', model:'CenterLine X 180mm (CL)', family:'sram-centerline', mfgPn:'RT-CLN-X-A2', disciplines:['xc'], price:82, weight:118, size:180, mount:'CL', desc:'sample weight (SRAM publishes no rotor weights); 180mm Center Lock confirmed via the FETCHED sram.com model page (rt-cln-x-a2)' },

  /* --- Hayes D-Series size-gap fills: 160/180/220mm all published at 160g on the FETCHED
     hayesbicycle.com product page (203mm is the outlier at 199g, already cataloged) --- */
  { id:'ro-hayes-dseries-160-6b', cat:'rotor', brand:'Hayes', model:'D-Series 160mm', family:'hayes-dseries', price:60, weight:160, size:160, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://hayesbicycle.com/products/d-series-rotor', desc:'160/180/220mm all listed at 160g on the FETCHED hayesbicycle.com product page; MSRP $59.99 rounds to the existing 203mm row\'s $60' },
  { id:'ro-hayes-dseries-180-6b', cat:'rotor', brand:'Hayes', model:'D-Series 180mm', family:'hayes-dseries', price:60, weight:160, size:180, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://hayesbicycle.com/products/d-series-rotor' },
  { id:'ro-hayes-dseries-220-6b', cat:'rotor', brand:'Hayes', model:'D-Series 220mm', family:'hayes-dseries', price:60, weight:160, size:220, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://hayesbicycle.com/products/d-series-rotor' },

  /* --- Hope Floating: 6-bolt size-gap fills + the Centerlock mount line (a genuinely separate
     product, "Floating Centrelock Rotor", confirmed via the FETCHED hopetech.com product page --
     manufacturer-published weight for 180mm; other sizes scaled) --- */
  { id:'ro-hope-floating-140-6b', cat:'rotor', brand:'Hope', model:'Floating 140mm (6-bolt)', family:'hope-floating', price:45, weight:100, size:140, mount:'sixbolt', desc:'sample weight (scaled down from the cataloged 180mm/155g sibling); 140mm confirmed via the FETCHED hopetech.com news page ("140, 160, 180, 200, 203 & 220mm")' },
  { id:'ro-hope-floating-160-6b', cat:'rotor', brand:'Hope', model:'Floating 160mm (6-bolt)', family:'hope-floating', price:46, weight:125, size:160, mount:'sixbolt', desc:'sample weight (scaled from the cataloged 180mm/155g sibling); 160mm confirmed via the FETCHED hopetech.com news page' },
  { id:'ro-hope-floating-200-6b', cat:'rotor', brand:'Hope', model:'Floating 200mm (6-bolt)', family:'hope-floating', price:52, weight:190, size:200, mount:'sixbolt', desc:'sample weight (interpolated between the cataloged 180mm/155g and 203mm/175g siblings); 200mm confirmed via the FETCHED hopetech.com news page' },
  { id:'ro-hope-floating-140-cl', cat:'rotor', brand:'Hope', model:'Floating 140mm (Centrelock)', family:'hope-floating', price:95, weight:110, size:140, mount:'CL', desc:'sample weight (scaled from the manufacturer-stated 180mm/146g); 140mm + Centrelock + $111.19 (140-180mm tier) confirmed via the FETCHED hopetech.com Floating Centrelock Rotor product page' },
  { id:'ro-hope-floating-160-cl', cat:'rotor', brand:'Hope', model:'Floating 160mm (Centrelock)', family:'hope-floating', price:95, weight:128, size:160, mount:'CL', desc:'sample weight (scaled from the manufacturer-stated 180mm/146g); confirmed via the FETCHED hopetech.com Floating Centrelock Rotor product page' },
  { id:'ro-hope-floating-180-cl', cat:'rotor', brand:'Hope', model:'Floating 180mm (Centrelock)', family:'hope-floating', price:95, weight:146, size:180, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://www.hopetech.com/products/brakes/discs/floating-centrelock-rotor/', desc:'146g is the manufacturer-published weight for this size on the FETCHED hopetech.com product page; price = the page\'s own USD figure for the 140-180mm tier ($111.19 ex tax, rounded)' },
  { id:'ro-hope-floating-200-cl', cat:'rotor', brand:'Hope', model:'Floating 200mm (Centrelock)', family:'hope-floating', price:100, weight:190, size:200, mount:'CL', desc:'sample weight (interpolated from the manufacturer-stated 180mm/146g and the 220mm sibling below); confirmed via the FETCHED hopetech.com Floating Centrelock Rotor product page ($117.73 ex tax for the 200-220mm tier)' },
  { id:'ro-hope-floating-203-cl', cat:'rotor', brand:'Hope', model:'Floating 203mm (Centrelock)', family:'hope-floating', price:100, weight:195, size:203, mount:'CL', desc:'sample weight (scaled from the cataloged 203mm 6-bolt/175g sibling); confirmed via the FETCHED hopetech.com Floating Centrelock Rotor product page ($117.73 ex tax for the 200-220mm tier)' },
  { id:'ro-hope-floating-220-cl', cat:'rotor', brand:'Hope', model:'Floating 220mm (Centrelock)', family:'hope-floating', price:100, weight:220, size:220, mount:'CL', desc:'sample weight (scaled from the cataloged 220mm 6-bolt/205g sibling); confirmed via the FETCHED hopetech.com Floating Centrelock Rotor product page ($117.73 ex tax for the 200-220mm tier)' },

  /* --- Magura: MDR-P Center-Lock gap (per-size manufacturer weight) + two entirely new Magura
     lines confirmed via FETCHED magura.com pages -- MDR-C (economy, both mounts) and Storm SL.2
     (lightweight XC, 6-bolt only) --- */
  { id:'ro-magura-mdrp-180-cl', cat:'rotor', brand:'Magura', model:'MDR-P 180mm (CL)', family:'magura-mdrp', price:65, weight:211, size:180, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://magura.com/product/mdr-p-cl/', desc:'211g/226g per-size weights from the FETCHED magura.com MDR-P CL page (EUR RRP 60.90 incl. VAT for both sizes; price here = sample USD estimate, no per-size USD breakout published)' },
  { id:'ro-magura-mdrp-203-cl', cat:'rotor', brand:'Magura', model:'MDR-P 203mm (CL)', family:'magura-mdrp', price:68, weight:226, size:203, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://magura.com/product/mdr-p-cl/', desc:'226g from the FETCHED magura.com MDR-P CL page; price = sample USD estimate (EUR RRP 60.90 incl. VAT, no per-size USD breakout)' },
  { id:'ro-magura-mdrc-160-6b', cat:'rotor', brand:'Magura', model:'MDR-C 160mm (6-bolt)', family:'magura-mdrc', price:35, weight:145, size:160, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://magura.com/product/mdr-c/', desc:'per-size weight (145/165/222/286g for 160/180/203/220mm) from the FETCHED magura.com MDR-C page, Magura\'s economy rotor line distinct from the cataloged MDR-P; EUR RRP 30.90 incl. VAT across all sizes -- price here = sample USD estimate' },
  { id:'ro-magura-mdrc-180-6b', cat:'rotor', brand:'Magura', model:'MDR-C 180mm (6-bolt)', family:'magura-mdrc', price:35, weight:165, size:180, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://magura.com/product/mdr-c/' },
  { id:'ro-magura-mdrc-203-6b', cat:'rotor', brand:'Magura', model:'MDR-C 203mm (6-bolt)', family:'magura-mdrc', price:38, weight:222, size:203, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://magura.com/product/mdr-c/' },
  { id:'ro-magura-mdrc-220-6b', cat:'rotor', brand:'Magura', model:'MDR-C 220mm (6-bolt)', family:'magura-mdrc', price:40, weight:286, size:220, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://magura.com/product/mdr-c/' },
  { id:'ro-magura-mdrc-160-cl', cat:'rotor', brand:'Magura', model:'MDR-C 160mm (CL)', family:'magura-mdrc', price:38, weight:160, size:160, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://magura.com/product/mdr-c-cl/', desc:'160/190/225g for 160/180/203mm from the FETCHED magura.com MDR-C CL page (EUR RRP 35.90 incl. VAT); price = sample USD estimate' },
  { id:'ro-magura-mdrc-180-cl', cat:'rotor', brand:'Magura', model:'MDR-C 180mm (CL)', family:'magura-mdrc', price:38, weight:190, size:180, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://magura.com/product/mdr-c-cl/' },
  { id:'ro-magura-mdrc-203-cl', cat:'rotor', brand:'Magura', model:'MDR-C 203mm (CL)', family:'magura-mdrc', price:40, weight:225, size:203, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://magura.com/product/mdr-c-cl/' },
  { id:'ro-magura-storm-sl2-160-6b', cat:'rotor', brand:'Magura', model:'Storm SL.2 160mm (6-bolt)', family:'magura-storm-sl2', disciplines:['xc'], price:32, weight:100, size:160, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://magura.com/product/storm-sl-2/', desc:'100g/118g for 160/180mm from the FETCHED magura.com Storm SL.2 page (EUR RRP 35.90 incl. VAT); price = sample USD estimate. Lightweight XC-focused rotor, 6-bolt only, no size above 180mm' },
  { id:'ro-magura-storm-sl2-180-6b', cat:'rotor', brand:'Magura', model:'Storm SL.2 180mm (6-bolt)', family:'magura-storm-sl2', disciplines:['xc'], price:34, weight:118, size:180, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://magura.com/product/storm-sl-2/' },

  /* --- Galfer Wave: 6-bolt size-gap fills (2.0mm SKUs, from the FETCHED galfer.com catalog page)
     + the Center-Lock mount line (brand-new for this catalog; sizes/weights/prices/part numbers
     all from a FETCHED galfer.com announcement page) --- */
  { id:'ro-galfer-wave-160-6b', cat:'rotor', brand:'Galfer', model:'Wave 160mm (6-bolt)', family:'galfer-wave', mfgPn:'DB002W2', price:48, weight:108, size:160, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://galfer.com/bike/products/brake-discs/', desc:'108g (2.0mm DB002W2 SKU) from the FETCHED galfer.com brake-discs catalog page; price = sample (no USD MSRP shown on the manufacturer page)' },
  { id:'ro-galfer-wave-180-6b', cat:'rotor', brand:'Galfer', model:'Wave 180mm (6-bolt)', family:'galfer-wave', mfgPn:'DB003W2', price:52, weight:147, size:180, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://galfer.com/bike/products/brake-discs/', desc:'147g (2.0mm DB003W2 SKU) from the FETCHED galfer.com brake-discs catalog page' },
  { id:'ro-galfer-wave-200-6b', cat:'rotor', brand:'Galfer', model:'Wave 200mm (6-bolt)', family:'galfer-wave', mfgPn:'DB006W2', price:58, weight:170, size:200, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://galfer.com/bike/products/brake-discs/', desc:'170g (2.0mm DB006W2 SKU) from the FETCHED galfer.com brake-discs catalog page' },
  { id:'ro-galfer-wave-160-cl', cat:'rotor', brand:'Galfer', model:'Wave 160mm (CL)', family:'galfer-wave', mfgPn:'DB002WCL', price:49, weight:110, size:160, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://galfer.com/bike/galfer-disc-wave-now-available-for-the-center-lock-system/', desc:'110g / EUR45 (ex VAT) from the FETCHED galfer.com Center-Lock announcement page (part DB002WCL); price = EUR sample converted, no USD MSRP published' },
  { id:'ro-galfer-wave-180-cl', cat:'rotor', brand:'Galfer', model:'Wave 180mm (CL)', family:'galfer-wave', mfgPn:'DB003WCL', price:51, weight:127, size:180, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://galfer.com/bike/galfer-disc-wave-now-available-for-the-center-lock-system/', desc:'127g / EUR47 (ex VAT) from the FETCHED galfer.com Center-Lock announcement page (part DB003WCL)' },
  { id:'ro-galfer-wave-203-cl', cat:'rotor', brand:'Galfer', model:'Wave 203mm (CL)', family:'galfer-wave', mfgPn:'DB004WCL', price:53, weight:157, size:203, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://galfer.com/bike/galfer-disc-wave-now-available-for-the-center-lock-system/', desc:'157g / EUR49 (ex VAT) from the FETCHED galfer.com Center-Lock announcement page (part DB004WCL)' },

  /* --- Trickstuff: two entirely new named trims beyond the cataloged (ambiguous-trim) Dächle
     180/203mm rows -- Dächle Disc HD (heavy-duty) and Dächle Disc UL (ultralight, with per-size
     factory SKU codes) -- both confirmed via FETCHED official trickstuff.com product pages --- */
  { id:'ro-trickstuff-dachlehd-160-6b', cat:'rotor', brand:'Trickstuff', model:'Dächle Disc HD 160mm (6-bolt)', family:'trickstuff-dachle-hd', price:37, weight:120, size:160, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://www.trickstuff.com/en/brake-parts-and-tools/brake-discs/daechle-disc-hd', desc:'heavy-duty trim distinct from the standard cataloged Dächle 180/203mm rows; 120/150/195g for 160/180/203mm + Disc IS (6-bolt) confirmed on the FETCHED official product page; price = the page\'s "from EUR34" figure, USD sample' },
  { id:'ro-trickstuff-dachlehd-180-6b', cat:'rotor', brand:'Trickstuff', model:'Dächle Disc HD 180mm (6-bolt)', family:'trickstuff-dachle-hd', price:37, weight:150, size:180, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://www.trickstuff.com/en/brake-parts-and-tools/brake-discs/daechle-disc-hd' },
  { id:'ro-trickstuff-dachlehd-203-6b', cat:'rotor', brand:'Trickstuff', model:'Dächle Disc HD 203mm (6-bolt)', family:'trickstuff-dachle-hd', price:37, weight:195, size:203, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://www.trickstuff.com/en/brake-parts-and-tools/brake-discs/daechle-disc-hd' },
  { id:'ro-trickstuff-dachleul-140-6b', cat:'rotor', brand:'Trickstuff', model:'Dächle Disc UL 140mm (6-bolt)', family:'trickstuff-dachle-ul', mfgPn:'BRDSU14IN0000S', disciplines:['xc'], price:37, weight:70, size:140, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://www.trickstuff.com/en/brake-parts-and-tools/brake-discs/daechle-disc-ul', desc:'ultralight trim distinct from the standard cataloged Dächle and the Dächle HD rows; 70g (1.85mm), Disc IS (6-bolt) confirmed on the FETCHED official product page, with a per-size factory SKU; price = the page\'s "from EUR34" figure, USD sample' },
  { id:'ro-trickstuff-dachleul-160-6b', cat:'rotor', brand:'Trickstuff', model:'Dächle Disc UL 160mm (6-bolt)', family:'trickstuff-dachle-ul', mfgPn:'BRDSU16IN0000S', disciplines:['xc'], price:37, weight:88, size:160, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://www.trickstuff.com/en/brake-parts-and-tools/brake-discs/daechle-disc-ul' },
  { id:'ro-trickstuff-dachleul-180-6b', cat:'rotor', brand:'Trickstuff', model:'Dächle Disc UL 180mm (6-bolt)', family:'trickstuff-dachle-ul', mfgPn:'BRDSV18IN0000S', price:37, weight:119, size:180, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://www.trickstuff.com/en/brake-parts-and-tools/brake-discs/daechle-disc-ul' },
  { id:'ro-trickstuff-dachleul-203-6b', cat:'rotor', brand:'Trickstuff', model:'Dächle Disc UL 203mm (6-bolt)', family:'trickstuff-dachle-ul', mfgPn:'BKDSV20IN0000S', price:37, weight:152, size:203, mount:'sixbolt', verified:true, lastChecked:'2026-07-08', source:'https://www.trickstuff.com/en/brake-parts-and-tools/brake-discs/daechle-disc-ul' },

  /* --- Shimano size-gap fills across the three cataloged families. bike.shimano.com 403s on
     WebFetch (the pre-existing verification wall noted project-wide) so, matching the existing
     rows in these same families, size/mount is rounded from WebSearch-aggregated retailer/spec
     listings and weight stays sample --- */
  { id:'ro-shimano-rtmt800-140-cl', cat:'rotor', brand:'Shimano', model:'RT-MT800 140mm (CL)', family:'shimano-rtmt800', mfgPn:'RT-MT800', price:42, weight:88, size:140, mount:'CL', desc:'sample weight; 140/160/180/203mm confirmed Center-Lock-only via bikecomponents-us/Hunt Bike Wheels/Vital MTB listings (RT-MT800 has no 6-bolt option), matching the cataloged 160/180/203mm siblings' },
  { id:'ro-shimano-rtmt900-140-cl', cat:'rotor', brand:'Shimano', model:'RT-MT900 140mm (CL)', family:'shimano-rtmt900', mfgPn:'RT-MT900', price:55, weight:89, size:140, mount:'CL', desc:'sample weight; 140mm confirmed via bikecomponents-us/Barquebike/Amazon listings (XTR M9100-series, XC-focused 140/160mm vs trail/enduro 180/203mm), matching the cataloged 160/203mm siblings' },
  { id:'ro-shimano-rtmt900-180-cl', cat:'rotor', brand:'Shimano', model:'RT-MT900 180mm (CL)', family:'shimano-rtmt900', mfgPn:'RT-MT900', price:60, weight:132, size:180, mount:'CL', desc:'sample weight; 180mm confirmed via bikecomponents-us/Dunbar Cycles listings, matching the cataloged 160/203mm siblings' },
  { id:'ro-shimano-smrt76-180-6b', cat:'rotor', brand:'Shimano', model:'SM-RT76 180mm (6-bolt)', family:'shimano-smrt76', mfgPn:'SM-RT76', price:34, weight:169, size:180, mount:'sixbolt', desc:'sample weight; 180mm confirmed via WebSearch aggregation of the bike.shimano.com AU/EU product listing (160/180/203mm, 6-bolt) + Worldwide Cyclery/eBay listings (bike.shimano.com itself 403s on WebFetch), matching the cataloged 160mm sibling' },

  /* --- TRP: three entirely new 2-piece rotor lines beyond the cataloged RS05E Race Rotor, each
     confirmed via a FETCHED trpcycling.com product page -- TR25 (Center Lock), TR33 (6-bolt),
     and TR42 (2.3mm-thick DH/e-MTB, 6-bolt) --- */
  { id:'ro-trp-tr25-160-cl', cat:'rotor', brand:'TRP', model:'TR25 160mm (CL)', family:'trp-tr25', price:71, weight:139, size:160, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://trpcycling.com/products/tr25', desc:'TR25 is a distinct 2-piece Center Lock rotor line from the cataloged RS05E Race Rotor; 139/152/198g for 160/180/203mm + Center Lock + $71.49 confirmed on the FETCHED trpcycling.com product page' },
  { id:'ro-trp-tr25-180-cl', cat:'rotor', brand:'TRP', model:'TR25 180mm (CL)', family:'trp-tr25', price:71, weight:152, size:180, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://trpcycling.com/products/tr25' },
  { id:'ro-trp-tr25-203-cl', cat:'rotor', brand:'TRP', model:'TR25 203mm (CL)', family:'trp-tr25', price:71, weight:198, size:203, mount:'CL', verified:true, lastChecked:'2026-07-08', source:'https://trpcycling.com/products/tr25' },
  { id:'ro-trp-tr25-140-cl', cat:'rotor', brand:'TRP', model:'TR25 140mm (CL)', family:'trp-tr25', disciplines:['xc'], price:71, weight:115, size:140, mount:'CL', desc:'sample weight (the FETCHED trpcycling.com product page confirms the 140mm size + Center Lock + $71.49 but doesn\'t publish its weight -- scaled down from the cataloged 160mm/139g sibling)' },
  { id:'ro-trp-tr33-140-6b', cat:'rotor', brand:'TRP', model:'TR33 140mm (6-bolt)', family:'trp-tr33', disciplines:['xc'], price:65, weight:105, size:140, mount:'sixbolt', desc:'TR33 is a distinct 2-piece 6-bolt rotor line from the cataloged RS05E; 140/160/180/203mm + 6-bolt + $64.99 MSRP confirmed on the FETCHED trpcycling.com product page; weight not published anywhere found, stays sample' },
  { id:'ro-trp-tr33-160-6b', cat:'rotor', brand:'TRP', model:'TR33 160mm (6-bolt)', family:'trp-tr33', price:65, weight:130, size:160, mount:'sixbolt', desc:'sample weight (not published); size/mount confirmed on the FETCHED trpcycling.com product page' },
  { id:'ro-trp-tr33-180-6b', cat:'rotor', brand:'TRP', model:'TR33 180mm (6-bolt)', family:'trp-tr33', price:65, weight:155, size:180, mount:'sixbolt', desc:'sample weight (not published); size/mount confirmed on the FETCHED trpcycling.com product page' },
  { id:'ro-trp-tr33-203-6b', cat:'rotor', brand:'TRP', model:'TR33 203mm (6-bolt)', family:'trp-tr33', price:65, weight:195, size:203, mount:'sixbolt', desc:'sample weight (not published); size/mount confirmed on the FETCHED trpcycling.com product page' },
  { id:'ro-trp-tr42-180-6b', cat:'rotor', brand:'TRP', model:'TR42 180mm (6-bolt)', family:'trp-tr42', disciplines:['dh'], price:75, weight:215, size:180, mount:'sixbolt', desc:'TR42 is TRP\'s 2.3mm-thick DH/e-MTB rotor (distinct from the standard-thickness TR25/TR33/RS05E lines); 180/203mm + 6-bolt + EUR70 confirmed on the FETCHED eu.trpcycling.com product page; weight not published, stays sample' },
  { id:'ro-trp-tr42-203-6b', cat:'rotor', brand:'TRP', model:'TR42 203mm (6-bolt)', family:'trp-tr42', disciplines:['dh'], price:78, weight:240, size:203, mount:'sixbolt', desc:'sample weight (not published); size/mount confirmed on the FETCHED eu.trpcycling.com product page' },

  /* --- Formula: the named "Monolithic" rotor line (both mounts), replacing the catalog's single
     unnamed sample row with sourced sibling sizes; spec/weight from a reputable retailer spec
     table (bikecomponents-us.com), not a manufacturer page fetch, so these stay unverified per
     the retailer-weight policy --- */
  { id:'ro-formula-monolithic-160-6b', cat:'rotor', brand:'Formula', model:'Monolithic 160mm (6-bolt)', family:'formula-monolithic', price:60, weight:135, size:160, mount:'sixbolt', desc:'sample weight (scaled from the 180mm/162g sibling); 160mm existence confirmed via WebSearch aggregation of rideformula.com ("160/180/203/220mm, 6-bolt, 1.8-2.3mm") -- weight not found for this size specifically' },
  { id:'ro-formula-monolithic-180-6b', cat:'rotor', brand:'Formula', model:'Monolithic 180mm (6-bolt)', family:'formula-monolithic', price:69, weight:162, size:180, mount:'sixbolt', desc:'162g/$68.95 from the bikecomponents-us.com spec listing (44mm-BCD 6-bolt, 2.3mm, 1-piece stainless) -- retailer spec table, not a manufacturer page fetch, stays unverified per the retailer-weight policy' },
  { id:'ro-formula-monolithic-203-6b', cat:'rotor', brand:'Formula', model:'Monolithic 203mm (6-bolt)', family:'formula-monolithic', price:73, weight:208, size:203, mount:'sixbolt', desc:'208g from the same bikecomponents-us.com spec listing as the cataloged 180mm sibling' },
  ...
  /* --- catalog-cockpit-breadth-2 (2026-07-08): round 2 cockpit breadth - ODI, Ergon, SDG, Deity, Chromag,
     PRO, Thomson, Renthal. All new rows sourced from a FETCHED manufacturer page (cited per row); where the
     maker page didn't publish a weight, price/interface stay maker-sourced and weight is a documented sample
     (never invented from nothing) - kept unverified in that case, per DATA-ENTRY-TEMPLATE. --- */
  { id:'hb-deity-blacklabel-318', cat:'handlebar', brand:'Deity', model:'Blacklabel 800 (25mm rise)', family:'deity-blacklabel', price:89.99, weight:342, clamp:31.8, width:800, rise:25, material:'alu', verified:true, lastChecked:'2026-07-08', source:'https://www.deitycomponents.com/blacklabel_handlebar_25mm.html', desc:'9°/5° backsweep/upsweep; also offered in 15/38/50mm rise at the same weight/price per the fetched deitycomponents.com store listing' },
  { id:'hb-deity-skyline-318', cat:'handlebar', brand:'Deity', model:'Skyline 787 (25mm rise)', family:'deity-skyline', price:89.99, weight:290, clamp:31.8, width:787, rise:25, material:'alu', verified:true, lastChecked:'2026-07-08', source:'https://www.deitycomponents.com/store/p13/DEITY_SKYLINE_787_HANDLEBAR_///_25mm_RISE.html', desc:'also offered in 15mm rise (290g/$89.99 per the fetched store page)' },
  { id:'hb-chromag-bza-35', cat:'handlebar', brand:'Chromag', model:'BZA', family:'chromag-bza', price:147, weight:235, clamp:35, width:800, rise:35, material:'carbon', verified:true, lastChecked:'2026-07-08', source:'https://us.chromagbikes.com/products/handlebars-bza-2020', desc:'235g stated as consistent across all rise options (15/25/35mm) per the fetched chromagbikes.com spec table' },
  { id:'hb-thomson-elite-35', cat:'handlebar', brand:'Thomson', model:'Elite 35 (20mm rise)', family:'thomson-elite', price:134.95, weight:300, clamp:35, width:800, rise:20, material:'alu', desc:'price/clamp/width/rise confirmed via the fetched bikethomson.com product page (also offered in 10mm/35mm rise at the same width/price); Thomson does not publish a weight on the page, so weight is a sample estimate (class-typical for a 35mm/800mm alloy riser), kept unverified' },
  { id:'hb-thomson-elite-trail-318', cat:'handlebar', brand:'Thomson', model:'Elite Trail', family:'thomson-elite', price:123.95, weight:269, clamp:31.8, width:750, rise:20, material:'alu', desc:'price/clamp/rise confirmed via the fetched bikethomson.com product page (750mm Trail width vs. an 800mm Downhill width option at the same rise/price); 269g is a retailer-reported figure (Evans Cycles), not on the maker page, so kept unverified' },
  { id:'hb-renthal-fatbar-lite-318', cat:'handlebar', brand:'Renthal', model:'Fatbar Lite (30mm rise)', family:'renthal-fatbar-lite', price:107.85, weight:270, clamp:31.8, width:760, rise:30, material:'alu', verified:true, lastChecked:'2026-07-08', source:'https://www.renthal.com/cycle/fatbar-lite', desc:'also offered in 35mm clamp at the same weight/price/width (see sibling row); rise also offered as Zero/10/20/40mm' },
  { id:'hb-renthal-fatbar-lite-35', cat:'handlebar', brand:'Renthal', model:'Fatbar Lite35 (30mm rise)', family:'renthal-fatbar-lite', price:107.85, weight:270, clamp:35, width:760, rise:30, material:'alu', verified:true, lastChecked:'2026-07-08', source:'https://www.renthal.com/cycle/fatbar-lite' },
  { id:'hb-renthal-fatbar-carbon-318', cat:'handlebar', brand:'Renthal', model:'Fatbar Carbon (20mm rise)', family:'renthal-fatbar-carbon', price:210.30, weight:225, clamp:31.8, width:800, rise:20, material:'carbon', verified:true, lastChecked:'2026-07-08', source:'https://www.renthal.com/cycle/fatbar-carbon', desc:'also offered in 35mm clamp at the same weight/price/width (see sibling row); rise also offered as 10/30/40mm' },
  { id:'hb-renthal-fatbar-carbon-35', cat:'handlebar', brand:'Renthal', model:'Fatbar Carbon35 (20mm rise)', family:'renthal-fatbar-carbon', price:210.30, weight:225, clamp:35, width:800, rise:20, material:'carbon', verified:true, lastChecked:'2026-07-08', source:'https://www.renthal.com/cycle/fatbar-carbon' },
  { id:'hb-chromag-osx-35', cat:'handlebar', brand:'Chromag', model:'OSX 35 (25mm rise)', family:'chromag-osx', price:81.60, weight:312, clamp:35, width:800, rise:25, material:'alu', verified:true, lastChecked:'2026-07-08', source:'https://us.chromagbikes.com/products/osx35-2020', desc:'also offered in 35mm rise per the fetched chromagbikes.com product page; a 35mm-clamp sibling of the cataloged 31.8mm Fubars OSX' },
  { id:'hb-sdg-slater-318', cat:'handlebar', brand:'SDG', model:'Slater 650', family:'sdg-slater-bar', price:59.99, weight:260, clamp:31.8, width:650, rise:20, material:'alu', verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/products/slater-handlebar', desc:'youth/dirt-jump bar: tapers to 19mm ends (needs the SDG 22.2 shim kit for standard grips/levers) - the stem-side clamp is a standard 31.8mm so it fits any 31.8 stem, per the fetched sdgcomponents.com product page' },
  ...
  { id:'st-deity-intake-dm-318', cat:'stem', brand:'Deity', model:'Intake DM (50mm)', family:'deity-intake-dm', price:119.99, weight:146, clamp:31.8, length:50, verified:true, lastChecked:'2026-07-08', source:'https://www.deitycomponents.com/store/p26/DEITY_INTAKE_DM_STEM_///_31.8mm_CLAMP.html', desc:'direct-mount DH stem, 3-piece design' },
  { id:'st-deity-cavity-318', cat:'stem', brand:'Deity', model:'Cavity (50mm)', family:'deity-cavity', price:94.99, weight:173, clamp:31.8, length:50, desc:'weight/clamp/length confirmed via the fetched deitycomponents.com/cavity-50-stem.html page (also offered in 35mm length at 150g); price not shown on that page, taken from consistent $94.99 retailer listings (Jenson USA et al.), kept unverified' },
  ...
  /* --- 2026-07-08: st-chromag-ranger-v2-35 RETIRED to ALIASES - Chromag's Ranger V2 is 31.8mm-clamp
     ONLY (confirmed via the fetched chromagbikes.com stems collection + Ranger V2 product page, plus
     every independent retailer listing found: thelostco/modernbike/Vital MTB all show 31.8mm, none show
     a 35mm Ranger V2). The prior row's clamp:35 was a fabricated spec (never mutate-in-place per the
     append-only id rule) - HiFi below is Chromag's real, currently-sourced 35mm-clamp stem. --- */
  { id:'st-chromag-hifi-318', cat:'stem', brand:'Chromag', model:'HiFi (50mm)', family:'chromag-hifi', price:112, weight:200, clamp:31.8, length:50, verified:true, lastChecked:'2026-07-08', source:'https://us.chromagbikes.com/products/hifi-stem', desc:'also offered in 31/40mm length at 31.8 clamp, per the fetched chromagbikes.com product page' },
  { id:'st-chromag-hifi-35', cat:'stem', brand:'Chromag', model:'HiFi 35 (50mm)', family:'chromag-hifi', price:112, weight:203, clamp:35, length:50, desc:'clamp/length/price confirmed via the fetched chromagbikes.com hifi-stem page (both 31.8 and 35mm clamp sold at the same $112); that page states 200g explicitly for 31.8/50 only, so the 35/50 weight (203g) is a third-party (retailer/Vital MTB) figure, kept unverified' },
  { id:'st-thomson-elite-x4-35', cat:'stem', brand:'Thomson', model:'Elite X4 35', family:'thomson-elite-x4', price:121.95, weight:185, clamp:35, length:50, desc:'price/clamp confirmed via the fetched bikethomson.com product page (also offered in 32/40mm length); 185g (50mm) is a retailer figure (Performance Bicycle), not published by Thomson, kept unverified' },
  { id:'st-renthal-duo-318', cat:'stem', brand:'Renthal', model:'Duo (50mm)', family:'renthal-duo', price:141.99, weight:137, clamp:31.8, length:50, desc:'price confirmed via the fetched renthal.com/cycle/duo product page (also offered in 40mm/124g); clamp (31.8mm only) and weight are consistent across many independent retailer listings but were not present in the renthal.com page text extracted, so kept unverified' },
  { id:'st-chromag-riza-318', cat:'stem', brand:'Chromag', model:'RIZA (38mm)', family:'chromag-riza', price:171, weight:194, clamp:31.8, length:38, verified:true, lastChecked:'2026-07-08', source:'https://us.chromagbikes.com/products/stems-riza', desc:'CNC-machined 6061 billet; also offered in 32/45mm length, and in a 35mm clamp (see sibling row), all at the same $171' },
  { id:'st-chromag-riza-35', cat:'stem', brand:'Chromag', model:'RIZA 35 (38mm)', family:'chromag-riza', price:171, weight:194, clamp:35, length:38, desc:'price/length confirmed via the fetched chromagbikes.com RIZA product page; that page only publishes weight for the 31.8mm/38mm combination (194g), so the 35mm-clamp weight is carried over as a same-family estimate, kept unverified' },
  { id:'st-pro-tharsis-trail-318', cat:'stem', brand:'PRO', model:'Tharsis Trail (35mm)', family:'pro-tharsis-trail', price:149.99, weight:95, clamp:31.8, length:35, desc:'regular (non-sale) US price from the fetched racycles.com listing; weight (95g/35mm length) matches the maker-quoted figure relayed via the Vital MTB spec page; 31.8mm clamp confirmed across multiple independent retailer listings (racycles/Amazon titles all say "31.8"). Fills the 31.8mm gap next to the cataloged 35mm-clamp Tharsis 3Five; kept unverified (no direct pro-bikegear.com fetch succeeded - the site blocks automated fetches)' },
  ...
  { id:'gr-odi-elite-pro', cat:'grips', brand:'ODI', model:'Elite Pro', family:'odi-elite-pro', price:30.25, weight:105, mfgPn:'D33EPB-B', desc:'price + SKU corrected via the fetched odigrips.com product page (2026-07-08); maker does not publish weight, sample unchanged' },
  ...
  { id:'gr-odi-ruffian-v21', cat:'grips', brand:'ODI', model:'Ruffian V2.1 Lock-On', family:'odi-ruffian', price:32.00, weight:105, mfgPn:'D33RFB-B', desc:'price + SKU confirmed via the fetched odigrips.com product page; 105g from the Vital MTB spec table (the maker page itself does not list weight), kept unverified' },
  { id:'gr-odi-rogue-v21', cat:'grips', brand:'ODI', model:'Rogue V2.1 Lock-On', family:'odi-rogue', price:32.00, weight:108, mfgPn:'D33RGU-U', desc:'price + SKU confirmed via the fetched odigrips.com product page (33.5mm large-diameter pad design); maker does not publish weight, sample estimate (class-typical vs. the cataloged ODI siblings)' },
  { id:'gr-odi-vans-v21', cat:'grips', brand:'ODI', model:'Vans V2.1 Lock-On', family:'odi-vans', price:33.95, weight:106, mfgPn:'D33VNB-B', desc:'price + SKU confirmed via the fetched odigrips.com product page; maker does not publish weight, sample estimate (class-typical vs. cataloged ODI siblings)' },
  { id:'gr-odi-ag2', cat:'grips', brand:'ODI', model:'AG-2 Lock-On', family:'odi-ag2', price:36.25, weight:106, mfgPn:'D35A2BH-B', desc:'Aaron Gwin signature grip; price + SKU confirmed via the fetched odigrips.com product page; maker does not publish weight, sample estimate (class-typical vs. cataloged ODI siblings)' },
  { id:'gr-ergon-gd1-evo', cat:'grips', brand:'Ergon', model:'GD1 Evo', family:'ergon-gd1', price:34.95, weight:120, desc:'price + 30mm diameter confirmed via the fetched ergonbike.shop product page; 120g is a third-party figure (the page itself does not list weight), kept unverified' },
  { id:'gr-ergon-gdh', cat:'grips', brand:'Ergon', model:'GDH', family:'ergon-gdh', price:44.95, weight:115, verified:true, lastChecked:'2026-07-08', source:'https://ergonbike.shop/products/gdh', desc:'32mm-diameter downhill grip, developed with Vali Höll/Troy Brosnan/Fabien Barel per the fetched product page' },
  { id:'gr-deity-slimfit', cat:'grips', brand:'Deity', model:'Slimfit', family:'deity-slimfit', price:27.99, weight:96, verified:true, lastChecked:'2026-07-08', source:'https://www.deitycomponents.com/slimfit-grips.html', desc:'30.5mm outer diameter, the thinnest Deity grip; price from the deitycomponents.com store listing, weight from the fetched product page' },
  { id:'gr-deity-lockjaw', cat:'grips', brand:'Deity', model:'Lockjaw', family:'deity-lockjaw', price:27.99, weight:104, verified:true, lastChecked:'2026-07-08', source:'https://www.deitycomponents.com/lockjaw_grips.html', desc:'32mm outer diameter; price from the deitycomponents.com store listing, weight from the fetched product page' },
  { id:'gr-chromag-format', cat:'grips', brand:'Chromag', model:'Format', family:'chromag-format', price:39.00, weight:91, verified:true, lastChecked:'2026-07-08', source:'https://us.chromagbikes.com/products/grips-format', desc:'single-clamp ergonomic grip, per the fetched chromagbikes.com product page' },
  { id:'gr-chromag-basis', cat:'grips', brand:'Chromag', model:'Basis', family:'chromag-basis', price:42.00, weight:104, verified:true, lastChecked:'2026-07-08', source:'https://us.chromagbikes.com/products/grips-basis', desc:'narrow-diameter dual-clamp grip for smaller hands, per the fetched chromagbikes.com product page' },
  { id:'gr-chromag-palmskin', cat:'grips', brand:'Chromag', model:'Palmskin', family:'chromag-palmskin', price:42.00, weight:104, verified:true, lastChecked:'2026-07-09', source:'https://us.chromagbikes.com/products/grips-palmskin', desc:'gloveless soft-compound grip, per the fetched chromagbikes.com product page' },
  { id:'gr-renthal-ultratacky-pushon', cat:'grips', brand:'Renthal', model:'Push-On Ultra Tacky', family:'renthal-ultratacky', price:22.90, weight:108, desc:'135mm length + price confirmed via the fetched renthal.com/cycle/push-on-ultratacky page; maker does not publish weight there, 108g is a third-party (Amazon/Rocky Mountain ATV) figure, kept unverified' },
  { id:'gr-chromag-clutch', cat:'grips', brand:'Chromag', model:'Clutch', family:'chromag-clutch', price:46.00, weight:113, verified:true, lastChecked:'2026-07-08', source:'https://us.chromagbikes.com/products/grips-clutch', desc:'extra-long grip with finger grooves, per the fetched chromagbikes.com product page' },
  { id:'gr-ergon-ga2', cat:'grips', brand:'Ergon', model:'GA2', family:'ergon-ga2', price:34.95, weight:107, verified:true, lastChecked:'2026-07-08', source:'https://ergonbike.shop/products/ergon-ga2', desc:'32mm diameter, right/left-specific all-mountain grip, per the fetched product page' },
  { id:'gr-sdg-thrice-31', cat:'grips', brand:'SDG', model:'Thrice 31 (S/M)', family:'sdg-thrice', price:19.99, weight:90, desc:'31mm diameter, 136mm length, per the fetched sdgcomponents.com product page; that page states "39 grams" ambiguously (unclear if per grip or per pair), so weight is kept a documented sample rather than trusting that figure directly' },
  ...
  /* --- catalog-saddles-breadth-2 (2026-07-08): Selle Italia off-road line, Fabric Scoop/Line breadth, SDG Bel-Air/Radar/Duster/Allure/Fly Jr breadth, Specialized Body Geometry Power/Phenom/Henge --- */
  { id:'sa-selleitalia-slr-boost-x-cross-ti316-superflow', cat:'saddle', brand:'Selle Italia', model:'SLR Boost X-Cross TI316 Superflow (S3)', family:'selleitalia-slr-boost', price:299.90, weight:195, verified:true, lastChecked:'2026-07-08', source:'https://www.selleitalia.com/slr-boost-x-cross-ti316-superflow/', desc:'S3 (130mm) SKU - 195g, TI316 rails, from the fetched selleitalia.com spec table; the L3 (145mm) sibling weighs 200g. $299.90 is the listed price before the site-wide "sale" discount ($239.92) shown at fetch time.' },
  { id:'sa-selleitalia-flite-boost-x-cross-ti316-superflow', cat:'saddle', brand:'Selle Italia', model:'Flite Boost X-Cross TI316 Superflow (S3)', family:'selleitalia-flite-boost', price:299.90, weight:216, verified:true, lastChecked:'2026-07-08', source:'https://www.selleitalia.com/flite-boost-x-cross-ti316-superflow/', desc:'S3 SKU - 216g, TI316 rails, from the fetched selleitalia.com spec table; the L3 sibling weighs 220g.' },
  { id:'sa-selleitalia-novus-boost-evo-x-cross-tm-superflow', cat:'saddle', brand:'Selle Italia', model:'Novus Boost Evo X-Cross TM Superflow', family:'selleitalia-novus-boost-evo', price:129.90, weight:251, verified:true, lastChecked:'2026-07-08', source:'https://www.selleitalia.com/novus-boost-evo-x-cross-tm-superflow/', desc:'251g (L3, only size listed), Cromoly/Manganese ("TM") rails, from the fetched selleitalia.com spec table.' },
  { id:'sa-selleitalia-x-bow-superflow', cat:'saddle', brand:'Selle Italia', model:'X-Bow Superflow (S3)', family:'selleitalia-x-bow', price:74.90, weight:346, verified:true, lastChecked:'2026-07-08', source:'https://www.selleitalia.com/x-bow-superflow/', desc:'S3 SKU - 346g, FEC-alloy rails, from the fetched selleitalia.com spec table; the L3 sibling weighs 354g. The non-Superflow X-Bow (no cutout) is the same price and near-identical weight (S1 346g/L1 356g) - not entered as a separate row.' },
  { id:'sa-selleitalia-x-bow-ti-316-superflow', cat:'saddle', brand:'Selle Italia', model:'X-Bow TI316 Superflow (S3)', family:'selleitalia-x-bow', price:119.90, weight:266, verified:true, lastChecked:'2026-07-08', source:'https://www.selleitalia.com/x-bow-ti-316-superflow/', desc:'S3 SKU - 266g, TI316 rails, from the fetched selleitalia.com spec table; the L3 sibling weighs 274g. $119.90 is the listed price before the site-wide sale ($71.94). The non-Superflow X-Bow TI316 is the same price and near-identical weight (S2 266g/L2 276g) - not entered as a separate row.' },
  { id:'sa-selleitalia-x-lr-ti-316-superflow', cat:'saddle', brand:'Selle Italia', model:'X-LR TI316 Superflow (S3)', family:'selleitalia-x-lr', price:179.90, weight:165, verified:true, lastChecked:'2026-07-08', source:'https://www.selleitalia.com/x-lr-ti-316-superflow/', desc:'S3 SKU - 165g, TI316 rails, dedicated XC-race saddle, from the fetched selleitalia.com spec table; the L3 sibling weighs 175g.' },
  { id:'sa-selleitalia-x-lr-kit-carbonio-superflow', cat:'saddle', brand:'Selle Italia', model:'X-LR Kit Carbonio Superflow (S3)', family:'selleitalia-x-lr', price:279.90, weight:130, verified:true, lastChecked:'2026-07-08', source:'https://www.selleitalia.com/x-lr-kit-carbonio-superflow/', desc:'S3 SKU - 130g, full carbon rails, from the fetched selleitalia.com spec table; the L3 sibling weighs 138g. $279.90 is the listed price before the site-wide sale ($195.93).' },
  { id:'sa-selleitalia-x-lr-air-cross-tm-superflow', cat:'saddle', brand:'Selle Italia', model:'X-LR Air Cross TM Superflow (S3)', family:'selleitalia-x-lr', price:109.90, weight:215, verified:true, lastChecked:'2026-07-08', source:'https://www.selleitalia.com/x-lr-air-cross-tm-superflow/', desc:'S3 SKU - 215g, Cromoly/Manganese ("TM") rails, from the fetched selleitalia.com spec table; the L3 sibling weighs 224g.' },
  { id:'sa-selleitalia-model-y', cat:'saddle', brand:'Selle Italia', model:'Model Y', family:'selleitalia-model-y', price:79.90, weight:277, verified:true, lastChecked:'2026-07-08', source:'https://www.selleitalia.com/model-y/', desc:'277g (L2 size), TI316 rails, from the fetched selleitalia.com spec table. $79.90 is the listed price before the site-wide sale ($55.93).' },
  { id:'sa-fabric-scoop-elite-radius', cat:'saddle', brand:'Fabric', model:'Scoop Elite Radius', family:'fabric-scoop', price:82, weight:272, verified:true, lastChecked:'2026-07-08', source:'https://fabric.cc/products/scoop-elite-radius', desc:'CroMo rails, 142mm width, 272g/$82 USD from the fetched fabric.cc page (US locale - the default EU locale shows EUR44,90 without a country=US query param appended to the URL).' },
  { id:'sa-fabric-scoop-race-team-radius', cat:'saddle', brand:'Fabric', model:'Scoop Race Team Radius', family:'fabric-scoop', price:105, weight:265, verified:true, lastChecked:'2026-07-08', source:'https://fabric.cc/products/scoop-race-team-radius', desc:'Titanium rails, 142mm width, 265g/$105 USD from the fetched fabric.cc page (US locale).' },
  { id:'sa-fabric-line-elite-shallow', cat:'saddle', brand:'Fabric', model:'Line Elite Shallow', family:'fabric-line', price:94, weight:255, verified:true, lastChecked:'2026-07-08', source:'https://fabric.cc/products/line-elite-shallow', desc:'CroMo rails, 142mm width, 255g/$94 USD from the fetched fabric.cc page (US locale).' },
  { id:'sa-fabric-line-race-team-shallow', cat:'saddle', brand:'Fabric', model:'Line Race Team Shallow', family:'fabric-line', price:128, weight:244, verified:true, lastChecked:'2026-07-08', source:'https://fabric.cc/products/line-race-team-shallow', desc:'Titanium rails, 142mm width, 244g/$128 USD from the fetched fabric.cc page (US locale).' },
  { id:'sa-fabric-scoop-sport-shallow', cat:'saddle', brand:'Fabric', model:'Scoop Sport Shallow', family:'fabric-scoop', price:53, weight:308, verified:true, lastChecked:'2026-07-08', source:'https://fabric.cc/products/scoop-sport-shallow', desc:'Steel rails, 142mm width, 308g/$53 USD from the fetched fabric.cc page (US locale).' },
  { id:'sa-fabric-scoop-elite-flat', cat:'saddle', brand:'Fabric', model:'Scoop Elite Flat', family:'fabric-scoop', price:82, weight:259, verified:true, lastChecked:'2026-07-08', source:'https://fabric.cc/products/scoop-elite-flat', desc:'CroMo rails, 142mm width, 259g/$82 USD from the fetched fabric.cc page (US locale).' },
  { id:'sa-fabric-scoop-race-team-flat', cat:'saddle', brand:'Fabric', model:'Scoop Race Team Flat', family:'fabric-scoop', price:105, weight:245, verified:true, lastChecked:'2026-07-08', source:'https://fabric.cc/products/scoop-race-team-flat', desc:'Titanium rails, 142mm width, 245g/$105 USD from the fetched fabric.cc page (US locale).' },
  { id:'sa-fabric-scoop-race-team-shallow', cat:'saddle', brand:'Fabric', model:'Scoop Race Team Shallow', family:'fabric-scoop', price:105, weight:258, verified:true, lastChecked:'2026-07-08', source:'https://fabric.cc/products/scoop-race-team-shallow', desc:'Titanium rails, 142mm width, 258g/$105 USD from the fetched fabric.cc page (US locale).' },
  { id:'sa-fabric-scoop-elite-shallow', cat:'saddle', brand:'Fabric', model:'Scoop Elite Shallow', family:'fabric-scoop', price:82, weight:269, verified:true, lastChecked:'2026-07-08', source:'https://fabric.cc/products/scoop-elite-shallow', desc:'CroMo rails, 142mm width, 269g/$82 USD from the fetched fabric.cc page (US locale).' },
  { id:'sa-fabric-scoop-elite-radius-gel', cat:'saddle', brand:'Fabric', model:'Scoop Elite Radius Gel', family:'fabric-scoop', price:88, weight:293, verified:true, lastChecked:'2026-07-08', source:'https://fabric.cc/products/scoop-elite-radius-gel', desc:'CroMo rails, 155mm width (gel-padded, wider than the standard 142mm Scoop), 293g/$88 USD from the fetched fabric.cc page (US locale).' },
  { id:'sa-fabric-line-sport-shallow', cat:'saddle', brand:'Fabric', model:'Line Sport Shallow', family:'fabric-line', price:64, weight:290, verified:true, lastChecked:'2026-07-08', source:'https://fabric.cc/products/line-sport-shallow', desc:'Steel rails, 142mm width, 290g/$64 USD from the fetched fabric.cc page (US locale).' },
  { id:'sa-sdg-belair-v3-max-lux-alloy', cat:'saddle', brand:'SDG', model:'Bel-Air V3 MAX (Lux-Alloy)', family:'sdg-belair', price:104.99, weight:245, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/bel-air-v3-max', desc:'MAX = wider shape than the standard Bel-Air V3, 140mm; Lux-Alloy rails, 245g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-belair-v3-overland-lux-alloy', cat:'saddle', brand:'SDG', model:'Bel-Air V3 Overland (Lux-Alloy)', family:'sdg-belair', price:104.99, weight:230, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/bel-air-v3-overland', desc:'Overland = bikepacking-oriented shape (saddle-bag compatible), 140mm, Lux-Alloy rails, 230g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-belair-v3-overland-carbon', cat:'saddle', brand:'SDG', model:'Bel-Air V3 Overland (Carbon Fiber)', family:'sdg-belair', price:209.99, weight:171, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/bel-air-v3-overland-carbon-fiber', desc:'Same Overland shape as the Lux-Alloy sibling but 7x9mm uni-directional carbon rails, 140mm, 171g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-belair-v3-carbon', cat:'saddle', brand:'SDG', model:'Bel-Air V3 (Carbon)', family:'sdg-belair', price:209.99, weight:181, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/bel-air-v3-carbon', desc:'Standard Bel-Air V3 shape with carbon rails (vs the Lux-Alloy base row already in the catalog), 140mm, 181g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-allure-v2-lux-alloy', cat:'saddle', brand:'SDG', model:'Allure V2 (Lux-Alloy)', family:'sdg-allure', price:104.99, weight:255, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/allure-v2-ti-alloy', desc:'Female-specific saddle shape, 143mm; the fetched sdgcomponents.com spec table says Lux-Alloy rails despite the URL slug saying ti-alloy - the page content is trusted over the stale slug. 255g.' },
  { id:'sa-sdg-belair-v3-air-foam-lux-alloy', cat:'saddle', brand:'SDG', model:'Bel-Air V3 Air Foam (Lux-Alloy)', family:'sdg-belair', price:104.99, weight:283, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/bel-air-v3-air-foam-lux-alloy', desc:'Same Bel-Air V3 shape/rails as the base catalog row but a different foam padding compound, 140mm, 283g (heavier than the standard 236g Bel-Air V3 Lux-Alloy row), from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-radar-cro-mo', cat:'saddle', brand:'SDG', model:'Radar (Cro-Mo)', family:'sdg-radar', price:69.99, weight:245, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/radar-cro-mo', desc:'Same Radar shape as the catalogs Ti-Alloy row but Cro-Mo rails, 138mm, 245g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-duster-p-mtn-ti-alloy', cat:'saddle', brand:'SDG', model:'Duster P MTN (Ti-Alloy)', family:'sdg-duster-p-mtn', price:99.99, weight:240, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/duster-p-mtn-ti-alloy', desc:'140mm, Ti-Alloy rails, 240g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-duster-p-mtn-cro-mo', cat:'saddle', brand:'SDG', model:'Duster P MTN (Cro-Mo)', family:'sdg-duster-p-mtn', price:69.99, weight:255, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/duster-p-mtn-cro-mo', desc:'Same Duster P MTN shape as the Ti-Alloy row but Cro-Mo rails, 140mm, 255g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-belair-rl-steel', cat:'saddle', brand:'SDG', model:'Bel-Air RL (Steel)', family:'sdg-belair-rl', price:42.99, weight:260, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/bel-air-rl-steel', desc:'Entry-level recreational sibling of the Bel-Air line, 140mm, steel rails, 260g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-fly-jr-steel', cat:'saddle', brand:'SDG', model:'Fly Jr (Steel)', family:'sdg-fly-jr', price:39.99, weight:270, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/2017-fly-jr-steel-1', desc:'Junior/kids saddle, narrow 122mm width, steel rails, 270g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-patriot-cro-mo', cat:'saddle', brand:'SDG', model:'Patriot (Cro-Mo)', family:'sdg-patriot', price:49.99, weight:270, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/patriot-cro-mo', desc:'DH/gravity-oriented shape (SDG Gravity collection), 129mm, Cro-Mo rails, 270g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-patriot-i-beam', cat:'saddle', brand:'SDG', model:'Patriot (I-Beam)', family:'sdg-patriot', price:49.99, weight:215, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/patriot-i-beam', desc:'Same Patriot DH/gravity shape as the Cro-Mo row but a solid I-Beam rail system, 129mm, 215g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-apollo-i-beam', cat:'saddle', brand:'SDG', model:'Apollo (I-Beam)', family:'sdg-apollo', price:49.99, weight:235, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/apollo-i-beam', desc:'DH/gravity-oriented shape (SDG Gravity collection), 134mm, solid I-Beam rail, 235g, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-sdg-apollo-b-rage', cat:'saddle', brand:'SDG', model:'Apollo B-RAGE', family:'sdg-apollo', price:64.99, weight:265, verified:true, lastChecked:'2026-07-08', source:'https://sdgcomponents.com/collections/mountain/products/apollo-b-rage', desc:'Same Apollo shape, 134mm, 265g; the fetched sdgcomponents.com page notes the rail is Cro-Mo or I-Beam depending on the buyers choice at checkout, from the fetched sdgcomponents.com spec table.' },
  { id:'sa-specialized-power-comp', cat:'saddle', brand:'Specialized', model:'Power Comp', family:'specialized-power', price:100, weight:247, desc:'143mm-width figure; Specialized also lists 155mm (253g) and 168mm (256g) widths. Cr-Mo rails. specialized.com blocks automated fetches (403 on every product URL tried, and the Chrome browser tool was unreachable this session), so this rests on convergent retailer listings (roadbikeaction.com plus several shop pages) rather than a fetched manufacturer page - left unverified.' },
  { id:'sa-specialized-phenom-comp', cat:'saddle', brand:'Specialized', model:'Phenom Comp', family:'specialized-phenom', price:92, weight:254, desc:'143mm-width figure (the 155mm sibling weighs 260g per the same listings). Cr-Mo rails. specialized.com blocks automated fetches (403); price is the Bikeinn/Tradeinn listed figure ($91.99, rounded) - left unverified pending a fetchable source. Note: fanatikbike.com showed an identical $149.99 for this, the Power Comp, and the Bridge Comp with Mimic alike - too uniform to trust, so it was discarded rather than used.' },
  { id:'sa-specialized-henge-comp', cat:'saddle', brand:'Specialized', model:'Henge Comp', family:'specialized-henge', price:90, weight:280, desc:'143mm-width figure. Cr-Mo rails, EVA + Level 3 padding, trail/all-mountain shape. specialized.com blocks automated fetches (403); price/weight from convergent retailer/review listings - left unverified.' },
  ...
  { id:'pd-ht-t2', cat:'pedal', brand:'HT', model:'T2', family:'ht-t2', price:179, weight:376, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.ht-components.com/product/productDetail/63', desc:'"ENDURO RACE" clipless pedal, 376g/pair (cr-moly spindle, X1E/X1/X1F/X3 HT-exclusive cleat system) - re-verified against the fetched ht-components.com spec table (was sample data: 368g/$135). Site shows a US$179-230 range across finish tiers; using the low end as MSRP (same convention as the ATAC XC 12 row)' },
  ...
  /* --- catalog-pedals-breadth-2 (2026-07-08): Crankbrothers/HT/DMR/Look breadth pass.
     Race Face re-checked (raceface.com/collections/pedals) - its full current lineup is
     Chester/Atlas/Ride/Aeffect R/Turbine, all already cataloged above; no new RF rows.
     iSSi checked and SKIPPED: rideissi.com redirects to retiredbrandresources.com/issi -
     the brand is retired (archived under Quality Bicycle Products, manuals-only), no current
     US MSRP exists to enter honestly, so no rows added for it. */
  { id:'pd-crankbrothers-stamp-11-large', cat:'pedal', brand:'Crankbrothers', model:'Stamp 11 Large (Titanium)', family:'crankbrothers-stamp', mfgPn:'16165', price:329.99, weight:325, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/stamp-11-large', desc:'325g/pair, 114x111mm platform, 6Al/4V titanium spindle - fetched crankbrothers.com product page' },
  { id:'pd-crankbrothers-stamp-11-small', cat:'pedal', brand:'Crankbrothers', model:'Stamp 11 Small (Titanium)', family:'crankbrothers-stamp', mfgPn:'16166', price:329.99, weight:299, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/stamp-11-small', desc:'299g/pair, 100x100mm platform, titanium spindle - fetched crankbrothers.com product page' },
  { id:'pd-crankbrothers-stamp-evo-large', cat:'pedal', brand:'Crankbrothers', model:'Stamp EVO Large', family:'crankbrothers-stamp', mfgPn:'17227', price:199.99, weight:464, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/stamp-evo-large-alloy-flat-pedals', desc:'464g/pair, 114x133mm platform - 20% longer than Stamp 7 for more support - fetched crankbrothers.com product page' },
  { id:'pd-crankbrothers-stamp-evo-small', cat:'pedal', brand:'Crankbrothers', model:'Stamp EVO Small', family:'crankbrothers-stamp', mfgPn:'17228', price:199.99, weight:418, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/stamp-evo-small-alloy-flat-pedals', desc:'418g/pair, 103x117mm platform - fetched crankbrothers.com product page' },
  { id:'pd-crankbrothers-eggbeater-11', cat:'pedal', brand:'Crankbrothers', model:'Eggbeater 11 (Titanium)', family:'crankbrothers-eggbeater', mfgPn:'11495', price:549.99, weight:179, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/eggbeater-11', desc:'179g/pair, 6Al/4V titanium construction - the lightest Crankbrothers pedal - fetched crankbrothers.com product page' },
  { id:'pd-crankbrothers-candy-11', cat:'pedal', brand:'Crankbrothers', model:'Candy 11 (Titanium)', family:'crankbrothers-candy', mfgPn:'15984', price:549.99, weight:249, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/candy-11', desc:'249g/pair, titanium-spindle version of Candy - fetched crankbrothers.com product page' },
  { id:'pd-crankbrothers-candy-3', cat:'pedal', brand:'Crankbrothers', model:'Candy 3', family:'crankbrothers-candy', mfgPn:'16175', price:159.99, weight:340, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/candy-3', desc:'340g/pair, alloy body, 67x74mm - fetched crankbrothers.com product page; site currently runs a $134.99 sale, using the $159.99 regular price as MSRP' },
  { id:'pd-crankbrothers-mallet-dh', cat:'pedal', brand:'Crankbrothers', model:'Mallet DH', family:'crankbrothers-mallet', mfgPn:'16095', price:199.99, weight:479, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/mallet-dh', desc:'479g/pair - the largest Crankbrothers platform (13% more surface area than Mallet Enduro), built for DH racing - fetched crankbrothers.com product page' },
  { id:'pd-crankbrothers-mallet-dh-11', cat:'pedal', brand:'Crankbrothers', model:'Mallet DH 11 (Titanium)', family:'crankbrothers-mallet', mfgPn:'16096', price:379.99, weight:445, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/mallet-dh-11', desc:'445g/pair, titanium wings - fetched crankbrothers.com product page' },
  { id:'pd-crankbrothers-mallet-enduro-11', cat:'pedal', brand:'Crankbrothers', model:'Mallet Enduro 11 (Titanium)', family:'crankbrothers-mallet', mfgPn:'16093', price:379.99, weight:385, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/mallet-e-11', desc:'385g/pair, titanium wings, double-anodized black/gold, 94x75mm body - fetched crankbrothers.com product page' },
  { id:'pd-crankbrothers-mallet-3', cat:'pedal', brand:'Crankbrothers', model:'Mallet 3', family:'crankbrothers-mallet', mfgPn:'15988', price:159.99, weight:499, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/mallet-3', desc:'499g/pair - fetched crankbrothers.com product page; site currently runs a $134.99 sale, using the $159.99 regular price as MSRP' },
  { id:'pd-crankbrothers-doubleshot-3', cat:'pedal', brand:'Crankbrothers', model:'Double Shot 3', family:'crankbrothers-doubleshot', mfgPn:'16111', price:159.99, weight:403, style:'hybrid', verified:true, lastChecked:'2026-07-08', source:'https://www.crankbrothers.com/products/doubleshot-3', desc:'Dual-sided hybrid pedal: one side is a flat platform (8 adjustable pins + diamond-plate pad), the other clips in with proprietary Crankbrothers cleats (not SPD-compatible); 403g/pair, 57mm q-factor - fetched crankbrothers.com product page. First real hybrid-style pedal in the catalog; VOCAB.pedalStyle widened flat/clip -> +hybrid (schema.js) to represent it honestly rather than mislabeling it flat or clip' },
  { id:'pd-ht-x2', cat:'pedal', brand:'HT', model:'X2 DH Race', family:'ht-x2', price:169, weight:460, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.ht-components.com/product/productDetail/28', desc:'DH-race clipless pedal, 460g/pair, cr-moly spindle, X1E/X1/X1F/X2/X3 HT-exclusive cleat system - fetched ht-components.com spec table; US$169 MSRP confirmed against Jenson USA + Universal Cycles US listings (ht-components.com itself does not show USD)' },
  { id:'pd-ht-m2', cat:'pedal', brand:'HT', model:'M2 (Leopard M)', family:'ht-m2', price:140, weight:305, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.ht-components.com/product/productDetail/58', desc:'"Leopard M" trail/all-mountain clipless pedal, 305g/pair, cr-moly spindle - fetched ht-components.com spec table; site shows a US$140-200 range across finish tiers, using the low end as MSRP' },
  { id:'pd-ht-d1', cat:'pedal', brand:'HT', model:'D1 (Duo)', family:'ht-d1', price:145, weight:390, style:'hybrid', verified:true, lastChecked:'2026-07-08', source:'https://www.ht-components.com/product/productDetail/15', desc:'"Duo" dual-function clip/flat pedal - X1E/X1/X1F/X3 HT-exclusive cleat system on one side, replaceable grip pins on the flat side; 390g/pair - fetched ht-components.com spec table (US$145 MSRP)' },
  { id:'pd-ht-gd1', cat:'pedal', brand:'HT', model:'GD1 (G MTB)', family:'ht-gd1', price:85, weight:430, style:'hybrid', verified:true, lastChecked:'2026-07-08', source:'https://www.ht-components.com/product/productDetail/56', desc:'"G MTB" dual-function clip/flat pedal, diecast aluminum body, 83.5x90mm, 430g/pair - fetched ht-components.com spec table (US$85 MSRP)' },
  { id:'pd-ht-ae05', cat:'pedal', brand:'HT', model:'AE05 (EVO+)', family:'ht-ae05', price:140, weight:360, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://www.ht-components.com/product/productDetail/12', desc:'"EVO+" flat pedal, 100x96x17mm aluminum body, 360g/pair, no cleat compatibility listed - fetched ht-components.com spec table; site shows a US$140-199 range across finish tiers, using the low end as MSRP' },
  { id:'pd-ht-pa12a', cat:'pedal', brand:'HT', model:'PA12A (Nano-P)', family:'ht-pa12a', price:50, weight:350, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://www.ht-components.com/product/productDetail/33', desc:'"Nano-P" all-mountain flat pedal, reinforced nylon composite body, 100x95x18mm, cr-moly spindle, 350g/pair, no cleat compatibility listed - fetched ht-components.com spec table (US$50 MSRP)' },
  { id:'pd-ht-supreme', cat:'pedal', brand:'HT', model:'Supreme (Nano-S)', family:'ht-supreme', price:129, weight:368, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://www.ht-components.com/product/productDetail/17', desc:'"Nano-S" flat pedal, 100x100x16.6mm aluminum body, 368g/pair, no cleat compatibility listed - fetched ht-components.com spec table; site shows a US$129-169 range across finish tiers, using the low end as MSRP' },
  { id:'pd-dmr-v12', cat:'pedal', brand:'DMR', model:'V12', family:'dmr-v12', price:79.99, weight:430, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://dmrbikes.com/products/dmr-v12-pedal', desc:'Aluminum platform pedal, "under 430g"/pair per the fetched dmrbikes.com page (sealed bearings, cro-mo axle, tuneable pins); GBP60 list. dmrbikes.com does not show USD - US price taken from Incycle Bicycles ($79.99), a US retailer' },
  { id:'pd-dmr-v12-magnesium', cat:'pedal', brand:'DMR', model:'V12 Magnesium', family:'dmr-v12', price:105.99, weight:350, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://dmrbikes.com/products/dmr-v12-pedal', desc:'Magnesium-bodied version of the V12, 350g/pair per the fetched dmrbikes.com V12 page (which quotes the Mag version alongside the "under 430g" standard); GBP80 list. US price taken from Universal Cycles ($105.99), a US retailer' },
  { id:'pd-dmr-v11', cat:'pedal', brand:'DMR', model:'V11', family:'dmr-v11', price:55, weight:450, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://dmrbikes.com/products/dmr-v11-pedal', desc:'450g/pair, glass-reinforced nylon composite body, 11 replaceable steel pins per side - fetched dmrbikes.com (GBP44 list). US price taken from Incycle Bicycles ($55.00), a US retailer' },
  { id:'pd-dmr-v8', cat:'pedal', brand:'DMR', model:'V8', family:'dmr-v8', price:54.95, weight:480, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://dmrbikes.com/products/dmr-v8-pedal', desc:'480g/pair, diecast aluminum body, 10 tuneable pins per side - fetched dmrbikes.com (GBP43 list, matches Incycle Bicycles\' figure). US price taken from Incycle Bicycles ($54.95), a US retailer' },
  { id:'pd-dmr-vault-mag', cat:'pedal', brand:'DMR', model:'Vault Mag', family:'dmr-vault', price:194.99, weight:404, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://dmrbikes.com/products/dmr-vault-mag-pedal', desc:'404g/pair, pressure-cast magnesium 105x105mm platform, 11 pins per pedal - fetched dmrbikes.com (GBP120 list). US price taken from Tree Fort Bikes\' regular price of $194.99 (site currently runs a $142.99 sale)' },
  { id:'pd-dmr-vault-midi', cat:'pedal', brand:'DMR', model:'Vault Midi', family:'dmr-vault', price:194.99, weight:420, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://dmrbikes.com/products/dmr-vault-midi-pedal', desc:'420g/pair, 95x104mm platform - DMR states "10% smaller / 16g lighter" than the standard Vault - fetched dmrbikes.com (GBP120 list). US price taken from Worldwide Cyclery ($194.99)' },
  { id:'pd-dmr-vault-mag-sl', cat:'pedal', brand:'DMR', model:'Vault Mag SL', family:'dmr-vault', price:349.99, weight:318, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://dmrbikes.com/products/dmr-vault-mag-sl-pedal', desc:'318g/pair, pressure die-cast magnesium 105x105mm platform + titanium axles, 17mm concave - fetched dmrbikes.com (GBP215 list, DMR\'s lightest Vault tier). US price taken from Worldwide Cyclery ($349.99); a Walmart listing shows 332g at a discounted ~$288, but the manufacturer-stated 318g is used here for weight' },
  { id:'pd-look-xtrack', cat:'pedal', brand:'Look', model:'X-Track', family:'look-xtrack', price:60, weight:450, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/products/pedals/mtb/cross-country/x-track', desc:'Entry-level SPD-compatible clipless pedal, aluminum body + Chromoly+ axle, 350mm2 platform, tension adjustable 6-14; 450g/pair including cleats (400g pedals-only) - fetched lookcycle.com US product page' },
  { id:'pd-look-xtrack-race', cat:'pedal', brand:'Look', model:'X-Track Race', family:'look-xtrack', price:100, weight:415, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/pedals-x-track-race', desc:'Composite body + Chromoly+ spindle, 515mm2 platform, SPD-compatible; 415g/pair including cleats (364g pedals-only) - fetched lookcycle.com US product page' },
  { id:'pd-look-xtrack-race-carbon', cat:'pedal', brand:'Look', model:'X-Track Race Carbon', family:'look-xtrack', price:165, weight:400, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/products/pedals/mtb/cross-country/x-track-race-carbon', desc:'Carbon body, 515mm2 platform, SPD-compatible; 400g/pair including cleats (350g pedals-only) - fetched lookcycle.com US product page' },
  { id:'pd-look-xtrack-race-carbon-ti', cat:'pedal', brand:'Look', model:'X-Track Race Carbon Ti', family:'look-xtrack', price:300, weight:340, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/products/pedals/mtb/cross-country/x-track-race-carbon-ti', desc:'Carbon body + titanium spindle, 515mm2 platform, 53mm q-factor, SPD-compatible; 340g/pair including cleats (290g pedals-only) - fetched lookcycle.com US product page' },
  { id:'pd-look-xtrack-enrage', cat:'pedal', brand:'Look', model:'X-Track En-Rage', family:'look-xtrack-enrage', price:105, weight:470, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/products/pedals/mtb/trail-enduro/x-track-en-rage', desc:'Forged aluminum body, 545mm2 platform, SPD-compatible trail/enduro pedal; 470g/pair including cleats (420g pedals-only) - fetched lookcycle.com US product page' },
  { id:'pd-look-xtrack-enrage-plus', cat:'pedal', brand:'Look', model:'X-Track En-Rage Plus', family:'look-xtrack-enrage', price:155, weight:500, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/products/pedals/mtb/trail-enduro/x-track-en-rage-plus', desc:'Forged aluminum body, SPD-compatible enduro pedal; 500g/pair including cleats (450g pedals-only) - fetched lookcycle.com US product page' },
  { id:'pd-look-xtrack-enrage-plus-ti', cat:'pedal', brand:'Look', model:'X-Track En-Rage Plus Ti', family:'look-xtrack-enrage', price:325, weight:450, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/products/pedals/mtb/trail-enduro/x-track-en-rage-plus-ti', desc:'Forged aluminum body + titanium axle, 664mm2 platform, 55mm q-factor, SPD-compatible; 450g/pair including cleats (400g pedals-only) - fetched lookcycle.com US product page' },
  { id:'pd-look-trailgrip', cat:'pedal', brand:'Look', model:'Trail Grip', family:'look-trailgrip', price:85, weight:530, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/products/pedals/mtb/trail-enduro/trail-grip', desc:'Flat pedal with LOOK activ grip by Vibram (composite studs + vulcanized rubber grip inserts, no cleats); 530g/pair - fetched lookcycle.com US product page' },
  { id:'pd-look-trailroc', cat:'pedal', brand:'Look', model:'Trail Roc', family:'look-trailroc', price:115, weight:420, style:'flat', desc:'Forged-aluminum flat pedal, 103x101mm, chromoly axle, 10 pins/side (5.5mm) - price from the fetched lookcycle.com collection listing; the individual product page 404s at time of entry, so weight (~406-430g/pair across teardowns) is corroborated via Bikerumor + BikeRadar reviews rather than a manufacturer spec table, left unverified' },
  { id:'pd-look-trailroc-plus', cat:'pedal', brand:'Look', model:'Trail Roc+', family:'look-trailroc', price:200, weight:395, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/products/dh-dirt/trail-roc-plus', desc:'Forged aluminum platform, 16mm profile, 10 adjustable pins, no cleats; 395g/pair - fetched lookcycle.com US product page' },
  { id:'pd-look-trailfusion', cat:'pedal', brand:'Look', model:'Trail Fusion', family:'look-trailfusion', price:60, weight:324, style:'flat', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/products/pedals/mtb/dh-dirt/trail-fusion', desc:'Wide composite-platform flat pedal, 8 metal pins per side, no cleats; 324g/pair - fetched lookcycle.com US product page' },
  { id:'pd-look-xtrack-power-dual', cat:'pedal', brand:'Look', model:'X-Track Power Dual', family:'look-xtrack-power', price:1200, weight:455, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/products/pedals/mtb/power-meter/x-track-power-dual', desc:'Dual-sided (both-leg) power meter pedal, SPD-compatible; 455g/pair including cleats - fetched lookcycle.com US product page' },
  { id:'pd-look-xtrack-power-single', cat:'pedal', brand:'Look', model:'X-Track Power Single', family:'look-xtrack-power', price:850, weight:455, style:'clip', verified:true, lastChecked:'2026-07-08', source:'https://www.lookcycle.com/us-en/products/pedals/powermeter/x-track-power-single', desc:'Single-sided power meter pedal, SPD-compatible; 455g/pair including cleats - fetched lookcycle.com US product page' },
...
var ALIASES = {
  ...
  'st-chromag': 'st-chromag-hifi-35',
  'st-chromag-ranger-v2-35': 'st-chromag-hifi-35',   // 2026-07-08: fabricated clamp - Ranger V2 is 31.8mm-only

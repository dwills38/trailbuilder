...
var PARTS = [
  ...
  { id:'fr-commencal-supreme-dh-v5', cat:'frame', brand:'Commencal', model:'Supreme DH V5', family:'commencal-supreme-dh', gen:'V5', disciplines:['dh'], price:2800, weight:5300, wheelConfigs:['29','mullet'], rearAxle:'150x12', headset:'straight-dc', headTubeUpper:'ZS56/28.6', headTubeLower:'ZS56/40', bb:'PF107', seatTube:31.6, brakeMount:'PM', maxRotorR:223, suspension:'full', shockEye:250, shockStroke:75, shockMount:'std', maxForkTravel:203, travel:200, udh:false, bundledShock:null, frameOnly:true, desc:'price + maxForkTravel = sample; headTube capture = ZS56/ZS56 per the fetched page (straight-dc steerer fit); rear 12x150 per Vital spec table (see comment above). NOTE 2026-07-08 (verify/retry): weight 5,3 kg MAKER-CONFIRMED (23CSUP1 product page), but VERIFICATION DEFERRED - the maker complete-bike page (23SUPR) states "Rear Hub dimension: 157x12mm" (native SuperBoost157 with a 157->150 conversion kit A22WHADAPDHV5), so rearAxle should be SuperBoost157 not 150x12, and rear travel is 220 not 200; correcting rearAxle breaks the DH-race golden (its rear wheel is 12x150) so it needs a 157 DH rear wheel first - scoped follow-up, do not ship the half-fix' },
  ...
  { id:'sh-ohlins-ttx22-m2-230x65', cat:'shock', brand:'Öhlins', model:'TTX22 m.2 (coil)', family:'ohlins-ttx22', price:750, weight:780, eye:230, stroke:65, mount:'std', spring:'coil', desc:'WEIGHT-BASIS FLAG (2026-07-08, chip task pending): the ~780 sample looks like a WITH-spring weight; Ohlins body weight excludes the coil spring (~486g for the TTX22m.2 per widely-cited editorial). Per DATA-ENTRY-TEMPLATE §5 coil shocks are catalogued WITHOUT spring + soldWithout. Likely systematic across the coil rows. ohlins.com product page states no weight, so not verified here.' },
  ...
  { id:'sh-ohlins-ttx22-m2-205x65-trun', cat:'shock', brand:'Öhlins', model:'TTX22 m.2 (205x65 trunnion)', family:'ohlins-ttx22', price:750, weight:770, eye:205, stroke:65, mount:'trunnion', spring:'coil', desc:'sample specs; 205x65 trunnion existence confirmed via ohlins.com model page (TTX22M.2 Coil TM 205x65, art. MTBM 2228) and bike24.com listing. WEIGHT-BASIS FLAG (2026-07-08, chip task pending): the 770 sample looks WITH-spring; Ohlins body is ~486g WITHOUT the coil (widely-cited editorial), the DATA-ENTRY-TEMPLATE §5 convention. ohlins.com states no weight, so not verified.' },

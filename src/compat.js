...
var PARTS = [
  ...
  /* --- catalog-frames-breadth-c (2026-07-08): Vitus frames from FETCHED vitusbikes.com product pages (Shopify storefront - fetches clean). Every verdict-driving interface (shock eye x stroke x mount, rear axle, headset steerer, BB, seatpost, brake mount, max rotor, wheel config, UDH) is maker-stated on each product page; weight + price are COMPLETE-BIKE sample (Vitus publishes only complete-bike weight and these are the complete-bike pages), so the rows stay UNVERIFIED with the source in desc - the Spectral CF / Stumpjumper precedent. Each shock size below was chosen because it ALREADY exists in-catalog (not distorted to fit) so every frame is immediately buildable. Same-pass blocks (see handoff): Orbea (orbea.com) + Propain (propain-bikes.com) product pages are 403/WAF-blocked to a fetch, Radon (radon-bikes.de) is a JS SPA serving a generic shell, and Calibre (calibrebicycles.com) pages omit the frame BB + caliper brake-mount, so none of those four can meet the fetched-field bar this pass. --- */
  { id:'fr-vitus-sommet-29-crx', cat:'frame', brand:'Vitus', model:'Sommet 29 CRX', family:'vitus-sommet', modelYear:2022, disciplines:['enduro'], price:2400, weight:3300, wheelConfigs:['29'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'ZS44/28.6', headTubeLower:'ZS56/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:203, suspension:'full', shockEye:205, shockStroke:62.5, shockMount:'trunnion', maxForkTravel:170, travel:162, udh:false, bundledShock:null, frameOnly:false, desc:'interfaces from the FETCHED vitusbikes.com Sommet 29 CRX 2022 product page: 162mm rear / 170 fork, Fox Float X2 205x62.5 TRUNNION (matches sh-fox-float-x-205x62p5-trun in-catalog), 148x12 Boost, Acros ZS44/28.6 upper + ZS56/40 lower (tapered steerer fit), BSA 73mm threaded, 31.6 post, Post Mount, 203 max rotor front+rear, 29in. weight + price = complete-bike sample (page lists complete bike 15.6kg / GBP 3,999.99; no frame-only weight published) so the row stays UNVERIFIED per the Spectral CF/Stumpjumper precedent; UDH not stated on this 2022 frame -> udh:false noted (Jibb/Neuron precedent); maxForkTravel 170 = stated stock/design fork. Source: https://vitusbikes.com/products/vitus-sommet-29-crx-mountain-bike-2022' },
  { id:'fr-vitus-sommet-297-crx', cat:'frame', brand:'Vitus', model:'Sommet 297 CRX', family:'vitus-sommet', modelYear:2022, disciplines:['enduro'], price:2400, weight:3300, wheelConfigs:['mullet'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'ZS44/28.6', headTubeLower:'ZS56/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:203, suspension:'full', shockEye:205, shockStroke:65, shockMount:'trunnion', maxForkTravel:170, travel:170, udh:false, bundledShock:null, frameOnly:false, desc:'interfaces from the FETCHED vitusbikes.com Sommet 297 CRX 2022 product page: MULLET (29 front / 27.5 rear), 170mm rear / 170 fork, Fox Float X2 205x65 TRUNNION (matches sh-fox-float-x2-205x65-trun in-catalog), 148x12 Boost, Acros ZS44/28.6 + ZS56/40 (tapered steerer fit), BSA 73mm threaded, 31.6 post, Post Mount, 203 max rotor, 29F/27.5R. weight + price = complete-bike sample (complete bike 15.5kg / GBP 3,999.99; no frame-only weight) so UNVERIFIED (Spectral/Stumpjumper precedent); UDH not stated -> udh:false; maxForkTravel 170 = stock fork. Source: https://vitusbikes.com/products/vitus-sommet-297-crx-mountain-bike-2022' },
  { id:'fr-vitus-sommet-27-crx', cat:'frame', brand:'Vitus', model:'Sommet 27 CRX', family:'vitus-sommet', modelYear:2021, disciplines:['enduro'], price:2400, weight:3300, wheelConfigs:['275'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'ZS44/28.6', headTubeLower:'ZS56/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:203, suspension:'full', shockEye:205, shockStroke:65, shockMount:'trunnion', maxForkTravel:170, travel:170, udh:false, bundledShock:null, frameOnly:false, desc:'interfaces from the FETCHED vitusbikes.com Sommet 27 CRX 2021 product page: FULL 27.5, 170mm rear / 170 fork, 205x65 TRUNNION (matches sh-fox-float-x2-205x65-trun etc), 148x12 Boost, Acros ZS44/28.6 + ZS56/40 (tapered steerer fit), BSA 73mm threaded, 31.6 post, Post Mount, 203 max rotor, rear tire 27.5x2.40. weight + price = complete-bike sample (complete bike 15.0kg / GBP 3,599.99; no frame-only weight) so UNVERIFIED; UDH not stated -> udh:false; maxForkTravel 170 = stock fork. Buildable in-catalog: fk-rockshox-zeb-ultimate-275-170 / fk-ohlins-rxf36-m2-275-170 + dtswiss e-1900 275 wheels + 27.5 enduro tires. Source: https://vitusbikes.com/products/vitus-sommet-27-crx-mountain-bike' },
  { id:'fr-vitus-escarpe-29-crx', cat:'frame', brand:'Vitus', model:'Escarpe 29 CRX', family:'vitus-escarpe', disciplines:['trail'], price:2000, weight:3000, wheelConfigs:['29'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'ZS44/28.6', headTubeLower:'ZS56/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:180, suspension:'full', shockEye:205, shockStroke:60, shockMount:'trunnion', maxForkTravel:150, travel:140, udh:false, bundledShock:null, frameOnly:false, desc:'interfaces from the FETCHED vitusbikes.com Escarpe 29 CRX product page: 140mm rear / 150 fork, 205x60 TRUNNION (matches sh-rockshox-super-deluxe-ultimate-205x60-trun / sh-fox-float-x2-perf-elite-205x60-trun in-catalog), 148x12 Boost, Acros OD44 44/28.6-56/40 (tapered steerer fit), Shimano BSA 73mm threaded, 31.6 post, Post Mount, 180 max rotor rear, 29in. weight + price = complete-bike sample (complete bike 14.3kg / GBP 3,499.99; no frame-only weight) so UNVERIFIED; UDH not stated -> udh:false; maxForkTravel 150 = stock fork. Source: https://vitusbikes.com/products/vitus-escarpe-29-crx-mountain-bike' },
  { id:'fr-vitus-escarpe-27-crx', cat:'frame', brand:'Vitus', model:'Escarpe 27 CRX', family:'vitus-escarpe', disciplines:['trail'], price:2000, weight:3000, wheelConfigs:['275'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'ZS44/28.6', headTubeLower:'ZS56/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:180, suspension:'full', shockEye:205, shockStroke:60, shockMount:'trunnion', maxForkTravel:150, travel:140, udh:false, bundledShock:null, frameOnly:false, desc:'first full-27.5 TRAIL frame in-catalog. Interfaces from the FETCHED vitusbikes.com Escarpe 27 CRX product page: FULL 27.5, 140mm rear / 150 fork, Fox Float DPS 205x60 TRUNNION (matches sh-rockshox-super-deluxe-ultimate-205x60-trun etc in-catalog), 148x12 Boost, Acros OD44 44/28.6-56/40 (tapered steerer fit), BSA 73mm threaded, 31.6 post, Post Mount, 180 max rotor rear, rear tire 27.5x2.40, 27.5in. weight + price = complete-bike sample (complete bike 14.0kg / GBP 3,499.99; no frame-only weight) so UNVERIFIED; UDH not stated -> udh:false; maxForkTravel 150 = stock fork. Buildable in-catalog: fk-rockshox-pike-ultimate-275-140 (140mm fits the 150 max) + dtswiss e-1900 275 wheels + 27.5 trail tires. Source: https://vitusbikes.com/products/vitus-escarpe-27-crx-mountain-bike' },
  { id:'fr-vitus-mythique-29-vrx', cat:'frame', brand:'Vitus', model:'Mythique 29 VRX', family:'vitus-mythique', modelYear:2023, disciplines:['trail'], price:1400, weight:3600, wheelConfigs:['29'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'ZS44/28.6', headTubeLower:'ZS56/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:180, maxTire:2.5, suspension:'full', shockEye:185, shockStroke:55, shockMount:'trunnion', maxForkTravel:140, travel:140, udh:true, bundledShock:null, frameOnly:false, desc:'interfaces from the FETCHED vitusbikes.com Mythique 29 VRX 2023 product page (alloy trail): 140mm rear / 140 fork, RockShox Deluxe Select R 185x55 TRUNNION (matches sh-rockshox-super-deluxe-ultimate-185x55-trun / sh-fox-float-x-perf-elite-185x55-trun in-catalog), rear axle+hanger page-stated "148mm x 12mm UDH, M12xP1.0" -> udh:true, Acros ZS44/28.6 + ZS56/40 (tapered steerer fit), 73mm BSA threaded, 31.6 post, Post Mount, 180 max rotor rear, page-stated maximum tire 29x2.5 (rule 18 active), 29in. weight + price = complete-bike sample (complete bike 15.3kg / GBP 2,099.99; no frame-only weight) so UNVERIFIED; maxForkTravel 140 = stock fork. Source: https://vitusbikes.com/products/vitus-mythique-29-vrx-mountain-bike-2023' },

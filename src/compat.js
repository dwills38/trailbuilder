...
var PARTS = [
  ...
  /* --- catalog-forks-breadth-2 (2026-07-09): fetched bike.marzocchi.com/products/bomber-z1's own variant list (the .json Shopify endpoint, not just the marketing copy) to get the REAL sold SKU matrix rather than assume every travel x wheel combo exists: 29"/150mm, 29"/160mm (x2 colors, already above), 27.5"/160mm, 27.5"/100mm (a lower-priced DJ-oriented build) - NOT a full 100/150/160 x 29/27.5 cross-product. Rotor 180mm and the 2109g figure are the SAME flat manufacturer-page numbers already used for the verified row above (Marzocchi states one figure for the whole page, not per-travel). --- */
  { id:'fk-marzocchi-bomber-z1-29-150', cat:'fork', brand:'Marzocchi', model:'Bomber Z1 150', family:'marzocchi-bomber-z1', disciplines:['enduro'], price:639, weight:2109, wheel:'29', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://bike.marzocchi.com/products/bomber-z1', desc:'29/150mm variant confirmed via the fetched bike.marzocchi.com/products/bomber-z1.json variant list ($639, currently out of stock but a real listed SKU); axle/steerer/rotor/weight = the same page-wide figures as the verified 29/160 row' },
  { id:'fk-marzocchi-bomber-z1-275-160', cat:'fork', brand:'Marzocchi', model:'Bomber Z1 27.5 160', family:'marzocchi-bomber-z1', disciplines:['enduro'], price:639, weight:2109, wheel:'275', travel:160, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://bike.marzocchi.com/products/bomber-z1', desc:'27.5/160mm variant confirmed via the fetched bike.marzocchi.com/products/bomber-z1.json variant list ($639, in stock); axle/steerer/rotor/weight = the same page-wide figures as the verified 29/160 row' },
  { id:'fk-marzocchi-bomber-z1-275-100', cat:'fork', brand:'Marzocchi', model:'Bomber Z1 27.5 100', family:'marzocchi-bomber-z1', disciplines:['trail'], price:609, weight:2109, wheel:'275', travel:100, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://bike.marzocchi.com/products/bomber-z1', desc:'27.5/100mm DJ-oriented variant confirmed via the fetched bike.marzocchi.com/products/bomber-z1.json variant list (its own distinct $609 price, out of stock but a real listed SKU); axle/steerer/rotor sourced the same as the other Z1 rows - weight uses the same page-wide 2109g figure as the longer-travel siblings though a 100mm chassis would realistically weigh less (Marzocchi does not break weight out per travel)' },
  ...
  /* catalog-forks-breadth-2 (2026-07-09) tried to add more Diamond/Sapphire/Onyx travel points and hit a wall: dvosuspension.com's product pages (fork/diamond-d1, fork/sapphire-d1, product/diamond-e3, etc.) all serve only an empty-cart JS shell to a fetch - no spec content at all, matching why this Onyx row already has no source. tech.dvosuspension.com (their setup/service subdomain) DOES fetch and confirms real travel ranges (Diamond Boost 29in: 130-160mm; Diamond Boost 27.5in: 140-170mm) but states no axle/steerer/rotor - not enough to source a verdict-driving row per this session's bar. web.archive.org is blocked for this tool entirely. Left untouched; a session with real browser access (not just WebFetch/curl) is needed to move DVO forward. */
  { id:'fk-fox-36-factory-29-160', cat:'fork', brand:'Fox', model:'36 Factory 160', family:'fox-36', disciplines:['enduro'], price:1099, weight:1960, wheel:'29', travel:160, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/2904/2023-2025-36mm-user-specifications', lastChecked:'2026-07-09', desc:'CORRECTED maxRotorF 203->230 + minRotorF 180 ADDED (catalog-forks-breadth-2): the fetched tech.ridefox.com "2023 FOX 36 29in 15x110" engineering user-spec sheet (note 12) states "FORK IS DESIGNED TO USE 180-230MM OUTSIDE DIAMETER DISC ROTORS... 180MM INTERNATIONAL BOOST POST MOUNT" - the 203 sample undersold the real max. Weight stays an unverified sample (Fox publishes no per-travel weight on this sheet), so this row is not marked verified' },
  ...
  /* catalog-forks-breadth-2 (2026-07-09): the current official extremeshox.com Era V2.1 product page fetches fine and confirms a real 130/140/150/160/170mm travel range, but states no wheel size, axle, steerer, rotor range, or weight (EUR pricing only) - not enough to source a new verdict-driving row per this session's bar (never infer axle/steerer/rotor from this 170mm sibling). Left as the sole Era row; a session that can pull EXT's PDF manual or a fuller spec table should revisit. */
  ...
  { id:'fk-manitou-mattoc-pro-29-150', cat:'fork', brand:'Manitou', model:'Mattoc Pro 150', family:'manitou-mattoc', disciplines:['enduro'], price:734.99, weight:1750, wheel:'29', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://hayesbicycle.com/products/mattoc-pro', desc:'CORRECTED (catalog-forks-breadth-2): the fetched hayesbicycle.com page states "Brake: Post Mount 160mm" (-> maxRotorF 160, down from the 203 sample - no adapter max is stated, so 160 is the sourced ceiling) and a flat 1730-1750g weight range across ALL its 110-150mm x 29/27.5 variants (-> 1750 for this, the longest-travel config, up from the 1950 sample); axle "15mm x 110mm Hexlock" (Boost110), steerer 1.5in tapered, and $734.99 US MSRP also confirmed on the same page' },
  /* --- catalog-forks-breadth-2 (2026-07-09): the same fetched hayesbicycle.com/products/mattoc-pro page lists a FULL 110/120/130/140/150mm x 29/27.5in matrix (this catalog previously had only the one 29/150 point above). Weight interpolated within the page's own stated 1730-1750g range (shortest travel = 1730, longest = 1750); maxRotorF 160 is the same sourced "Post Mount 160mm" fact as the row above, not a guess per-row. Tagged 'trail' rather than 'enduro' for the shorter, more trail-appropriate travels (annotation-only, doesn't feed checkBuild). */
  { id:'fk-manitou-mattoc-pro-29-110', cat:'fork', brand:'Manitou', model:'Mattoc Pro 110', family:'manitou-mattoc', disciplines:['trail'], price:734.99, weight:1730, wheel:'29', travel:110, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://hayesbicycle.com/products/mattoc-pro', desc:'29/110/Boost110/tapered/"Post Mount 160mm"/$734.99, weight = low end of the page\'s stated 1730-1750g range (shortest travel of the 110-150mm matrix)' },
  { id:'fk-manitou-mattoc-pro-29-120', cat:'fork', brand:'Manitou', model:'Mattoc Pro 120', family:'manitou-mattoc', disciplines:['trail'], price:734.99, weight:1735, wheel:'29', travel:120, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://hayesbicycle.com/products/mattoc-pro', desc:'29/120/Boost110/tapered/"Post Mount 160mm"/$734.99, weight interpolated within the page\'s stated 1730-1750g range' },
  { id:'fk-manitou-mattoc-pro-29-130', cat:'fork', brand:'Manitou', model:'Mattoc Pro 130', family:'manitou-mattoc', disciplines:['trail'], price:734.99, weight:1740, wheel:'29', travel:130, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://hayesbicycle.com/products/mattoc-pro', desc:'29/130/Boost110/tapered/"Post Mount 160mm"/$734.99, weight interpolated within the page\'s stated 1730-1750g range' },
  { id:'fk-manitou-mattoc-pro-29-140', cat:'fork', brand:'Manitou', model:'Mattoc Pro 140', family:'manitou-mattoc', disciplines:['trail'], price:734.99, weight:1745, wheel:'29', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://hayesbicycle.com/products/mattoc-pro', desc:'29/140/Boost110/tapered/"Post Mount 160mm"/$734.99, weight interpolated within the page\'s stated 1730-1750g range' },
  { id:'fk-manitou-mattoc-pro-275-110', cat:'fork', brand:'Manitou', model:'Mattoc Pro 27.5 110', family:'manitou-mattoc', disciplines:['trail'], price:734.99, weight:1730, wheel:'275', travel:110, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://hayesbicycle.com/products/mattoc-pro', desc:'27.5/110/Boost110/tapered/"Post Mount 160mm"/$734.99 - the fetched page explicitly lists 27.5in across the same 110-150mm range as 29in (a real wheel-size option this catalog\'s Mattoc previously lacked entirely), weight = low end of its stated range' },
  { id:'fk-manitou-mattoc-pro-275-120', cat:'fork', brand:'Manitou', model:'Mattoc Pro 27.5 120', family:'manitou-mattoc', disciplines:['trail'], price:734.99, weight:1735, wheel:'275', travel:120, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://hayesbicycle.com/products/mattoc-pro', desc:'27.5/120/Boost110/tapered/"Post Mount 160mm"/$734.99, weight interpolated within the page\'s stated range' },
  { id:'fk-manitou-mattoc-pro-275-130', cat:'fork', brand:'Manitou', model:'Mattoc Pro 27.5 130', family:'manitou-mattoc', disciplines:['trail'], price:734.99, weight:1740, wheel:'275', travel:130, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://hayesbicycle.com/products/mattoc-pro', desc:'27.5/130/Boost110/tapered/"Post Mount 160mm"/$734.99, weight interpolated within the page\'s stated range' },
  { id:'fk-manitou-mattoc-pro-275-140', cat:'fork', brand:'Manitou', model:'Mattoc Pro 27.5 140', family:'manitou-mattoc', disciplines:['trail'], price:734.99, weight:1745, wheel:'275', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://hayesbicycle.com/products/mattoc-pro', desc:'27.5/140/Boost110/tapered/"Post Mount 160mm"/$734.99, weight interpolated within the page\'s stated range' },
  { id:'fk-manitou-mattoc-pro-275-150', cat:'fork', brand:'Manitou', model:'Mattoc Pro 27.5 150', family:'manitou-mattoc', disciplines:['enduro'], price:734.99, weight:1750, wheel:'275', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://hayesbicycle.com/products/mattoc-pro', desc:'27.5/150/Boost110/tapered/"Post Mount 160mm"/$734.99, weight = high end of the page\'s stated range (matches the longest-travel 29/150 sibling)' },
  ...
  { id:'fk-manitou-mezzer-pro-29-150', cat:'fork', brand:'Manitou', model:'Mezzer Pro 150', family:'manitou-mezzer', gen:'G2', disciplines:['enduro'], price:1199.99, weight:2030, wheel:'29', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:223, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://hayesbicycle.com/products/mezzer-pro-g2', desc:'catalog-forks-breadth-2: closes the last of the Mezzer Pro G2\'s three listed travels (150/160/170 - the fetched hayesbicycle.com page confirms 29in only, no 27.5). Same 2030g figure as the 160/170 siblings (one chassis, internally adjustable 140-170) + same interfaces/price from the same source' },
  ...
  /* --- catalog-forks-breadth-2 (2026-07-09): the RXF34's own product page (fetched above) lists 120/130/140mm as its full travel range, 29in only - closing the other two. Each fetched individually (raw HTML, not the summarizer) to confirm per-travel price/weight: both $1,309, weight rising 1698->1727->1752g. --- */
  { id:'fk-ohlins-rxf34-m2-29-130', cat:'fork', brand:'Öhlins', model:'RXF34 m.2 130', family:'ohlins-rxf34', gen:'m.2', disciplines:['xc','trail'], price:1309, weight:1727, wheel:'29', travel:130, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:203, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-rxf34-m-2-air-otx18-29-44-130', desc:'29/130/15x110/1727g/$1,309 + "180-203 mm" rotor range from the fetched ohlins.com product page (own URL for this exact travel, not inferred from the 120 sibling)' },
  { id:'fk-ohlins-rxf34-m2-29-140', cat:'fork', brand:'Öhlins', model:'RXF34 m.2 140', family:'ohlins-rxf34', gen:'m.2', disciplines:['xc','trail'], price:1309, weight:1752, wheel:'29', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:203, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-rxf34-m-2-air-otx18-29-44-140-1', desc:'29/140/15x110/1752g/$1,309 + "180-203 mm" rotor range from the fetched ohlins.com product page (own URL for this exact travel - the plain "-140" slug 404s, the real product page is the "-140-1" slug)' },

  /* Öhlins RXF36 m.2 (existing verified 275/170 + 29/160 rows): the RXF36 m.2 line spans 27.5"/150-180mm (38mm offset) and 29"/140-170mm (51mm offset) per ohlins.com - each variant fetched individually via raw HTML (not the summarizer, after a cross-check confirmed the summarizer was NOT hallucinating repeat numbers - every page really does state 2150g "with bolts + axle" and a 180-205mm rotor range flat across the whole m.2 line, same as the two rows already verified in this catalog). Closes 275/150,160,180 and 29/140,150,170. */
  { id:'fk-ohlins-rxf36-m2-275-150', cat:'fork', brand:'Öhlins', model:'RXF36 m.2 27.5 150', family:'ohlins-rxf36', gen:'m.2', disciplines:['enduro'], price:1045, weight:2150, wheel:'275', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:205, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-ohlins-rxf36-m-2-air-ttx18-27-5-38-150', desc:'27.5/150/38mm offset/15x110/2150g ("with bolts + axle")/"180-205 mm" rotor range/$1,045 - all from the fetched ohlins.com product page for this exact SKU (FGMTB 3615 2061)' },
  { id:'fk-ohlins-rxf36-m2-275-160', cat:'fork', brand:'Öhlins', model:'RXF36 m.2 27.5 160', family:'ohlins-rxf36', gen:'m.2', disciplines:['enduro'], price:1245, weight:2150, wheel:'275', travel:160, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:205, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-ohlins-rxf36-m-2-air-ttx18-27-5-38-160', desc:'27.5/160/38mm offset/15x110/2150g/"180-205 mm" rotor range/$1,245 - all from the fetched ohlins.com product page for this exact SKU' },
  { id:'fk-ohlins-rxf36-m2-275-180', cat:'fork', brand:'Öhlins', model:'RXF36 m.2 27.5 180', family:'ohlins-rxf36', gen:'m.2', disciplines:['enduro'], price:1045, weight:2150, wheel:'275', travel:180, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:205, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-ohlins-rxf36-m-2-air-ttx18-27-5-38-180', desc:'27.5/180/38mm offset/15x110/2150g/"180-205 mm" rotor range/$1,045 (same price as the 150 sibling, per Öhlins own page - not a typo, double-checked via raw HTML) - all from the fetched ohlins.com product page for this exact SKU' },
  { id:'fk-ohlins-rxf36-m2-29-140', cat:'fork', brand:'Öhlins', model:'RXF36 m.2 140', family:'ohlins-rxf36', gen:'m.2', disciplines:['enduro'], price:1245, weight:2150, wheel:'29', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:205, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-ohlins-rxf36-m-2-air-ttx18-29-51-140', desc:'29/140/51mm offset/15x110/2150g/"180-205 mm" rotor range/$1,245 - all from the fetched ohlins.com product page for this exact SKU' },
  { id:'fk-ohlins-rxf36-m2-29-150', cat:'fork', brand:'Öhlins', model:'RXF36 m.2 150', family:'ohlins-rxf36', gen:'m.2', disciplines:['enduro'], price:1369.5, weight:2150, wheel:'29', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:205, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-ohlins-rxf36-m-2-air-ttx18-29-51-150', desc:'29/150/51mm offset/15x110/2150g/"180-205 mm" rotor range/$1,369.50 - all from the fetched ohlins.com product page for this exact SKU' },
  { id:'fk-ohlins-rxf36-m2-29-170', cat:'fork', brand:'Öhlins', model:'RXF36 m.2 170', family:'ohlins-rxf36', gen:'m.2', disciplines:['enduro'], price:1369.5, weight:2150, wheel:'29', travel:170, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:205, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-ohlins-rxf36-m-2-air-ttx18-29-51-170', desc:'29/170/51mm offset/15x110/2150g/"180-205 mm" rotor range/$1,369.50 (same price as the existing verified 275/170 row) - all from the fetched ohlins.com product page for this exact SKU' },

  /* Öhlins RXF36 m.3 - a NEW generation/model, not yet in this catalog: an "all-new chassis" (the page's own words) that coexists on sale alongside m.2, discovered by following the ohlins.com front-forks listing page. Variant links enumerated from the m.3 product page itself: 29"/44mm/140-160mm, one 29"/51mm/160mm, a 29"/44mm/160mm COIL, and only one 27.5" config (27.5"/38mm/170mm). Rotor range is 180-203mm (narrower than m.2's 180-205 - a real generational difference, not a typo) and weight is a flat "from 2050g" across every config, both confirmed per-row via raw HTML. Air spring only entered (coil skipped - fork schema has no spring field). */
  { id:'fk-ohlins-rxf36-m3-29-140', cat:'fork', brand:'Öhlins', model:'RXF36 m.3 140', family:'ohlins-rxf36', gen:'m.3', disciplines:['enduro'], price:1369.5, weight:2050, wheel:'29', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:203, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-rxf36-m-3-air-ttx18-29-44-140', desc:'29/140/44mm offset/15x110/2050g ("from 2050g (with bolts and axle)")/"180-203 mm" rotor range/$1,369.50 from the fetched ohlins.com RXF36 m.3 product page - an all-new chassis vs m.2 (own page: "an all-new chassis" with "reworked internals and design"), sold alongside it, not a replacement' },
  { id:'fk-ohlins-rxf36-m3-29-150', cat:'fork', brand:'Öhlins', model:'RXF36 m.3 150', family:'ohlins-rxf36', gen:'m.3', disciplines:['enduro'], price:1369.5, weight:2050, wheel:'29', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:203, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-rxf36-m-3-air-ttx18-29-44-150', desc:'29/150/44mm offset/15x110/2050g/"180-203 mm" rotor range/$1,369.50 from the fetched ohlins.com RXF36 m.3 product page for this exact SKU' },
  { id:'fk-ohlins-rxf36-m3-29-160', cat:'fork', brand:'Öhlins', model:'RXF36 m.3 160', family:'ohlins-rxf36', gen:'m.3', disciplines:['enduro'], price:1369.5, weight:2050, wheel:'29', travel:160, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:203, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-rxf36-m-3-air-ttx18-29-44-160', desc:'29/160/44mm offset/15x110/2050g/"180-203 mm" rotor range/$1,369.50 from the fetched ohlins.com RXF36 m.3 product page for this exact SKU (a 29/51mm-offset/160mm and a 29/44mm/160mm COIL variant also exist on the same page - offset and spring type aren\'t modeled as separate rows per this catalog\'s conventions)' },
  { id:'fk-ohlins-rxf36-m3-275-170', cat:'fork', brand:'Öhlins', model:'RXF36 m.3 27.5 170', family:'ohlins-rxf36', gen:'m.3', disciplines:['enduro'], price:1369.5, weight:2050, wheel:'275', travel:170, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:203, minRotorF:180, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-rxf36-m-3-air-ttx18-27-5-38-170', desc:'27.5/170/38mm offset/15x110/2050g/"180-203 mm" rotor range/$1,369.50 from the fetched ohlins.com RXF36 m.3 product page - the ONLY 27.5in config the m.3 line currently offers (per its own variant selector)' },

  /* Öhlins RXF38 m.3 - a NEW generation/model alongside the existing verified RXF38 m.2 rows: 29in only, 160/170/180mm (an air/coil choice at 170mm too - coil skipped, no fork spring field). Notably its rotor spec reads as a FIXED "200 mm" (not a range like m.2's 180-220) on every variant, confirmed via raw HTML each time - entered as min=max=200 to reflect a fixed-diameter native mount rather than fabricating a range the page doesn't state. */
  { id:'fk-ohlins-rxf38-m3-29-160', cat:'fork', brand:'Öhlins', model:'RXF38 m.3 160', family:'ohlins-rxf38', gen:'m.3', disciplines:['enduro'], price:1534.5, weight:2320, wheel:'29', travel:160, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:200, minRotorF:200, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-rxf38-m-3-air-ttx18-29-44-160', desc:'29/160/44mm offset/15x110/2320g ("with bolts and axle")/"Brake dim: 200 mm" (a FIXED size, not a range - entered as minRotorF=maxRotorF=200)/$1,534.50 from the fetched ohlins.com RXF38 m.3 product page (FGMTB 3816 2510)' },
  { id:'fk-ohlins-rxf38-m3-29-170', cat:'fork', brand:'Öhlins', model:'RXF38 m.3 170', family:'ohlins-rxf38', gen:'m.3', disciplines:['enduro'], price:1534.5, weight:2320, wheel:'29', travel:170, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:200, minRotorF:200, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-rxf38-m-3-air-ttx18-29-44-170', desc:'29/170/44mm offset/15x110/2320g/"Brake dim: 200 mm" (fixed)/$1,534.50 from the fetched ohlins.com RXF38 m.3 product page for this exact SKU (a coil-spring 170mm variant also exists on the same page - not modeled, fork schema has no spring field)' },
  { id:'fk-ohlins-rxf38-m3-29-180', cat:'fork', brand:'Öhlins', model:'RXF38 m.3 180', family:'ohlins-rxf38', gen:'m.3', disciplines:['enduro'], price:1534.5, weight:2320, wheel:'29', travel:180, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:200, minRotorF:200, verified:true, lastChecked:'2026-07-09', source:'https://www.ohlins.com/en-us/mountain-bike/front-forks/am-rxf38-m-3-air-ttx18-29-44-180', desc:'29/180/44mm offset/15x110/2320g/"Brake dim: 200 mm" (fixed)/$1,534.50 from the fetched ohlins.com RXF38 m.3 product page for this exact SKU' },
  ...
  /* --- catalog-forks-breadth-2 (2026-07-09): Bomber Z2 - a NEW model, Marzocchi's lighter 34mm-chassis step-down from the Z1 above, not previously in this catalog. Real sold SKU matrix per the fetched bike.marzocchi.com/products/bomber-z2.json variant list: 29"/120,130,140mm and 27.5"/140,150mm (NOT a full cross-product - same lesson as the Z1 batch above). "Max Rotor Size: 160mm" and "2,043 g" are flat manufacturer-page figures applied across the line, same convention as the Z1/RXF36/Mezzer rows elsewhere in this catalog. Axle "15QRx110" -> Boost110 (same spacing, QR skewer instead of a bolt-thru Maxle - a lever-mechanism difference, not a different hub fitment, so no new vocab value). --- */
  { id:'fk-marzocchi-bomber-z2-29-120', cat:'fork', brand:'Marzocchi', model:'Bomber Z2 120', family:'marzocchi-bomber-z2', disciplines:['trail'], price:529, weight:2043, wheel:'29', travel:120, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://bike.marzocchi.com/products/bomber-z2', desc:'29/120/15QRx110 (Boost110)/1.5in tapered/"Max Rotor Size: 160mm"/2,043g/$529 - all from the fetched bike.marzocchi.com/products/bomber-z2 page + its .json variant list (this exact SKU currently out of stock but real)' },
  { id:'fk-marzocchi-bomber-z2-29-130', cat:'fork', brand:'Marzocchi', model:'Bomber Z2 130', family:'marzocchi-bomber-z2', disciplines:['trail'], price:529, weight:2043, wheel:'29', travel:130, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://bike.marzocchi.com/products/bomber-z2', desc:'29/130 variant, same page-wide interfaces/weight/price as the 120mm sibling' },
  { id:'fk-marzocchi-bomber-z2-29-140', cat:'fork', brand:'Marzocchi', model:'Bomber Z2 140', family:'marzocchi-bomber-z2', disciplines:['trail'], price:529, weight:2043, wheel:'29', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://bike.marzocchi.com/products/bomber-z2', desc:'29/140 variant (in stock per the .json variant list), same page-wide interfaces/weight/price as the 120mm sibling' },
  { id:'fk-marzocchi-bomber-z2-275-140', cat:'fork', brand:'Marzocchi', model:'Bomber Z2 27.5 140', family:'marzocchi-bomber-z2', disciplines:['trail'], price:529, weight:2043, wheel:'275', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://bike.marzocchi.com/products/bomber-z2', desc:'27.5/140 variant, same page-wide interfaces/weight/price as the 29/120 sibling' },
  { id:'fk-marzocchi-bomber-z2-275-150', cat:'fork', brand:'Marzocchi', model:'Bomber Z2 27.5 150', family:'marzocchi-bomber-z2', disciplines:['trail'], price:499, weight:2043, wheel:'275', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:160, verified:true, lastChecked:'2026-07-09', source:'https://bike.marzocchi.com/products/bomber-z2', desc:'27.5/150 variant - its own distinct $499 price per the .json variant list (the longest-travel Z2 config, priced lower than the 120-140mm variants on Marzocchi\'s own page); weight = the same page-wide 2,043g figure' },
  { id:'fk-fox-34-factory-29-140', cat:'fork', brand:'Fox', model:'34 Factory 140', family:'fox-34', modelYear:2025, disciplines:['trail'], price:1099, weight:1780, wheel:'29', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/3074/2025-2027-34mm-user-specifications', lastChecked:'2026-07-09', desc:'CORRECTED maxRotorF 203->230 + minRotorF 180 ADDED (catalog-forks-breadth-2): the fetched tech.ridefox.com "2025 FOX 34 29in 15x110" engineering user-spec sheet (note 12) states "FORK IS DESIGNED TO USE 180-230MM OUTSIDE DIAMETER DISC ROTORS... 180MM INTERNATIONAL BOOST POST MOUNT" - same rotor range as the sibling 36/38 chassis, correcting the too-low 203 sample. Weight stays an unverified sample (the sheet gives no per-travel weight), so this row is not marked verified' },
  ...
  /* --- catalog-forks-breadth-2 (2026-07-09): broadening fork travel/wheel-size coverage across the brands already in the catalog, one session dedicated solely to cat:'fork'. Every row below traces its wheel/travel/axle/steerer/brakeMount/rotor fields to a FETCHED manufacturer page (sram.com model pages; Fox's own tech.ridefox.com engineering "User Spec" sheets - real CAD drawings, downloaded as images and read directly since the spec tables are baked into the JPGs, not page text; Öhlins' own per-SKU product pages, one fetch per exact wheel/travel/offset variant; Hayes/Manitou's page; Marzocchi's Shopify .json variant list). Price/weight stay sample where the source doesn't break them out per travel - always noted per row. DVO (Diamond/Sapphire/Onyx) and EXT Era's full interface set (axle/steerer/rotor) could NOT be sourced this session: dvosuspension.com's product pages serve only an empty-cart JS shell to fetches (matches this catalog's existing un-sourced Onyx SC row) and its tech.dvosuspension.com subdomain states travel ranges but no axle/steerer/rotor; extremeshox.com's Era V2.1 page states only a travel range (130-170mm) with no wheel size, rotor, or weight. Per the "a missing row beats a fabricated one" rule, no new DVO or EXT rows were added - flagging for a session with real browser access (this catalog's Chrome extension has domain-blocked most bike-brand sites before; WebFetch/curl also came up empty here). --- */

  /* RockShox Pike Ultimate C2 (fs-pike-ult-c2, fetched 2026-07-09): the model page confirms travel is 120/130/140mm across BOTH 27.5 and 29in (rotor 180-220, Boost110, tapered, PM, $1,149 flat) - closing the 29/120 and 27.5/120+130 gaps (29/130, 29/140-verified and 27.5/140 already existed). */
  { id:'fk-rockshox-pike-ultimate-29-120', cat:'fork', brand:'RockShox', model:'Pike Ultimate 120', family:'rockshox-pike', gen:'C2', mfgPn:'FS-PIKE-ULT-C2', disciplines:['trail'], price:1149, weight:1830, wheel:'29', travel:120, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:180, source:'https://www.sram.com/en/rockshox/models/fs-pike-ult-c2', lastChecked:'2026-07-09', desc:'sample WEIGHT (fs-pike-ult-c2 states a weight only for the 29/140 config); wheel/travel/axle/steerer/brakeMount/rotor range + $1,149 MSRP confirmed on the fetched sram.com model page (travel options 120/130/140 across both wheel sizes)' },
  { id:'fk-rockshox-pike-ultimate-275-120', cat:'fork', brand:'RockShox', model:'Pike Ultimate 27.5 120', family:'rockshox-pike', gen:'C2', mfgPn:'FS-PIKE-ULT-C2', disciplines:['trail'], price:1149, weight:1800, wheel:'275', travel:120, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:180, source:'https://www.sram.com/en/rockshox/models/fs-pike-ult-c2', lastChecked:'2026-07-09', desc:'sample WEIGHT (mirrors the 29/120 sibling minus the same ~-30g wheel-size delta convention used elsewhere in this catalog); wheel size "27.5" + travel 120 + interfaces + $1,149 MSRP confirmed on the fetched sram.com model page fs-pike-ult-c2' },
  { id:'fk-rockshox-pike-ultimate-275-130', cat:'fork', brand:'RockShox', model:'Pike Ultimate 27.5 130', family:'rockshox-pike', gen:'C2', mfgPn:'FS-PIKE-ULT-C2', disciplines:['trail'], price:1149, weight:1860, wheel:'275', travel:130, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:180, source:'https://www.sram.com/en/rockshox/models/fs-pike-ult-c2', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 275/120 sibling); wheel size "27.5" + travel 130 + interfaces + $1,149 MSRP confirmed on the fetched sram.com model page fs-pike-ult-c2' },

  /* RockShox Lyrik Ultimate D2 (fs-lyrk-ult-d2, fetched 2026-07-09): the model page confirms travel is 140/150/160mm across BOTH 27.5 and 29in (rotor 180-220, Boost110, tapered, PM, $1,199 flat) - closing 29/140, 29/150, 27.5/140, 27.5/150 (29/160-verified and 27.5/160 already existed). */
  { id:'fk-rockshox-lyrik-ultimate-29-140', cat:'fork', brand:'RockShox', model:'Lyrik Ultimate 140', family:'rockshox-lyrik', gen:'D2', mfgPn:'FS-LYRK-ULT-D2', disciplines:['enduro'], price:1199, weight:1950, wheel:'29', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:180, source:'https://www.sram.com/en/rockshox/models/fs-lyrk-ult-d2', lastChecked:'2026-07-09', desc:'sample WEIGHT (fs-lyrk-ult-d2 states a weight only for the 29/160 config); wheel/travel/axle/steerer/brakeMount/rotor range + $1,199 MSRP confirmed on the fetched sram.com model page (travel options 140/150/160 across both wheel sizes)' },
  { id:'fk-rockshox-lyrik-ultimate-29-150', cat:'fork', brand:'RockShox', model:'Lyrik Ultimate 150', family:'rockshox-lyrik', gen:'D2', mfgPn:'FS-LYRK-ULT-D2', disciplines:['enduro'], price:1199, weight:1990, wheel:'29', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:180, source:'https://www.sram.com/en/rockshox/models/fs-lyrk-ult-d2', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 29/140 sibling); wheel/travel/axle/steerer/brakeMount/rotor range + $1,199 MSRP confirmed on the fetched sram.com model page fs-lyrk-ult-d2' },
  { id:'fk-rockshox-lyrik-ultimate-275-140', cat:'fork', brand:'RockShox', model:'Lyrik Ultimate 27.5 140', family:'rockshox-lyrik', gen:'D2', mfgPn:'FS-LYRK-ULT-D2', disciplines:['enduro'], price:1199, weight:1900, wheel:'275', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:180, source:'https://www.sram.com/en/rockshox/models/fs-lyrk-ult-d2', lastChecked:'2026-07-09', desc:'sample WEIGHT (mirrors the 29/140 sibling minus the same wheel-size delta convention used elsewhere in this catalog, e.g. the existing 27.5/160 row); wheel size "27.5" + travel 140 + interfaces + $1,199 MSRP confirmed on the fetched sram.com model page fs-lyrk-ult-d2' },
  { id:'fk-rockshox-lyrik-ultimate-275-150', cat:'fork', brand:'RockShox', model:'Lyrik Ultimate 27.5 150', family:'rockshox-lyrik', gen:'D2', mfgPn:'FS-LYRK-ULT-D2', disciplines:['enduro'], price:1199, weight:1940, wheel:'275', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:180, source:'https://www.sram.com/en/rockshox/models/fs-lyrk-ult-d2', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 275/140 sibling); wheel size "27.5" + travel 150 + interfaces + $1,199 MSRP confirmed on the fetched sram.com model page fs-lyrk-ult-d2' },

  /* RockShox SID Ultimate 3P D1 (fs-sid-ult3-d1, fetched 2026-07-09): the model page confirms travel is 110/120mm, 29in ONLY (rotor 180-220, Boost110, tapered, $1,099 flat) - closing 29/110 (29/120-verified already existed). */
  { id:'fk-rockshox-sid-ultimate-29-110', cat:'fork', brand:'RockShox', model:'SID Ultimate 110', family:'rockshox-sid', gen:'D1', mfgPn:'FS-SID-ULT3-D1', disciplines:['xc'], price:1099, weight:1450, wheel:'29', travel:110, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:180, maxTire:2.6, source:'https://www.sram.com/en/rockshox/models/fs-sid-ult3-d1', lastChecked:'2026-07-09', desc:'sample WEIGHT (fs-sid-ult3-d1 states a weight only for the 120mm crown-adjust config); wheel/travel/axle/steerer/brakeMount/rotor range/max tire + $1,099 MSRP confirmed on the fetched sram.com model page (travel options 110/120, 29in only - no 27.5 SID)' },

  /* RockShox ZEB: the CURRENT sram.com model page (fs-zeb-ult-b1, fetched 2026-07-09) shows travel 150/160/170/180mm across BOTH wheel sizes, but at a materially different price/weight ($1,299 / ~2550g) than this catalog's existing UNTAGGED ZEB rows ($1,099-1,149 / ~2100-2200g, no gen field). That's either a real B1-generation price/weight jump this catalog hasn't caught up to, or the existing rows are simply stale samples - a genuine drift question, not a fork-breadth one, so it's flagged here rather than resolved: the four new rows below stay in the EXISTING (un-gen-tagged) sample tier for internal family consistency rather than mixing an unreconciled B1 price/weight into three rows and leaving four in the old tier. Existence of all four wheel/travel combos is still real (same B1 page). */
  { id:'fk-rockshox-zeb-ultimate-29-150', cat:'fork', brand:'RockShox', model:'ZEB Ultimate 150', family:'rockshox-zeb', disciplines:['enduro'], price:1099, weight:2130, wheel:'29', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:200, desc:'sample specs (mirror 160/170 siblings, same un-gen-tagged tier already in this catalog); 150mm existence confirmed via the fetched sram.com fs-zeb-ult-b1 model page (current ZEB Ultimate travel options: 150/160/170/180mm, both wheel sizes) - see the fork-breadth-2 block comment above re: a B1-vs-legacy price/weight discrepancy this row deliberately does NOT resolve' },
  { id:'fk-rockshox-zeb-ultimate-275-150', cat:'fork', brand:'RockShox', model:'ZEB Ultimate 27.5 150', family:'rockshox-zeb', disciplines:['enduro'], price:1099, weight:2080, wheel:'275', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:200, desc:'sample specs (mirror the 29/150 sibling above minus the wheel-size delta already used for the existing 275/170 row); 27.5/150mm existence confirmed via the fetched sram.com fs-zeb-ult-b1 model page' },
  { id:'fk-rockshox-zeb-ultimate-275-160', cat:'fork', brand:'RockShox', model:'ZEB Ultimate 27.5 160', family:'rockshox-zeb', disciplines:['enduro'], price:1099, weight:2090, wheel:'275', travel:160, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:200, desc:'sample specs (mirror the existing 29/160 row minus the wheel-size delta); 27.5/160mm existence confirmed via the fetched sram.com fs-zeb-ult-b1 model page' },
  { id:'fk-rockshox-zeb-ultimate-275-180', cat:'fork', brand:'RockShox', model:'ZEB Ultimate 27.5 180', family:'rockshox-zeb', disciplines:['enduro'], price:1149, weight:2190, wheel:'275', travel:180, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:220, minRotorF:200, desc:'sample specs (mirror the existing 29/180 row minus the wheel-size delta); 27.5/180mm existence confirmed via the fetched sram.com fs-zeb-ult-b1 model page' },

  /* Fox 34/36/38 Factory: real Fox Factory Inc. engineering "User Spec" drawings, downloaded from tech.ridefox.com/bike/spec-sheets/* (the JPGs themselves, read directly - not the JS-blocked ridefox.com storefront) and read as images since the spec tables are baked into the drawing, fetched 2026-07-09. All three chassis share the identical rotor note ("FORK IS DESIGNED TO USE 180-230MM OUTSIDE DIAMETER DISC ROTORS... 180MM INTERNATIONAL BOOST POST MOUNT") - confirmed on each sheet individually, not assumed across chassis. None of the sheets state a per-travel weight (only axle-to-crown geometry tables), so every new row below stays an unverified sample for weight/price; axle/steerer/brakeMount/maxRotorF/minRotorF are the real sourced fields. */
  /* Fox 34 Factory (2025-2027 34mm sheet): 29in ONLY, travel 120/130/140mm. Closes 120/130 (140 already existed - and is now corrected above). */
  { id:'fk-fox-34-factory-29-120', cat:'fork', brand:'Fox', model:'34 Factory 120', family:'fox-34', modelYear:2025, disciplines:['trail'], price:1099, weight:1730, wheel:'29', travel:120, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/3074/2025-2027-34mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (the "2025 FOX 34 29in 15x110" sheet gives no per-travel weight, only an A/B geometry table for 120/130/140mm forks); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com engineering spec sheet (34mm chassis is 29in-only - no 27.5 variant on this sheet)' },
  { id:'fk-fox-34-factory-29-130', cat:'fork', brand:'Fox', model:'34 Factory 130', family:'fox-34', modelYear:2025, disciplines:['trail'], price:1099, weight:1755, wheel:'29', travel:130, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/3074/2025-2027-34mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 120mm sibling); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com engineering spec sheet' },
  /* Fox 36 Factory (2023-2025 36mm sheet): BOTH 29in and 27.5in, travel 130/140/150/160/170mm - a full wheel-size + travel matrix the catalog previously had only ONE point of (29/160). Closes 29/130,140,150,170 and the entire 27.5in wheel size. */
  { id:'fk-fox-36-factory-29-130', cat:'fork', brand:'Fox', model:'36 Factory 130', family:'fox-36', modelYear:2023, disciplines:['enduro'], price:1099, weight:1900, wheel:'29', travel:130, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/2904/2023-2025-36mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (the "2023 FOX 36 29in 15x110" sheet gives no per-travel weight, only an A geometry table for 130/140/150/160/170mm forks); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com engineering spec sheet' },
  { id:'fk-fox-36-factory-29-140', cat:'fork', brand:'Fox', model:'36 Factory 140', family:'fox-36', modelYear:2023, disciplines:['enduro'], price:1099, weight:1930, wheel:'29', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/2904/2023-2025-36mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 130mm sibling); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com engineering spec sheet' },
  { id:'fk-fox-36-factory-29-150', cat:'fork', brand:'Fox', model:'36 Factory 150', family:'fox-36', modelYear:2023, disciplines:['enduro'], price:1099, weight:1945, wheel:'29', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/2904/2023-2025-36mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 130mm sibling); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com engineering spec sheet' },
  { id:'fk-fox-36-factory-29-170', cat:'fork', brand:'Fox', model:'36 Factory 170', family:'fox-36', modelYear:2023, disciplines:['enduro'], price:1099, weight:1985, wheel:'29', travel:170, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/2904/2023-2025-36mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 130mm sibling); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com engineering spec sheet' },
  { id:'fk-fox-36-factory-275-130', cat:'fork', brand:'Fox', model:'36 Factory 27.5 130', family:'fox-36', modelYear:2023, disciplines:['enduro'], price:1099, weight:1850, wheel:'275', travel:130, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/2904/2023-2025-36mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (mirrors the 29in siblings minus a ~50g wheel-size delta, the same convention already used across this catalog e.g. the ZEB 170 pair); the "2023 FOX 36 27.5in 15x110" sheet confirms wheel/axle/steerer/brakeMount/rotor range for a full 27.5in wheel-size option this catalog\'s Fox 36 previously lacked entirely' },
  { id:'fk-fox-36-factory-275-140', cat:'fork', brand:'Fox', model:'36 Factory 27.5 140', family:'fox-36', modelYear:2023, disciplines:['enduro'], price:1099, weight:1880, wheel:'275', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/2904/2023-2025-36mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 275/130 sibling); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com 27.5in engineering spec sheet' },
  { id:'fk-fox-36-factory-275-150', cat:'fork', brand:'Fox', model:'36 Factory 27.5 150', family:'fox-36', modelYear:2023, disciplines:['enduro'], price:1099, weight:1895, wheel:'275', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/2904/2023-2025-36mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 275/130 sibling); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com 27.5in engineering spec sheet' },
  { id:'fk-fox-36-factory-275-160', cat:'fork', brand:'Fox', model:'36 Factory 27.5 160', family:'fox-36', modelYear:2023, disciplines:['enduro'], price:1099, weight:1910, wheel:'275', travel:160, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/2904/2023-2025-36mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 275/130 sibling); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com 27.5in engineering spec sheet' },
  { id:'fk-fox-36-factory-275-170', cat:'fork', brand:'Fox', model:'36 Factory 27.5 170', family:'fox-36', modelYear:2023, disciplines:['enduro'], price:1099, weight:1935, wheel:'275', travel:170, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/2904/2023-2025-36mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 275/130 sibling); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com 27.5in engineering spec sheet' },
  /* Fox 38 Factory (2021-2026 38mm sheets, both wheel sizes): travel 150/160/170/180mm. The existing 29/160,170,180 rows already carry the correct 230/180 rotor range (no correction needed) - this batch closes 29/150 and the entire 27.5in wheel size. */
  { id:'fk-fox-38-factory-29-150', cat:'fork', brand:'Fox', model:'38 Factory 150', family:'fox-38', disciplines:['enduro'], price:1299, weight:2140, wheel:'29', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/1089/2021-2026-38mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (mirrors the existing verified-interface 160mm sibling; the "2021 FOX 38 29in 15x110QR" sheet gives no per-travel weight, only an A/B geometry table for 150/160/170/180mm forks); wheel/axle/steerer/brakeMount/rotor range (note 15: "180MM DISC BRAKE POST MOUNTS...USE WITH THE 180MM ROTOR. UP TO 230MM...WITH THE PROPER ADAPTER") confirmed on the fetched tech.ridefox.com engineering spec sheet' },
  { id:'fk-fox-38-factory-275-150', cat:'fork', brand:'Fox', model:'38 Factory 27.5 150', family:'fox-38', disciplines:['enduro'], price:1299, weight:2090, wheel:'275', travel:150, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/1089/2021-2026-38mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (mirrors the 29in siblings minus the ~50g wheel-size delta convention used elsewhere in this catalog); the "2021 FOX 38 27.5in 15x110QR" sheet confirms wheel/axle/steerer/brakeMount/rotor range for a full 27.5in wheel-size option this catalog\'s Fox 38 previously lacked entirely' },
  { id:'fk-fox-38-factory-275-160', cat:'fork', brand:'Fox', model:'38 Factory 27.5 160', family:'fox-38', disciplines:['enduro'], price:1299, weight:2110, wheel:'275', travel:160, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/1089/2021-2026-38mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 275/150 sibling); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com 27.5in engineering spec sheet' },
  { id:'fk-fox-38-factory-275-170', cat:'fork', brand:'Fox', model:'38 Factory 27.5 170', family:'fox-38', disciplines:['enduro'], price:1299, weight:2130, wheel:'275', travel:170, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/1089/2021-2026-38mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 275/150 sibling); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com 27.5in engineering spec sheet' },
  { id:'fk-fox-38-factory-275-180', cat:'fork', brand:'Fox', model:'38 Factory 27.5 180', family:'fox-38', disciplines:['enduro'], price:1349, weight:2150, wheel:'275', travel:180, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/1089/2021-2026-38mm-user-specifications', lastChecked:'2026-07-09', desc:'sample WEIGHT (same convention as the 275/150 sibling, priced at the existing 180mm-tier sample like the 29/180 sibling); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com 27.5in engineering spec sheet' },
  /* Fox 36 SL Factory - a NEW model in this catalog: the 2026 successor that replaces the Fox 34 in Fox's lineup (BikeRadar/Singletracks/Bikerumor, 2026-07-09: "the 2026 Fox 36 SL replaces the brand's previous trail fork, the 34"), sold under the "36 Float SL" name at retail (thelostco.com/jensonusa/biketart listings) - this catalog's answer to the "Float SL" target. 29in only, travel 120/130/140mm, per the fetched tech.ridefox.com "2026 Fox 36SL 29in" engineering spec sheet (note 12: same 180-230mm PM rotor range as the 34/36/38). Price $1,149 corroborated across multiple current retailer listings (Fanatik Bike, BikeTiresDirect, Jenson USA, Biketart) for the Factory trim; ridefox.com's own price page did not fetch (JS-rendered), so price is retailer-corroborated rather than a direct manufacturer figure. Weight: press coverage citing Fox's own claim puts 29/140 at 1755g (BikeRadar/Singletracks); used here as the closest thing to a manufacturer figure, other travels sampled around it. */
  { id:'fk-fox-36-sl-factory-29-120', cat:'fork', brand:'Fox', model:'36 SL Factory 120', family:'fox-36-sl', modelYear:2026, disciplines:['trail'], price:1149, weight:1700, wheel:'29', travel:120, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/3120/2026-2027-36sl-user-specifications', lastChecked:'2026-07-09', desc:'sample weight (interpolated below the 140mm press-cited 1755g; the tech.ridefox.com sheet gives no per-travel weight); price retailer-corroborated $1,149 (Fox\'s 2026 successor to the 34 - see the family-level block comment above); wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com "2026 Fox 36SL 29in" engineering spec sheet (travel options 120/130/140, 29in only)' },
  { id:'fk-fox-36-sl-factory-29-130', cat:'fork', brand:'Fox', model:'36 SL Factory 130', family:'fox-36-sl', modelYear:2026, disciplines:['trail'], price:1149, weight:1725, wheel:'29', travel:130, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/3120/2026-2027-36sl-user-specifications', lastChecked:'2026-07-09', desc:'sample weight (same convention as the 120mm sibling); price retailer-corroborated $1,149; wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com engineering spec sheet' },
  { id:'fk-fox-36-sl-factory-29-140', cat:'fork', brand:'Fox', model:'36 SL Factory 140', family:'fox-36-sl', modelYear:2026, disciplines:['trail'], price:1149, weight:1755, wheel:'29', travel:140, axle:'Boost110', steerer:'tapered', brakeMount:'PM', maxRotorF:230, minRotorF:180, source:'https://tech.ridefox.com/bike/spec-sheets/3120/2026-2027-36sl-user-specifications', lastChecked:'2026-07-09', desc:'weight 1755g per BikeRadar/Singletracks press coverage citing Fox\'s own claimed 29x140mm figure (2026-07-09) - the closest available approximation to a manufacturer number, hence not marked verified (not itself a fetched manufacturer page); price retailer-corroborated $1,149; wheel/axle/steerer/brakeMount/rotor range confirmed on the fetched tech.ridefox.com engineering spec sheet' },

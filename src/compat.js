...
var PARTS = [
  ...
  /* --- catalog-frames-breadth-d (2026-07-09): Transition, Evil, Intense frames, every verdict-
     driving field from a FETCHED manufacturer page (transitionbikes.com model spec pages;
     evil-bikes.com model FAQ pages; intensecycles.com Tracer specs page). Shock eye x stroke x
     mount was chosen to match a shock already in-catalog wherever the real spec allowed, so these
     are buildable now - EXCEPT the Evil Following LS, whose real 165x45 trunnion shock has no
     catalog match yet (flagged in its desc for the suspension session). Weights are sample where
     the maker publishes none (noted per row); the Intense Tracer 279 carries a maker-stated weight.
     Pivot + Cannondale were investigated but their spec pages are JS/region/403-walled to WebFetch
     (Pivot's fetchable tech PDFs are setup guides with no interface numbers), so no row was entered
     for them - a missing frame beats an unsourced one. --- */
  { id:'fr-transition-sentinel-carbon', cat:'frame', brand:'Transition', model:'Sentinel Carbon', family:'transition-sentinel', disciplines:['trail'], price:3799, weight:3100, wheelConfigs:['29','mullet'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'ZS44/28.6', headTubeLower:'ZS56/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:223, maxTire:2.5, suspension:'full', shockEye:205, shockStroke:60, shockMount:'trunnion', maxForkTravel:160, travel:150, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://www.transitionbikes.com/Bikes/Sentinel', desc:'VERIFIED 2026-07-09 vs fetched transitionbikes.com Sentinel spec page: 150mm rear (compat 160 via a 205x65 shock) / 160mm fork; shock "205x60mm (compatible with 205x65mm), Trunnion Mount Top / 30x8mm Bottom"; "Transition Axle For UDH, 12x148"; 44/56 Zero Stack head tube (tapered steerer fit); 73mm BSA threaded; 31.6 post; "180mm Post Mount, Max Rotor 223mm"; 29 or MX/mullet (XS is 27.5-only, not modeled); UDH; max tire 29x2.5; $3,799 carbon frameset. weight = sample (Transition publishes no frame weight).' },
  { id:'fr-transition-spire-carbon', cat:'frame', brand:'Transition', model:'Spire Carbon', family:'transition-spire', disciplines:['enduro'], price:3799, weight:3300, wheelConfigs:['29'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'ZS56/28.6', headTubeLower:'ZS56/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:223, maxTire:2.6, suspension:'full', shockEye:205, shockStroke:65, shockMount:'trunnion', maxForkTravel:180, travel:170, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://www.transitionbikes.com/Bikes/Spire', desc:'VERIFIED 2026-07-09 vs fetched transitionbikes.com Spire spec page: 170mm rear (compat 160) / 170mm fork (compat 180 single crown; dual crown on alloy only); shock "205x65mm (compat 205x60mm), Trunnion Top / 30x8mm Bottom"; "Transition Axle For UDH, 12x148"; 56 Zero Stack head tube (tapered steerer fit); 73mm BSA; 31.6 post; "180mm Post Mount, Max Rotor 223mm"; 29 only; UDH; max tire 29x2.6; $3,799 carbon frameset. weight = sample. (fr-transition-spire-alloy is the alloy sibling already in-catalog.)' },
  { id:'fr-transition-patrol-carbon', cat:'frame', brand:'Transition', model:'Patrol Carbon', family:'transition-patrol', disciplines:['enduro'], price:3699, weight:3100, wheelConfigs:['mullet'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'ZS56/28.6', headTubeLower:'ZS56/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:223, maxTire:2.6, suspension:'full', shockEye:205, shockStroke:60, shockMount:'trunnion', maxForkTravel:170, travel:160, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://www.transitionbikes.com/Bikes/Patrol', desc:'VERIFIED 2026-07-09 vs fetched transitionbikes.com Patrol spec page: mullet (29 Front / 27.5 Rear); 160mm rear (compat 170) / 160mm fork (compat 170 single or dual crown); shock "205x60mm (compat 205x65mm), Trunnion Top / 30x8mm Bottom"; 12x148 Transition UDH axle; 56 Zero Stack head tube (tapered steerer fit); 73mm BSA; 31.6 post; "180mm Post Mount, Max Rotor 223mm"; UDH; max tire 27.5x2.6; $3,699 carbon frameset. weight = sample.' },
  { id:'fr-transition-patrol-alloy', cat:'frame', brand:'Transition', model:'Patrol Alloy', family:'transition-patrol', disciplines:['enduro'], price:2499, weight:3900, wheelConfigs:['mullet'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'ZS56/28.6', headTubeLower:'ZS56/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:223, maxTire:2.6, suspension:'full', shockEye:205, shockStroke:60, shockMount:'trunnion', maxForkTravel:170, travel:160, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://www.transitionbikes.com/Bikes/Patrol', desc:'Alloy sibling of fr-transition-patrol-carbon; identical interfaces per the same fetched transitionbikes.com Patrol spec page; $2,499 alloy frameset. weight = sample (alloy runs heavier than carbon).' },
  { id:'fr-transition-spur-carbon', cat:'frame', brand:'Transition', model:'Spur Carbon', family:'transition-spur', disciplines:['xc','trail'], price:3599, weight:2500, wheelConfigs:['29'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'IS42/28.6', headTubeLower:'IS52/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:200, maxTire:2.4, suspension:'full', shockEye:190, shockStroke:45, shockMount:'std', maxForkTravel:130, travel:120, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://www.transitionbikes.com/Bikes/Spur', desc:'VERIFIED 2026-07-09 vs fetched transitionbikes.com Spur spec page: down-country, 120mm rear / 130mm fork; shock "190x45mm, 30x8mm hardware" standard eyelet mount (matches sh-rockshox-sidluxe-ultimate-190x45 / sh-fox-float-sl-factory-190x45); 12x148; IS42/IS52 head tube (tapered steerer fit); 73mm BSA English thread; 31.6 post; "160mm Post Mount, Max Rotor 200mm"; 29 only; UDH; max tire 29x2.4; $3,599 carbon frameset. weight = sample.' },
  { id:'fr-transition-smuggler-carbon', cat:'frame', brand:'Transition', model:'Smuggler Carbon', family:'transition-smuggler', disciplines:['trail'], price:3499, weight:2900, wheelConfigs:['29'], rearAxle:'Boost148', headset:'tapered', headTubeUpper:'IS42/28.6', headTubeLower:'IS52/40', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:203, maxTire:2.4, suspension:'full', shockEye:210, shockStroke:50, shockMount:'std', maxForkTravel:140, travel:130, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://www.transitionbikes.com/Bikes/Smuggler', desc:'VERIFIED 2026-07-09 vs fetched transitionbikes.com Smuggler spec page: 130mm rear / 140mm fork; shock "210x50mm" standard mount (matches sh-rockshox-sidluxe-ultimate-210x50); 12x148 Transition UDH axle; carbon IS42/IS52 head tube (tapered steerer fit; alloy is 44/56 ZS); 73mm BSA; 31.6 post; "180mm Post Mount, Max Rotor 203mm"; 29 F&R; UDH; max tire 29x2.4; $3,499 carbon frameset. weight = sample.' },
  { id:'fr-transition-tr11-alloy', cat:'frame', brand:'Transition', model:'TR11 Alloy', family:'transition-tr11', disciplines:['dh'], price:2599, weight:4000, wheelConfigs:['mullet'], rearAxle:'Boost148', headset:'straight-dc', bb:'BSA83', seatTube:31.6, brakeMount:'PM', maxRotorR:223, suspension:'full', shockEye:225, shockStroke:75, shockMount:'trunnion', maxForkTravel:200, travel:211, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://www.transitionbikes.com/Bikes/TR11', desc:'VERIFIED 2026-07-09 vs fetched transitionbikes.com TR11 spec page: DH, mullet only (29 Front / 27.5 Rear); 211mm rear / 200mm fork; shock stated "RockShox Vivid Ultimate DH (225x75mm)" with "Trunnion Mount Top / 30x8mm Bottom" (matches sh-rockshox-vivid-ultimate-225x75-trun); "Transition 12x148 for SRAM UDH" (a Boost-spaced DH frame, RAAW Yalla V2 precedent); ZS56 head tube running a dual-crown BoxXer Ultimate 200 -> headset straight-dc; 83mm threaded BB; 31.6 post; "200mm Post Mount, Max Rotor 223mm"; UDH; $2,599 alloy frameset. weight + maxTire = sample (frame weight not published; max tire not stated).' },
  { id:'fr-evil-offering-ls', cat:'frame', brand:'Evil', model:'Offering LS', family:'evil-offering', gen:'LS', disciplines:['trail'], price:3799, weight:3000, wheelConfigs:['29'], rearAxle:'SuperBoost157', headset:'tapered', bb:'BSA73', seatTube:30.9, brakeMount:'PM', maxRotorR:203, maxTire:2.6, suspension:'full', shockEye:185, shockStroke:55, shockMount:'trunnion', maxForkTravel:160, travel:141, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://evil-bikes.com/pages/offering-faq', desc:'VERIFIED 2026-07-09 vs fetched evil-bikes.com Offering FAQ: 141mm rear, recommended 150-160mm fork; "185x55mm, Trunnion-mounted upper, 8x20mm lower" shock (matches sh-fox-float-x-perf-elite-185x55-trun / sh-rockshox-super-deluxe-ultimate-185x55-trun); "SuperBoost (12x157mm)" rear; ZS44/ZS62 headset, tapered steerer 1-1/8 to 1-1/2 (ZS62 not in headTube vocab so headTube omitted; headset:tapered captures the steerer fit); threaded BSA 73mm; 30.9 post; "180mm Post Mount" rear, up to 203mm rotor; 29 only; SRAM UDH; max tire 2.6. price $3,799 frame (evil-bikes.com listed MSRP); weight = sample.' },
  { id:'fr-evil-wreckoning-ls', cat:'frame', brand:'Evil', model:'Wreckoning LS', family:'evil-wreckoning', gen:'LS', disciplines:['enduro'], price:3750, weight:3200, wheelConfigs:['29'], rearAxle:'SuperBoost157', headset:'tapered', bb:'BSA73', seatTube:30.9, brakeMount:'PM', maxRotorR:203, maxTire:2.5, suspension:'full', shockEye:205, shockStroke:65, shockMount:'trunnion', maxForkTravel:180, travel:166, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://evil-bikes.com/pages/wreckoning-faq-test', desc:'VERIFIED 2026-07-09 vs fetched evil-bikes.com Wreckoning FAQ: 166mm rear, recommended 170-180mm fork (44mm offset); "205x65mm Metric Trunnion" shock, 8x20mm lower (matches sh-rockshox-super-deluxe-205x65-trun etc.); "SuperBoost (12x157mm)" rear; ZS44/ZS62 headset, tapered steerer (headTube omitted, ZS62 not in vocab); threaded BSA 73mm; 30.9 post; "180mm Post Mount" rear, 203mm max rotor; 29 only; SRAM UDH; max tire 2.5. price $3,750 frame (evil-bikes.com listed MSRP); weight = sample.' },
  { id:'fr-evil-following-ls', cat:'frame', brand:'Evil', model:'Following LS', family:'evil-following', gen:'LS', disciplines:['xc','trail'], price:3799, weight:2800, wheelConfigs:['29'], rearAxle:'SuperBoost157', headset:'tapered', bb:'BSA73', seatTube:30.9, brakeMount:'PM', maxRotorR:203, maxTire:2.6, suspension:'full', shockEye:165, shockStroke:45, shockMount:'trunnion', maxForkTravel:130, travel:121, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://evil-bikes.com/pages/following-faq', desc:'VERIFIED 2026-07-09 vs fetched evil-bikes.com Following FAQ: 121mm rear, recommended 120-130mm fork; "165x45mm Trunnion-mount" shock - NO matching shock row exists in-catalog yet (closest is 185x55 trunnion), so this frame is NOT buildable until a 165x45 trunnion shock is added - FLAGGED for the suspension session. "SuperBoost (12x157mm)" rear; ZS44/ZS62 headset, tapered steerer (headTube omitted, ZS62 not in vocab); threaded BSA 73mm; 30.9 post; "180mm Post Mount" rear, 203mm max rotor; 29 only; SRAM UDH; max tire 2.6. price $3,799 frame (evil-bikes.com listed MSRP); weight = sample.' },
  { id:'fr-evil-insurgent-ls', cat:'frame', brand:'Evil', model:'Insurgent LS', family:'evil-insurgent', gen:'LS', disciplines:['enduro'], price:3799, weight:3300, wheelConfigs:['mullet'], rearAxle:'SuperBoost157', headset:'tapered', bb:'BSA73', seatTube:30.9, brakeMount:'PM', maxRotorR:203, maxTire:2.6, suspension:'full', shockEye:205, shockStroke:65, shockMount:'trunnion', maxForkTravel:170, travel:168, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://evil-bikes.com/pages/insurgent-faq', desc:'VERIFIED 2026-07-09 vs fetched evil-bikes.com Insurgent FAQ: mullet (29 front / 27.5 rear), 168mm rear, "170mm 29 or 180mm 27.5 fork" (maxForkTravel 170 for the 29-front mullet config; a full-27.5 setup with a 180 fork is also mentioned but not modeled, to avoid a false verdict); "205x65mm Trunnion" shock, 8x20mm lower (matches sh-rockshox-super-deluxe-205x65-trun etc.); "SuperBoost (12x157mm)" rear; ZS44/ZS62 headset, tapered steerer (headTube omitted); threaded BSA 73mm; 30.9 post; "180mm Post Mount" rear, 203mm max rotor; SRAM UDH; max tire 27.5x2.6. price $3,799 frame (evil-bikes.com listed MSRP); weight = sample.' },
  { id:'fr-intense-tracer-279', cat:'frame', brand:'Intense', model:'Tracer 279', family:'intense-tracer', disciplines:['enduro'], price:2999, weight:3170, wheelConfigs:['29','mullet'], rearAxle:'Boost148', headset:'tapered', bb:'BSA73', seatTube:31.6, brakeMount:'PM', maxRotorR:203, maxTire:2.5, suspension:'full', shockEye:205, shockStroke:65, shockMount:'trunnion', maxForkTravel:170, travel:170, udh:true, bundledShock:null, frameOnly:true, verified:true, lastChecked:'2026-07-09', source:'https://intensecycles.com/pages/tracer-279-specifications-and-capabilities', desc:'VERIFIED 2026-07-09 vs fetched intensecycles.com Tracer 279 Specifications and Capabilities page: 170mm rear / 170mm fork (single crown only); shock "205x65mm Trunnion" (matches sh-fox-float-x2-205x65-trun etc.); "148x12 Boost" rear (the current Tracer moved off SuperBoost); ZS49/ZS56 headset, tapered steerer (headTube omitted, ZS49 not in vocab); BSA 73mm; 31.6 post; Post Mount / Direct, up to 203mm rotor (with adapter); runs BOTH 29 and 279/mullet (the shared "Tracer 279 AND 29" geometry chart confirms one convertible frame); UDH + T-Type; max tire 2.5; frame weight MAKER-STATED "3.17kg (S)" (L/XL 3.34kg) -> 3170g entered; $2,999 frameset.' },

...
var KIT_PARTS = [
  ...
  { id:'jsy-ion-scrub-amp', cat:'jersey', brand:'ION', model:'Scrub AMP LS', price:70, weight:180,
    sleeve:'long', sizes:['S','M','L','XL','XXL'],
    desc:'ATTEMPTED 2026-07-18: ion-products.com sells Scrub Amp across many concurrent SKU generations (BAT/non-BAT/Mesh_ine/2022/2023 variants, prices $59.95-$94.99 by variant) with no single current listing cleanly matching this row\'s $70 sample - left unverified rather than guess a variant.' },
  ...
  { id:'jsy-looseriders-cs', cat:'jersey', brand:'Loose Riders', model:'C/S Jersey', price:55, weight:145,
    sleeve:'short', sizes:['S','M','L','XL','XXL'],
    desc:'ATTEMPTED 2026-07-18: loose-riders.com (German brand) is a EUR-native store; its "USD" price display is an odd auto-converted figure (e.g. "48,02 USD"), not a genuine US MSRP, and the current short-sleeve collection is colorway-named (Electric Blue, Phase Black, etc.) with no "C/S" (Cult of Shred) product found. Same EUR-only situation as TSG/Northwave/Madison - policy pending with Douglas per the kit-verify-fanout brief. Left unverified.' },
  ...
  { id:'sht-looseriders-cs', cat:'shorts', brand:'Loose Riders', model:'C/S Shorts', price:100, weight:290,
    liner:false, disciplines:['trail','enduro'], sizes:['S','M','L','XL','XXL'],
    desc:'"Cult of Shred" short: three sealed-zip water-resistant pockets, embedded-vinyl waistband grip. ATTEMPTED 2026-07-18: same EUR-only situation as jsy-looseriders-cs (loose-riders.com, policy pending with Douglas). Left unverified.' },

...
var KIT_PARTS = [
  ...
  { id:'ewr-scott-shield', cat:'eyewear', brand:'Scott', model:'Shield', price:140, weight:28,
    type:'glasses', sizes:['OSFA'],
    desc:'UNVERIFIED (2026-07-17): Scott sells 3 Shield tiers on scott-sports.com US - Sport Shield ($89.99, 32g), Pro Shield ($109.99, 36g), Shield Compact - but no plain "Shield" US product page exists, so this row\'s exact tier/price can\'t be confirmed without guessing. Left as an unverified sample rather than force-matching a tier.' },

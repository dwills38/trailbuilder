...
var KIT_PARTS = [
  ...
  { id:'hm-lazer-coyote-kineticore', cat:'helmet', brand:'Lazer', model:'Coyote KinetiCore', price:150, weight:340,
    ...
    desc:'Weight/type/KinetiCore rotational-EPS design confirmed on lazersport.com; US price page 404’d, price is an unverified street estimate. KinetiCore is Lazer’s own EPS design, not MIPS. token-law-fix (2026-07-23): RE-FETCHED lazersport.com/global/helmets/off-road/coyote-kineticore via the browser pane - this is a CURRENT product (full spec/"FIND MY DEALER" page, no archived/discontinued marking) - priceBasis CORRECTED discontinued-no-msrp->third-party-listed (the honest token: current product, maker publishes no USD price, stored figure is the pre-existing disclosed street estimate). No status change (was already absent = current).',
    verified:true, priceBasis:'third-party-listed', lastChecked:'2026-07-23', source:'https://www.lazersport.com/global/helmets/off-road/coyote-kineticore' },
  { id:'hm-lazer-impala-kineticore', cat:'helmet', brand:'Lazer', model:'Impala KinetiCore', price:130, weight:370,
    type:'half-shell', disciplines:['trail'], sizes:['S','M','L'],
    desc:'Open-face; weight/type confirmed on lazersport.com; US price page 404’d, price is an unverified street estimate. Includes RECCO Rescue Technology. KinetiCore is not MIPS. token-law-fix (2026-07-23): RE-FETCHED lazersport.com/global/helmets/off-road/impala-kineticore via the browser pane - this is a CURRENT product (full spec/"FIND MY DEALER" page, no archived/discontinued marking) - priceBasis CORRECTED discontinued-no-msrp->third-party-listed (the honest token: current product, maker publishes no USD price, stored figure is the pre-existing disclosed street estimate). No status change (was already absent = current).',
    verified:true, priceBasis:'third-party-listed', lastChecked:'2026-07-23', source:'https://www.lazersport.com/global/helmets/off-road/impala-kineticore' },
  ...
  { id:'hm-kask-valegro', cat:'helmet', brand:'Kask', model:'Valegro', price:250,
    ...
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.kask.com/en-us/Cycling/MTB', sourceType:'manufacturer' },
  { id:'hm-6d-atb-1t', cat:'helmet', brand:'6D', model:'ATB-1T', price:124.99, weight:460,
    type:'convertible', disciplines:['trail','enduro'], verified:true, lastChecked:'2026-07-23',
    priceBasis:'msrp-confirmed', source:'https://www.6dhelmets.com/products/atb-1t',
    desc:'3/4-shell trail/enduro helmet with 6D\'s ODS (Omni-Directional Suspension) liner; reviewed as effectively "two helmets in one" via its coverage/venting tradeoff, catalogued as convertible-type. RE-CHECKED 2026-07-23 via Exa fetch of 6dhelmets.com (WebFetch 429s all session): $124.99 regular US price (currently discounted to $99.99, MSRP used per policy) and the maker\'s own nominal "+/- 460g (size M/L)" weight spec, both corrected from the prior press-sourced sample figures ($269.95/501g).' },
  { id:'hm-6d-atb-2t', cat:'helmet', brand:'6D', model:'ATB-2T Ascent', price:199.95, weight:460,
    type:'half-shell', disciplines:['trail','enduro'], verified:true, lastChecked:'2026-07-23',
    priceBasis:'msrp-confirmed', source:'https://www.6dhelmets.com/products/atb-2t',
    desc:'Open-face trail/enduro half-shell, 6D\'s 4th-gen ODS suspension liner. RE-CHECKED 2026-07-23 via Exa fetch of 6dhelmets.com (WebFetch 429s all session): $199.95 regular US price (currently discounted to $149.99, MSRP used per policy) and the maker\'s own nominal "+/- 460g (size M/L)" weight spec, both corrected from the prior press-sourced sample figures ($229.95/475g).' },
  { id:'hm-6d-alterra', cat:'helmet', brand:'6D', model:'Alterra', price:435, weight:710,
    type:'full-face', disciplines:['enduro','dh'], verified:true, lastChecked:'2026-07-23',
    priceBasis:'msrp-confirmed', source:'https://www.6dhelmets.com/products/alterra',
    desc:'Lightweight pedal-friendly full-face with in-molded carbon fiber chin bar and internal roll cage, 6D\'s ODS suspension liner. RE-CHECKED 2026-07-23 via Exa fetch of 6dhelmets.com (WebFetch 429s all session): $435 US price and the maker-stated "710g (M/L)" weight, both corrected from the prior press-sourced sample figures ($395/719g).' },
  { id:'hm-limar-alben-mips', cat:'helmet', brand:'Limar', model:'Alben + MIPS', price:141, weight:230,
    ...
    desc:'22-vent lightweight in-mold shell, all-mountain/XC positioning. RE-CHECKED 2026-07-23: limar.com/products/alben-mips (EN/US store) now redirects to the homepage - only limar.com/it/products/alben-mips (Italian store, MIPS Class A padding, EUR-only) is live, and its weight table did not surface in the fetch. Cannot confirm a current US SKU/weight. Left unverified, no fields changed.' },
  { id:'hm-limar-air-atlas-mips', cat:'helmet', brand:'Limar', model:'Air Atlas + MIPS', price:340, weight:260,
    type:'half-shell', rotational:'mips', disciplines:['xc'], verified:true, lastChecked:'2026-07-23',
    priceBasis:'regional-conversion', source:'https://limar.com/products/air-atlas-mips',
    desc:'Road/XC-crossover half-shell, MIPS AIR NODE padding, Air Fit Evo retention. Positioned by Limar as road-first but a real half-shell bike helmet (not e-bike/motor gear), included per the brand\'s XC-adjacent lineup. RE-CHECKED 2026-07-23 via limar.com (EUR-only store, no USD price shown): maker lists EUR 297.49 regular price and per-size weights S 220g/M 235g/L 260g - the prior 303g sample did not match any published size and is corrected to the L-size (largest) figure. USD price is a disclosed conversion at EUR/USD 1.1418 (xe.com, 2026-07-23) = $339.68, rounded to $340.' },
  { id:'hm-limar-livigno-mips', cat:'helmet', brand:'Limar', model:'Livigno + MIPS', price:249.95, weight:590,
    type:'full-face', rotational:'mips', disciplines:['enduro','dh'], verified:true, lastChecked:'2026-07-23',
    priceBasis:'third-party-listed', source:'https://limar.com/products/livigno-mips',
    desc:'Lightweight full-face rated for DH racing use, MIPS Air Node liner. RE-CHECKED 2026-07-23 via limar.com (EUR-only store, no USD price shown; weight table read directly off the fetched page): maker states "M (590g), L (640g)" - matches the catalog\'s 590g (size M) exactly. Price ($249.95) is Pinkbike\'s 2024-06-04 review-stated US MSRP ("Price: $249.95 USD"), not read off the EUR-only maker page, so it is third-party-listed rather than msrp-confirmed.' },
  { id:'hm-bern-hendrix-mips', cat:'helmet', brand:'Bern', model:'Hendrix MIPS', price:119, weight:400,
    type:'half-shell', rotational:'mips', verified:true, lastChecked:'2026-07-23', priceBasis:'msrp-confirmed',
    source:'https://bernhelmets.com/products/hendrix-bike-helmet',
    desc:'ThinShell/Ribtech EPS half-shell, MIPS-equipped; Bern\'s own copy positions it for "commuters, recreational cyclists, and trail riders". Deliberately left without a disciplines tag (not an MTB-specific gravity helmet - see the batch header note). RE-CHECKED 2026-07-23 via bernhelmets.com (Exa fetch; WebFetch 429s all session): $119.00 US price and "Average Weight: 400g" both read directly off the current product page - weight already matched the catalog, price corrected down from the $149.95 sample.' },
  { id:'hm-bern-major-mips', cat:'helmet', brand:'Bern', model:'Major MIPS', price:65, weight:320,
    type:'half-shell', rotational:'mips', verified:true, lastChecked:'2026-07-23', priceBasis:'msrp-confirmed',
    source:'https://bernhelmets.com/products/major',
    desc:'Bern\'s most-ventilated urban half-shell (14 vents), Virginia Tech 5-star rated, MIPS-equipped. No disciplines tag (urban/commuter positioning, not MTB-specific - see batch header note). RE-CHECKED 2026-07-23 via bernhelmets.com (Exa fetch; WebFetch 429s all session): the current MIPS SKU is listed as "Major MIPS Bike Helmet (Barn Deal)" at $65.00 with "Average Weight: 320g", both read directly off the page - berneurope.com states a differing 360g for the MIPS version, but the primary bernhelmets.com page for this exact MIPS SKU states 320g, so that figure is used.' },
  { id:'hm-bern-hudson-mips', cat:'helmet', brand:'Bern', model:'Hudson MIPS', price:159, weight:370,
    type:'half-shell', rotational:'mips', verified:true, lastChecked:'2026-07-23', priceBasis:'msrp-confirmed',
    source:'https://bernhelmets.com/products/hudson',
    desc:'E-bike/commuter-rated half-shell (up to 27mph), 13 vents, integrated LED light mount, MIPS-equipped. No disciplines tag (commuter positioning). RE-CHECKED 2026-07-23 via bernhelmets.com (Exa fetch; WebFetch 429s all session): $159.00 US price and "Average Weight: 370g" both read directly off the current product page - weight already matched the catalog, price corrected up from the $139.99 sample.' },
  ...
  { id:'sho-fizik-terra-x5', cat:'shoes', brand:'Fizik', model:'Terra X5', price:149.95, weight:576,
    ...
    desc:'Boa L6 Dial B + Slipstream lace guides, 25mm microfiber/velcro strap, nylon-reinforced sole. Weight per pair from a BikeRadar-measured 288g/shoe (size 42). RE-CHECKED 2026-07-23: multiple independent US retailers (American Cyclery, Spokengear, Mechanic Cycling) all list $149.99, corroborating the catalog\'s $149.95 sample, but a direct fizik.com fetch 404\'d/errored every attempt - still not read off the maker\'s own page. Left unverified, no fields changed.' },
  { id:'sho-fizik-terra-ergolace-x2-flat', cat:'shoes', brand:'Fizik', model:'Terra Ergolace X2 Flat', price:149.99, weight:606,
    soleType:'flat', closure:'lace', disciplines:['trail','enduro'], verified:true, lastChecked:'2026-07-23',
    priceBasis:'msrp-confirmed', source:'https://www.fizik.com/en-us/products/shoes-terra-ergolace-x2-flat-black_black-tex2etf1k1010',
    desc:'Lace-up flat-pedal walkable trail shoe. RE-CHECKED 2026-07-23 via fizik.com (en-us): $149.99 regular US price (currently discounted to $112.49) and "Weight: 303 g" per-shoe read directly off the fetched maker product page, doubled to 606g/pair per the catalog\'s pair-weight convention - corrected from the prior 129.99/646g sample.' },
  { id:'sho-fizik-terra-ergolace-x2', cat:'shoes', brand:'Fizik', model:'Terra Ergolace X2', price:149.99, weight:658,
    soleType:'clipless', closure:'lace', disciplines:['trail','enduro'], verified:true, lastChecked:'2026-07-23',
    priceBasis:'msrp-confirmed', source:'https://www.fizik.com/en-us/products/shoes-terra-ergolace-x2-kh-black_black-tex2etr1k1010',
    desc:'2-bolt clipless sibling of the Ergolace X2 Flat (sho-fizik-terra-ergolace-x2-flat), same lace-up upper on a clipless-specific sole. RE-CHECKED 2026-07-23 via fizik.com (en-us): $149.99 regular US price (currently discounted to $112.49) and "Weight: 329 g" per-shoe read directly off the fetched maker product page, doubled to 658g/pair per the catalog\'s pair-weight convention - corrected from the prior 129/no-weight sample.' },
  ...
  { id:'pnt-looseriders-cs-casual', cat:'pants', brand:'Loose Riders', model:'C/S Casual Pant', price:137.76,
    liner:false, disciplines:['trail'], sizes:['28','30','32','34','36','38'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', sourceType:'manufacturer',
    source:'https://www.loose-riders.com/en/men/technical/pants-o-shorts/cos-casual-black~10204/',
    desc:'Fetched loose-riders.com (own store, USD storefront): "C/S Casual Black", $137.76 USD, sizes 28-38. Chino-styled MTB pant on the C/S Evo platform - ratchet closure, DWR, knee panel for pad compatibility. No weight published on the fetched page, omitted rather than guessed.' },
  ...
  { id:'pnt-zoic-edge', cat:'pants', brand:'ZOIC', model:'Edge Pant', price:110,
    ...
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', sourceType:'manufacturer',
    source:'https://zoic.com/products/edge-pant',
    desc:'Fetched zoic.com via the browser pane: "Edge Pants", $110.00 USD, sizes 30-40. 4-way stretch trail/commute pant. No weight published on the fetched page, omitted rather than guessed.' },
  { id:'pnt-monsroyale-diversion', cat:'pants', brand:'Mons Royale', model:'Diversion Merino Trail Pants', price:219.95,
    liner:false, disciplines:['trail','enduro'], sizes:['S','M','L','XL','XXL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', sourceType:'manufacturer',
    source:'https://monsroyale.com/products/diversion-merino-trail-pants-black-mens',
    desc:'Fetched monsroyale.com via the browser pane: "Diversion Merino Trail Pants", $219.95 USD, sizes S-XXL. Merino-nylon blend, articulated for knee pads underneath. No weight published on the fetched page, omitted rather than guessed.' },
  { id:'pnt-yeticycles-ridgway', cat:'pants', brand:'Yeti Cycles', model:'Ridgway Pant', price:170,
    liner:false, disciplines:['trail'], sizes:['SM','MD','LG','XL','XXL','MD-LNG','LG-LNG','XL-LNG'],
    verified:true, priceBasis:'third-party-listed', lastChecked:'2026-07-23',
    source:'https://www.goldenbikeshop.com/product/yeti-cycles-ridgway-pant-455400-1.htm',
    desc:'yeticycles.com (fetched https://yeticycles.com/en-us/gear/detail/ridgway-pant) confirms the product and sizes SM-XXL/long but publishes no price. $170.00 USD list price confirmed as the converging figure across two independent retailers (Golden Bike Shop, ProBikeSupply), both showing it struck through against an $85 sale price - third-party-listed. No weight published anywhere found, omitted rather than guessed.' },
  ...
  { id:'glv-chromag-tact', cat:'gloves', brand:'Chromag', model:'Tact Glove', price:40,
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://us.chromagbikes.com/collections/gloves',
    desc:'Confirmed off us.chromagbikes.com\'s Gloves collection listing (Exa-rendered): $40.00 USD, exact match to the existing sample. No weight found on the storefront this pass.' },
  ...
  { id:'knp-gform-pro-rugged-2', cat:'kneepad', brand:'G-Form', model:'Pro-Rugged 2 MTB Knee/Shin Guard', price:139.99,
  ...
  { id:'knp-amplifi-mkx', cat:'kneepad', brand:'Amplifi', model:'MKX Knee', price:102.46, weight:260,
    ...
    desc:'Strain-rate-sensitive silicone MKX material (flexible until impact, then stiffens), slip-on sleeve, no hard shell. Confirmed off amplifisports.com/en (Exa-rendered) - the maker publishes no US-dollar storefront, only the EUR list price EUR89.99 (a concurrent -49% sale to EUR45.99 was NOT used - list price is the MSRP basis); converted at EUR/USD 1.1386, xe.com, 2026-07-24. Weight (260g, size L) stays the pre-existing review-measured pair figure (not restated on the maker page).' },
  ...
  { id:'elp-oneal-dirt', cat:'elbowpad', brand:'O\'Neal', model:'Dirt Elbow Guard', price:49.99, mfgPn:'0277-823',
    disciplines:['trail'], sizes:['M','L','XL'],
    desc:'The budget sibling in O\'Neal\'s current 4-SKU US Elbow Guards collection (alongside Flow above and a youth-only Dirt, skipped per the adult-only fence) - own SKU code (0277-823 vs Flow\'s 0259-103), same IPX soft-gel/Lycra construction reused in the marketing copy but sold at a different price point. Fetched oneal.com product page: $49.99 confirmed. No cert standard stated on the page. No weight published. Added kit-breadth-6.',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-22', source:'https://oneal.com/products/dirt-elbow-guard' },
  { id:'elp-oneal-redeema', cat:'elbowpad', brand:'O\'Neal', model:'Redeema Elbow Guard', price:79.99, mfgPn:'0251-734',
    disciplines:['trail','enduro'], sizes:['S','M','L','XL'],
  ...
  { id:'elp-amplifi-mkx', cat:'elbowpad', brand:'Amplifi', model:'MKX Elbow', price:86.53,
    ...
    desc:'Strain-rate-sensitive silicone MKX material, slip-on sleeve, no hard shell - elbow counterpart to the MKX Knee (knp-amplifi-mkx). Confirmed off amplifisports.com/en (Exa-rendered) - EUR75.99 list price (a concurrent -22% sale to EUR59.99 was NOT used); converted at EUR/USD 1.1386, xe.com, 2026-07-24. Still no per-pair weight published, left unset.' },
  { id:'elp-amplifi-salvo', cat:'elbowpad', brand:'Amplifi', model:'Salvo Elbow', price:78, weight:320,
    disciplines:['trail','enduro'], sizes:['S','M','L','XL'],
    desc:'Reinforced-panel sleeve, 3D-molded SAS-TEC protector, flex-zone venting. Weight is a retailer-listed pair figure. CHECKED (2026-07-24): the adult "Salvo Elbow" no longer appears in amplifisports.com/en\'s current elbow lineup (Elbow Sleeve, MKX Elbow, AEGI:S Elbow) - only a kids\' "Polymer Grom Elbow" referencing a "Salvo Polymer Elbow design" remains, and only third-party retailers (Blue Tomato, Bike Academy, etc.) still list it. Left unverified sample rather than guessing it maps to a current SKU.' },
  ...
  { id:'elp-dakine-slayer', cat:'elbowpad', brand:'Dakine', model:'Slayer Bike Elbow Pad', price:90,
    disciplines:['trail','enduro'], sizes:['XXS','XS','S','M','L','XL'],
    desc:'kit-cross-category-1 (2026-07-24): Dakine had ZERO elbowpad rows despite Slayer being Dakine\'s flagship protection line (kneepad already cataloged) -- confirmed gap. Dual-density DK Impact foam, Cordura outer, sold in pairs. Maker states "CE certified to EU 2016/425 (CRITT protocol VTT-007)" -- CRITT VTT-007 is a real French/EU MTB-specific protocol but is NOT one of this catalog\'s cataloged protectionCert tokens (en1621-1-l1/l2), so `certs` is deliberately left unset rather than force-mapped to a different standard (flagged in the worker report as a possible future vocab addition). No weight published on the fetched page.',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://www.dakine.com/products/slayer-elbow-pad-s20' },
  ...
  { id:'arm-troyleedesigns-rockfight', cat:'bodyarmor', brand:'Troy Lee Designs', model:'Rockfight Chest Protector', price:135,
    coverage:'chest-back', disciplines:['trail','enduro'], sizes:['XS/SM','MD/LG','XL/2X'],
    desc:'The non-CE, lighter sibling of the Rockfight CE row above - EPP foam at chest+spine, no hard-shell stone plate, unrestricted-airflow cutouts. Fetched troyleedesigns.com product page: $135.00 USD confirmed, sizes matching the CE variant. No CE/EN standard stated on this (non-CE-suffixed) page, so no `certs` token. No weight published. Added kit-breadth-6.',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-22', source:'https://troyleedesigns.com/products/rockfight-chest-protector-black' },
  { id:'arm-troyleedesigns-upl7855hw', cat:'bodyarmor', brand:'Troy Lee Designs', model:'UPL 7855 HW Upper Body Armor', price:218,
    coverage:'chest-back', disciplines:['enduro','dh'], sizes:['S','M','L','XL'],
    desc:'A full upper-body armor SHIRT (not a vest) with removable protective pieces at the arms, chest, rib cage, abdomen, and back - broader coverage than this schema\'s "chest-back" vocab captures, noted here since no arms/abdomen token exists. Fetched troyleedesigns.com product page: MSRP $218.00 USD confirmed (currently on sale at $130.80, sale price not used per pricing policy). No CE/EN standard stated on the page. No weight published. Added kit-breadth-6.',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-22', source:'https://troyleedesigns.com/products/7855-protective-ls-shirt-black' },
  ...
  { id:'arm-100-tarka-long-sleeve', cat:'bodyarmor', brand:'100%', model:'Tarka Long Sleeve', price:249,
    coverage:'chest-back', certs:['en1621-2-l2','en1621-3'], disciplines:['enduro','dh'], sizes:['S','M','L','XL','2XL'],
    desc:'DIRECT-FETCH CORRECTION FLAG for the coordinator: the Tarka Vest row above was marked discontinued 2026-07-19 off a zero-result 100percent.com SITE SEARCH; a direct kit-breadth-6 fetch of this SKU\'s own product page (2026-07-22) shows it live and purchasable ("Add to cart", not out-of-stock/sold-out) with a real SKU (70010-00001) - the site-search null result looks like a stale/broken index rather than a real discontinuation, but this worker did not re-touch the Vest row (out of scope for a breadth-add pass; flagging for reconciliation). Coverage extends to shoulders+forearms beyond this schema\'s chest-back vocab (noted, not encodable). SmartShock chest EN1621-3 Level 1, elbow/shoulder EN1621-1:2014 Level 2 (limb standard, no bodyarmor token), back EN1621-2:2014 Level 2 - both bodyarmor-tier standards entered. MSRP $249.00 confirmed (currently marked "Final Sale" at $74.70, sale price not used per pricing policy). No weight published.',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-22', source:'https://www.100percent.com/products/tarka-long-sleeve-black' },
  { id:'arm-100-tarka-short-sleeve', cat:'bodyarmor', brand:'100%', model:'Tarka Short Sleeve', price:199,
    coverage:'chest-back', certs:['en1621-2-l2','en1621-3'], disciplines:['enduro','dh'], sizes:['S','M','L','XL','2XL'],
  ...
  { id:'arm-dakine-dkimpact-spine', cat:'bodyarmor', brand:'Dakine', model:'DK Impact Spine Protector', price:60,
    coverage:'back',
    desc:'kit-cross-category-1 (2026-07-24): Dakine had ZERO bodyarmor rows -- confirmed gap. Add-on back/spine insert designed to fit inside Dakine hydration packs; maker page states "CE EN 1621-2 certification" with no L1/L2 level given, so `certs` is deliberately left unset rather than guessing a tier. Not currently listed on Dakine\'s main Bike Protection collection page (dakine.com/collections/bike-protection, which shows only knee/elbow pads) but the standalone product page is live and purchasable, so entered as a current (not discontinued) row. No sizes/weight published on the fetched page.',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://www.dakine.com/products/dk-impact-spine-protector' },
  ...
  { id:'shg-oneal-proiv-kneeshin', cat:'shinguard', brand:"O'Neal", model:'Pro IV Knee Guard', price:84.99, mfgPn:'0251-202',
    disciplines:['enduro','dh'],
    desc:'kit-cross-category-1 (2026-07-24): O\'Neal had ZERO shinguard rows -- confirmed gap. Combo knee/shin/thigh protector, sold as a pair, double-pivot design, CE certified to EN 1621-1 per maker copy ("Certified protection: The knee guard is CE certified according to EN 1621-1") -- the page states no L1/L2 level, so `certs` is left unset rather than guessing a tier. This is O\'Neal\'s general protection line (shared with its motocross catalog, described on-page as fitting "under your MX pants") rather than a bike-only SKU -- same moto-crossover convention already used elsewhere in this category for EVS Sports/Fly Racing/Answer rows. SKU 0251-202. Fetched live from oneal.com.',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://oneal.com/products/pro-iv-knee-guard-black' },
  { id:'shg-bluegrass-bighorn', cat:'shinguard', brand:'Bluegrass', model:'Big Horn Knee/Shin Pad', price:60, mfgPn:'3PP003CE00M20',
    disciplines:['enduro','dh'],
    desc:'kit-cross-category-1 (2026-07-24): Bluegrass had ZERO shinguard rows -- confirmed gap. Rigid-shell knee/shin pad from Bluegrass\'s Gravity protection line. Ref 3PP003CE00M20 ("CE00" segment implies a CE marking, but no explicit EN 1621-1 level is stated on the fetched page, so `certs` is left unset). Sizes XS-L. Price is the site\'s own listed EUR figure (€60, no US-store price found) taken at par as an unverified sample.',
    sizes:['XS','S','M','L'] },
  ...
  { id:'ewr-salice-016rw', cat:'eyewear', brand:'Salice', model:'016 RW', price:136, weight:26,
    type:'glasses', sizes:['OSFA'],
    desc:'Kit-6 (2026-07-20): confirmed the 016 model is CURRENT on salice.co.uk (Salice\'s official UK/US-priced site, browser pane) -- standard "SALICE 016 SUNGLASSES MIRROR LENS" runs $137 across all colorways (polarised $192, light-adaptive $172 tiers also exist). The site categorizes by lens-color name rather than the "RW" designation retailers use; could not confirm "RW" maps to a specific one of those colorways, but the base 016 mirror-lens price ($137) is a solid floor for this row. Price corrected from a stale $70 sample. PRICE-BASIS-LOCALE-1 (2026-07-24): flagged for citing a .co.uk source under msrp-confirmed. RE-FETCHED salice.co.uk/collections/016 directly (browser pane): confirms this is NOT Salice\'s own manufacturer site — the page footer reads "Salice UK Manbi Active Brands Ltd", a UK-based THIRD-PARTY distributor/retailer trading as "Salice UK", not Salice (the Italian eyewear maker) itself. So msrp-confirmed was wrong regardless of the $ currency shown - "the maker\'s own US MSRP" requires the MAKER\'s page, and this is a reseller\'s storefront. Relabeled to third-party-listed. Also re-priced while here: the mirror-lens tier now lists at $136.00 (was $137 at the 2026-07-20 check, a $1 drift) - updated to the current live figure.',
    verified:true, priceBasis:'third-party-listed', lastChecked:'2026-07-24', source:'https://www.salice.co.uk/collections/016' },
  ...
  { id:'ewr-roka-cp1x', cat:'eyewear', brand:'Roka', model:'CP-1x', price:240,
    type:'glasses',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://www.roka.com/products/cp-1x',
    desc:'Full-frame shield sunglasses (catalog previously described it "semi-rimless" - roka.com\'s own copy calls it a "Complete Protection Full-Frame Shield"; corrected), custom nose-bridge fit system. Confirmed off roka.com (Gloss White / Dark Glacier Mirror configuration): $240 USD, exact match to the existing sample (non-prescription base tier; a prescription CP-1x tier runs from $335). No weight confirmed in the raw page text this pass (a fetch-summary "29g" figure could not be cross-checked against the rendered page, so left unset per the phantom-number caution).' },
  { id:'ewr-roka-sl1x', cat:'eyewear', brand:'Roka', model:'SL-1x', price:185,
    type:'glasses',
    desc:'Rimless shield sunglasses, lighter-weight sibling of the CP-1x. CHECKED (2026-07-24): roka.com no longer sells a plain non-prescription "SL-1x" - only "SL-1x Prescription Sunglasses" and "SL-1x Protective" (ANSI Z87+ tactical tier, $175) remain live product pages; a retailer (Ironman Store) still lists a "SL-1X Rimless Performance Sunglasses" at $250, but that isn\'t a maker page and doesn\'t clearly map to this catalog row\'s config. Left unverified rather than guess which current SKU/price applies.' },
  { id:'ewr-roka-sr1x', cat:'eyewear', brand:'Roka', model:'SR-1x', price:210,
    type:'glasses',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://www.roka.com/products/sr-1x',
    desc:'Semi-rimless shield sunglasses, Roka\'s protective/tactical-adjacent tier (also sold in a Z87+ ballistic-rated version). Confirmed off roka.com (Matte Black / HC Fusion Mirror configuration): $210 USD - a real correction from the prior $175 sample (the SL-1x Protective tier the prior session apparently cross-referenced is the one still at $175). No weight confirmed in the raw page text this pass.' },
  { id:'ewr-goodr-og', cat:'eyewear', brand:'Goodr', model:'The OG', price:30,
    type:'glasses',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://goodr.com/collections/wrap-gs',
    desc:'No-slip, no-bounce polarized sport sunglasses, Goodr\'s original entry-level model. Confirmed off goodr.com\'s own All Styles collection listing (Exa-rendered): the OG line lists at a regular $30 (current sitewide sale price $24, not used as the basis), exact match to the existing sample. No weight found this batch.' },
  { id:'ewr-goodr-wrap-g', cat:'eyewear', brand:'Goodr', model:'Wrap G', price:45,
    type:'glasses', disciplines:['trail','enduro'],
    desc:'Wraparound cycling-specific shield, more curved/coverage than Goodr\'s round OG line, polarized. CHECKED (2026-07-24): goodr.com\'s current US "All Styles" listing has no "Wrap G" line at all - the wraparound-shield tier is now split across MACH G ($40), BOLT G ($45), TIDAL G ($45), FLY G ($35) and CIRCLE G ($30). The regional goodr.asia/goodr.eu storefronts still sell a "Wrap G" at $70 SGD/local currency, but that\'s not a US-site match. Left unverified rather than guess which current US tier this row should become.' },
  { id:'ewr-goodr-bfg', cat:'eyewear', brand:'Goodr', model:'BFG', price:40,
    type:'glasses',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://goodr.com/collections/bfgs',
  ...
  { id:'ewr-troyleedesigns-airbrake-pixel', cat:'eyewear', brand:'Troy Lee Designs', model:'Airbrake MTB Goggle - TLD Pixel', price:191,
    type:'goggles', disciplines:['enduro','dh'],
    desc:'kit-cross-category-1 (2026-07-24): TLD had ZERO eyewear rows -- confirmed gap (the eyewear category already holds standalone goggle brands EKS Brand/Dragon Alliance/Von Zipper, so goggles belong here). IMPORTANT ATTRIBUTION NOTE: this is a TLD x Oakley collaboration -- the Airbrake goggle shell/lens is Oakley-manufactured; "TLD Pixel" is Troy Lee Designs\' own colorway of that shell, sold on troyleedesigns.com under its "Oakley MTB Goggles" collection. Entered under brand:\'Troy Lee Designs\' because that is how TLD names and sells this specific SKU on its own storefront, not a claim that TLD makes its own goggle optics. Fetched live from troyleedesigns.com/collections/oakley-mtb-goggles ($191.00; SKU was showing sold-out at fetch time, a stock state not a lifecycle one, so status is left unset).',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://www.troyleedesigns.com/products/sp25-oakley-airbrake-mtb-goggle-tld-pixel-pixel' },
  ...
  { id:'jkt-leatt-hydradri3', cat:'jacket', brand:'Leatt', family:'leatt-hydradri', model:'Jacket MTB HydraDri 3.0', price:175,
    fitCut:'unisex', waterproof:true, sizes:['XS','S','M','L','XL','2XL','3XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://us.leatt.com/products/jacket-mtb-hydradri-3-0',
    desc:'HydraDri Evo 2.5-layer shell, 20,000mm waterproof / 20,000 g/m2 breathable PU membrane, magnetic helmet-compatible Ride Adaptive Hood, ClimbVent front-zip venting. Price confirmed on us.leatt.com. No weight published on the manufacturer page, so left unset rather than guessed.' },
  { id:'jkt-leatt-windblock2', cat:'jacket', brand:'Leatt', family:'leatt-windblock', model:'Jacket MTB WindBlock 2.0', price:142,
    fitCut:'unisex', waterproof:false, sizes:['XS','S','M','L','XL','2XL','3XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://us.leatt.com/products/jacket-mtb-windblock-2-0',
    desc:'Ultra-light ripstop nylon wind shell for XC/gravel, no waterproof membrane (windproof by fabric/construction, DWR-treated against light spray only, hence waterproof:false), knitted mesh back/armhole venting, packs into its own rear pocket. Price confirmed on us.leatt.com. No weight published on the manufacturer page.' },
  { id:'jkt-leatt-trail1', cat:'jacket', brand:'Leatt', family:'leatt-trail-jacket', model:'Jacket MTB Trail 1.0', price:99.99,
    fitCut:'unisex', waterproof:false, sizes:['XS','S','M','L','XL','2XL','3XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://us.leatt.com/products/jacket-mtb-trail-1-0-sale',
    desc:'Packable emergency-shelter shell, water/wind-resistant fabric explicitly NOT full waterproof per the maker copy ("will not keep you dry all day"), under-helmet stretch hood, self-pack chest pocket. $99.99 is the page\'s listed regular price (shown struck-through against a $64.99 current markdown). No weight published on the manufacturer page.' },
  { id:'jkt-leatt-hydradri5', cat:'jacket', brand:'Leatt', family:'leatt-hydradri', model:'Jacket MTB HydraDri 5.0', price:289,
    fitCut:'unisex', waterproof:true, sizes:['S','M','L','XL','2XL','3XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://us.leatt.com/products/jacket-mtb-hydradri-5-0-sale',
    desc:'Top-tier 3-layer HydraDri MAX membrane, 30,000mm waterproof / 30,000 g/m2 breathable, adjustable four-position magnetic Ride Adaptive Hood, ClimbVent venting, anti-slip backpack shoulder patches, forearm brush guards. $289 is the page\'s listed regular price (shown struck-through against a $187.85 current markdown). No weight published on the manufacturer page.' },
  { id:'jkt-poc-motionwind', cat:'jacket', brand:'POC', family:'poc-motion', model:'Motion Wind Jacket', price:190, weight:202,
    fitCut:'mens', waterproof:false, sizes:['S','M','L','XL','XXL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://poc.com/en-us/product/motion-wind-jacket-uranium-black',
    desc:'Lightweight nylon-spandex wind-blocking shell (DWR splash protection only, not a waterproof membrane, hence waterproof:false), helmet-compatible hood, elasticated cuffs/hem. Price + 202g weight (size M) confirmed on poc.com (US store).' },
  { id:'jkt-poc-motionrain', cat:'jacket', brand:'POC', family:'poc-motion', model:'Motion Rain Jacket', price:300, weight:295,
    fitCut:'mens', waterproof:true, sizes:['S','M','L','XL','XXL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://poc.com/en-us/product/ms-motion-rain-jacket-uranium-black',
    desc:'3-layer waterproof ripstop nylon shell, fluorocarbon-free DWR, helmet-compatible adjustable hood, underarm ventilated zones, reflective rear detailing. Price + 295g weight (size M) confirmed on poc.com (US store).' },
  { id:'jkt-troyleedesigns-resist', cat:'jacket', brand:'Troy Lee Designs', family:'troyleedesigns-resist', model:'Resist Jacket', price:295,
    fitCut:'mens', waterproof:true, sizes:['XS','S','M','L','XL','2XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://troyleedesigns.com/products/fa24-resist-jacket-mono-carbon',
    desc:'3-layer TLD waterproof shell, 15K/15K rating, 4 YKK waterproof zippered pockets, adjustable helmet-compatible hood, droptail hem with waist cinch. Formerly named the Decent Jacket per the product copy. Price confirmed on troyleedesigns.com. No weight published on the product page.' },
  { id:'jkt-troyleedesigns-crestline', cat:'jacket', brand:'Troy Lee Designs', family:'troyleedesigns-crestline', model:'Crestline Jacket', price:220, insulated:true,
    fitCut:'mens', sizes:['S','M','L','XL','2XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://troyleedesigns.com/products/fa23-crestline-jacket-mono-carbon',
    desc:'Packable insulated shoulder-season jacket, 100% polyester down-proof micro ripstop outer with PrimaLoft Gold insulation, deep YKK Vislon zippered side pockets, packs into its own pillow pocket. Not marketed as waterproof (no hydrostatic rating stated), so waterproof left unset rather than guessed. Price confirmed on troyleedesigns.com. No weight published on the product page.' },
  { id:'jkt-100-torrent-rain', cat:'jacket', brand:'100%', family:'100-torrent', model:'Torrent Rain Jacket', price:39.95,
    fitCut:'mens', waterproof:true, sizes:['S','M','L','XL','2XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.100percent.com/products/torrent-rain-jacket-black-23',
    desc:'EVA-fabric extra-long 3/4-length rain coat, welded pockets, snap closures. Price confirmed on 100percent.com (US store). No weight published on the product page.' },
  { id:'jkt-100-corridor-stretch-windbreaker', cat:'jacket', brand:'100%', family:'100-corridor', model:'Corridor Stretch Windbreaker', price:99,
    fitCut:'unisex', waterproof:false, sizes:['S','M','L','XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.100percent.com/products/corridor-stretch-windbreaker-black-1',
    desc:'Lightweight tapered wind-blocking layer with reflective logos, no waterproof claim on the product page (wind protection only, hence waterproof:false). $99.00 is the page\'s listed regular price (shown struck-through against a $34.65 current markdown). No weight published on the product page.' },
  { id:'jkt-giro-stow-h2o', cat:'jacket', brand:'Giro', family:'giro-stow', model:'Stow H2O Jacket', price:174.95,
    fitCut:'mens', waterproof:true,
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.giro.com/product/men%27s-stow-h2o-jacket/350250000800000030.html',
    desc:'15,000mm waterproof / 15,000 g/m2 breathable seam-sealed shell, packs down to stow on a pack or bars, two zippered hand pockets, 3M reflective highlights. $174.95 is the page\'s listed regular price (shown struck-through against a $122.99 current markdown). No weight or sizes published on the fetched page.' },
  { id:'jkt-ixs-awpro-10', cat:'jacket', brand:'iXS', family:'ixs-aw', model:'AW-Pro 1.0 Laminated Jacket', price:317.84,
    fitCut:'unisex', waterproof:true, sizes:['XS','S','M','L','XL','2XL'],
    verified:true, priceBasis:'regional-conversion', lastChecked:'2026-07-23', source:'https://www.ixs.com/en/products/aw-pro-1-0-laminatjacke-black',
    desc:'3-layer fully waterproof/breathable riding shell, 20,000mm water column / 20,000 g/m2 MVP breathability, over-helmet hood, waterproof zippered pockets + underarm vents, lift-pass sleeve pocket. iXS\'s own EU store lists EUR-only pricing (no US storefront found); price converted from the maker-stated EUR279.00 at the ECB EUR/USD reference rate of 1.1392 on 2026-07-23 (ecb.europa.eu) - regional-conversion, not a US-native MSRP. No weight published on the product page.' },
  { id:'jkt-alpinestars-tahoe-waterproof', cat:'jacket', brand:'Alpinestars', family:'alpinestars-tahoe', model:'Tahoe Waterproof Jacket', price:189.99,
    fitCut:'mens', waterproof:true,
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.alpinestars.com/products/tahoe-waterproof-jacket-black-red-dark-shadow',
    desc:'MTB-specific winter-kit shell optimized for waterproofing and breathability, dual-adjustment storm hood, silicone backpack-grip patterning, multiple storage compartments. Price confirmed on alpinestars.com. No weight or sizes published on the fetched page.' },
  { id:'jkt-alpinestars-adura-rain', cat:'jacket', brand:'Alpinestars', family:'alpinestars-adura', model:'A-Dura Rain Jacket', price:214.95,
    fitCut:'mens', waterproof:true, sizes:['S','M','L','XL','2XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.alpinestars.com/products/a-dura-rain-jacket',
    desc:'2.5-layer stretch membrane, 15,000mm waterproof, tape-welded 15mm sealon seams at shoulders/hood, mesh-lined ventilating hand pockets, Velcro cuff adjustment. Price + sizes confirmed on alpinestars.com. No weight published on the fetched page.' },
  { id:'jkt-specialized-trail-rain', cat:'jacket', brand:'Specialized', family:'specialized-trail-jacket', model:"Men's Trail Rain Jacket", price:174.99,
    fitCut:'mens', waterproof:true, sizes:['XS','S','M','L','XL','2XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.specialized.com/us/en/mens-trail-rain-jacket/p/200445',
    desc:'2.5-layer fully waterproof fabric (DWR outer + waterproof membrane + comfort backing), over-the-helmet hood, packable into its own pocket. $174.99 is the page\'s listed regular price (shown struck-through against an $87.49 current final-sale markdown). No weight published on the fetched page.' },
  { id:'jkt-specialized-trail-swat', cat:'jacket', brand:'Specialized', family:'specialized-trail-jacket', model:"Men's Trail SWAT Jacket", price:139.99,
    fitCut:'mens', waterproof:false, sizes:['XS','S','M','L','XL','2XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.specialized.com/us/en/mens-trail-swat-jacket/p/200447',
    desc:'Breathable wind-resistant fabric with DWR water-repellent coating (not a waterproof membrane, hence waterproof:false), one SWAT-compatible storage pocket, abrasion panels, integrated scuba hood. $139.99 is the page\'s listed regular price (shown struck-through against a $69.99 current final-sale markdown). No weight published on the fetched page.' },
  { id:'jkt-scott-dryopro-25l', cat:'jacket', brand:'Scott', family:'scott-dryo', model:"Dryo Pro 2.5 Layer Men's Jacket", price:250,
    fitCut:'mens', waterproof:true,
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.scott-sports.com/us/en/products/bike-apparel-men-jackets',
    desc:'DRYOsphere 2.5-layer waterproof/breathable shell (15,000mm waterproof / 15,000 g/m2 breathable per the maker\'s EU spec sheet for the same platform), adjustable cuffs/hem, underarm vents, helmet-compatible hood. Price confirmed on scott-sports.com\'s US bike-jackets listing. Weight not confirmed - third-party retailers cite conflicting figures (350g vs 450g) for this jacket, so left unset rather than guessed.' },
  { id:'jkt-dakine-rainprotection-light', cat:'jacket', brand:'Dakine', family:'dakine-rainprotection', model:'Rain Protection Light Jacket', price:100,
    fitCut:'mens', waterproof:true, sizes:['S','M','L','XL','2XL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.dakine.com/collections/mens-apparel/products/rain-protection-light-jacket-black',
    desc:'General outdoor rain shell (Dakine\'s dedicated Bike Jackets & Outerwear collection is currently sold out with 0 products, a documented catalog gap), 100% polyester, 10,000mm waterproof rating per the spec sheet despite softer "water-resistant" marketing copy - treated as waterproof:true on the stated 10K figure. Adjustable drawcord hood, front hand pockets, rubberized snap closure. Price + sizes confirmed on dakine.com.' },
  { id:'jkt-7mesh-revelation', cat:'jacket', brand:'7mesh', family:'7mesh-revelation', model:"Men's Revelation Jacket", price:300,
    fitCut:'mens', waterproof:true, sizes:['XS','S','M','L','XL','XXL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://7mesh.com/en-US/products/mens-revelation-jacket',
    desc:'GORE-TEX Pro shell, watertight zippered forearm intake vents + side jersey-access vents, removable under-helmet hood. Price + sizes confirmed on 7mesh.com\'s US (en-US) storefront.' },
  { id:'jkt-rapha-trail-lightweight', cat:'jacket', brand:'Rapha', family:'rapha-trail-lightweight', model:"Men's Trail Lightweight Jacket", price:175,
    fitCut:'mens', waterproof:false, sizes:['XS','S','M','L','XL','XXL'],
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.rapha.cc/us/en/product/TLJ01XXAMC',
    desc:'Superlight Japanese ripstop windproof layer, DWR coating rated for "light rain showers and spray" rather than a waterproof membrane (hence waterproof:false), packs into its own chest pocket and straps to the frame, helmet-compatible hood. $175.00 is the page\'s listed regular price (shown struck-through against a $122.00 current markdown) on rapha.cc\'s US store.' },
  { id:'jkt-monsroyale-diversion-wind', cat:'jacket', brand:'Mons Royale', family:'monsroyale-diversion', model:'Diversion Merino Wind Jacket', price:239.95,
    fitCut:'mens', waterproof:false,
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://monsroyale.com/pages/bike',
    desc:'Merino-Shift/recycled-Pertex-Quantum wind shell (C0 DWR water-repellent finish, no waterproof membrane claimed, hence waterproof:false), adjustable helmet-compatible hood, packs into its own hood. Price confirmed on monsroyale.com\'s US bike collection page. No weight in grams published (fabric is rated 140gsm, a fabric-density figure, not a garment weight).' },
  { id:'jkt-dharco-rainjacket-storm', cat:'jacket', brand:'DHaRCO', family:'dharco-rainjacket', model:'Mens Rain Jacket - Storm', price:218,
    fitCut:'mens', waterproof:true,
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://us.dharco.com/products/mens-rain-jacket-storm',
    desc:'8,000mm waterproof / 5,000 g/m2/24h breathable polyester shell, fully taped seams, waterproof YKK zips, helmet-compatible hood, adjustable velcro cuffs. Price confirmed on us.dharco.com (the US storefront - the AUD/GBP regional stores list the same jacket at different local prices). No weight or sizes published on the fetched page.' },
  { id:'jkt-fasthouse-offroad-seeker', cat:'jacket', brand:'Fasthouse', family:'fasthouse-seeker', model:'Off-Road Seeker Jacket', price:205,
    fitCut:'mens', waterproof:false,
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://www.fasthouse.com/products/off-road-seeker-jacket-black',
    desc:'DWR-coated 4-way-stretch shell with zip-off sleeves (store into a back pocket), fleece-lined collar, upper-back vent - DWR-only weather protection, no waterproof rating stated, hence waterproof:false. Price confirmed on fasthouse.com. No weight or sizes published on the fetched page.' },
  { id:'jkt-chromag-col', cat:'jacket', brand:'Chromag', family:'chromag-col', model:"Col Jacket Men's", price:174,
    fitCut:'mens', waterproof:false,
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-23', source:'https://us.chromagbikes.com/products/col-jacket-mens',
    desc:'Ultra-lightweight ripstop windbreaker with C0 DWR (wind protection only, no waterproof rating stated, hence waterproof:false), spandex cuff panels, laser-cut underarm venting, stash pocket with a frame-strap for on-bike storage. Price confirmed on us.chromagbikes.com (the USD storefront - the .com default store shows a different EUR price for the same SKU). No weight or sizes published on the fetched page.' },
  { id:'jkt-velocio-alphaair', cat:'jacket', brand:'Velocio', family:'velocio-alpha', model:"Men's Alpha Air Jacket", price:259, insulated:true,
    fitCut:'mens', waterproof:false,
  ...
  { id:'jkt-oneal-baja', cat:'jacket', brand:"O'Neal", model:'Baja Jacket', price:119.99, mfgPn:'1104-102',
    fitCut:'unisex', waterproof:false,
    desc:'kit-cross-category-1 (2026-07-24): O\'Neal had ZERO jacket rows -- confirmed gap. Windproof, water-repellent shell (not a fully waterproof jacket -- maker copy says "water-repellent", so waterproof:false rather than asserting true), size-adjustable removable sleeves, waterproof front zipper. Sizes S-XXL. Fetched live from oneal.com; the only result the site\'s own "cycling jacket" search returns.',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://oneal.com/products/baja-jacket-black',
    sizes:['S','M','L','XL','XXL'] },
  { id:'jkt-raceface-loamranger', cat:'jacket', brand:'Race Face', model:'Loam Ranger', price:114.00,
    fitCut:'mens', insulated:false, waterproof:false,
    desc:'kit-cross-category-1 (2026-07-24): Race Face had ZERO jacket rows across its Conspiracy/Trigger rain-shell lines -- confirmed gap. The Loam Ranger is a flannel shirt-jacket ("Lumberjack Casual", RaceFace\'s own copy: "every self-respecting mountain biker needs a trusty flannel") under RaceFace\'s Outerwear nav, not a technical rain shell -- casual layer, not waterproof/insulated. Sizes S-XXL. raceface.com listed it at "Regular price $91.20 / Sale price $114.00" (the site\'s own labels read reversed vs the actual sale; $114.00 is the higher, non-sale figure, taken as MSRP).',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://www.raceface.com/products/loam-ranger',
    sizes:['S','M','L','XL','XXL'] },
  { id:'jkt-shimano-nagano', cat:'jacket', brand:'Shimano', model:'Nagano Jacket', price:51.99, status:'discontinued',
    fitCut:'mens', waterproof:false,
    desc:'kit-cross-category-1 (2026-07-24): Shimano had ZERO jacket/shorts/pants rows -- confirmed gap. Windproof, water-repellent (not fully waterproof) windbreaker, part of Shimano\'s Enduro/All Mountain/XC MTB apparel line; mfgPn (black S) PCWWBMSUE21ML0104. No longer listed on ride.shimano.com (the current US direct-to-consumer site carries NO apparel/jacket/shorts/pants collection at all -- footwear/gloves/socks/eyewear/pedals only), so entered as discontinued sample data, same treatment as the existing jsy-shimano-explorer-ss row (real-then-dropped, not fabricated). Price is a EUR retailer listing (bike-components.de, €51.99) converted at par for the sample figure -- not a confirmed US MSRP, so left unverified.',
    mfgPn:'PCWWBMSUE21ML0104' },
  ...
  { id:'jsy-velocio-delta-trail-ls', cat:'jersey', brand:'Velocio', model:'Delta TRAIL Long Sleeve', price:99,
    weight:144, sourceType:'measured', weightSource:'https://www.bikeperfect.com/reviews/velocio-delta-trail-long-sleeve-jersey-review',
    sleeve:'long', verified:true, lastChecked:'2026-07-23', priceBasis:'msrp-confirmed',
    source:'https://www.velocio.cc/products/mens-delta-trail-long-sleeve',
    desc:'Polartec Delta open-grid-knit MTB long sleeve, recycled polyester/Tencel(lyocell) blend, trail-specific cut. RE-CHECKED 2026-07-23 via velocio.cc (browser pane, WebFetch 429s): $99 US price and 70% Polyester/30% Lyocell materials read directly off the current product page, matching the catalog. No weight published by Velocio; weight is BikePerfect\'s reviewer-measured 144g (size small) tech-spec figure, cited as sourceType:measured per the third-party-measured-weight policy.' },
  { id:'jsy-velocio-ultralight-trail-ss', cat:'jersey', brand:'Velocio', model:'Ultralight TRAIL Jersey', price:79,
    weight:135, sourceType:'measured', weightSource:'https://www.feedthehabit.com/velocio-ultralight-trail-jersey-review/',
    sleeve:'short', verified:true, lastChecked:'2026-07-23', priceBasis:'msrp-confirmed',
    source:'https://www.velocio.cc/products/mens-ultralight-mtb-jersey',
    desc:'Featherweight opaque-mesh summer MTB jersey, 88% recycled polyester / 12% elastane construction. RE-CHECKED 2026-07-23 via velocio.cc (browser pane, WebFetch 429s; product now titled "Ultralight MTB Jersey" on-site, body copy still says "Ultralight TRAIL Jersey" - same SKU): $79 US price and materials read directly off the current product page, matching the catalog. No weight published by Velocio; weight is FeedTheHabit\'s explicitly scale-measured 135g figure ("By my scale, it comes in at 135 grams"), cited as sourceType:measured.' },
  ...
  { id:'pnt-shimano-explorer-rain', cat:'pants', brand:'Shimano', model:'Explorer Rain Pant', price:99.95, status:'discontinued',
    liner:false, fitCut:'mens',
    desc:'kit-cross-category-1 (2026-07-24): completes the same Shimano gap as jkt-shimano-nagano/sht-shimano-explorer (see jkt-shimano-nagano for why ride.shimano.com carries no current apparel line). From the March-2021 Explorer Collection: seam-sealed Dryshield waterproof fabric, crotch reinforcement, chain-guard velcro tabs, packable carry pouch. No longer sold anywhere on shimano-eu.com/ride.shimano.com. Price is a EUR retailer RRP (bike-discount.de listed it at an RRP of €99.95) taken at par as an unverified sample -- not a confirmed US MSRP.' },
  ...
  { id:'jsy-ornot-uv-hooded-trail-shirt', cat:'jersey', brand:'Ornot', model:'Hooded UV Trail Shirt', price:85,
    sleeve:'long',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://www.ornotbike.com/products/mens-uv-hooded-trail-shirt-oat',
    desc:'Hooded version of the UV Trail Shirt (Bicycling Magazine Gear of the Year 2024), same 85% Polyester/15% Elastane fabric, UPF 30, rear accessory pocket - reviews specifically cite "mountain biking" use. The hood itself has no schema field (jersey has no hood vocab) - captured in `desc` only. Confirmed off an individual ornotbike.com product page (Oat colorway): $85.00, exact match to the existing sample.' },
  { id:'sht-ornot-mission-short', cat:'shorts', brand:'Ornot', model:'Mission Short', price:126,
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://www.ornotbike.com/products/mission-short-slate',
    desc:'US-made (Oakland, CA) casual/trail short, bluesign-approved recycled nylon/elastane, full panel gusset, 4-way stretch, 8.5" inseam. No built-in chamois (casual daily-driver cut, not a padded MTB short) - `liner` left unset. Reconfirmed off multiple ornotbike.com product pages (Slate/Obsidian/Midnight Blue): $126.00 across colorways, exact match to the existing sample. Also sold in a "Lightweight" (148gsm) fabric variant at the same $126 price - not split into a separate row (no engine-read field differs; fabric weight is a annotation-only difference, DATA-ENTRY-TEMPLATE §1 "NOTHING" row).' },
  { id:'sht-ornot-work-bib-short', cat:'shorts', brand:'Ornot', model:'Work Bib Short', price:184, weight:198,
    liner:true,
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://www.ornotbike.com/products/mens-work-bib-short-black',
    desc:'Bib-style road/trail short with a high-density endurance chamois pad and one-piece strap construction, bluesign-approved recycled fabric, UPF 50+ - entered under `shorts` since this catalog has no separate bib category (flagged in the worker report). Reconfirmed off ornotbike.com product pages (Black/Stone Blue) and the Men\'s Bibs and Tights collection listing: $184.00, exact match to the existing sample. Per-size weight (198g) stays the prior session\'s figure, read directly off the maker\'s own Shopify product JSON (not a third-party retailer).' },
  ...
  { id:'sho-chromeindustries-southside3-pro', cat:'shoes', brand:'Chrome Industries', model:'Southside 3.0 Pro', price:122, weight:1056,
    soleType:'clipless', closure:'lace', disciplines:['trail'],
    desc:'Clipless sneaker-style commuter/trail shoe, Panaracer vulcanized outsole, rigid FlexPlate nylon shank, recessed 2-bolt cleat mount. CHECKED (2026-07-24): chromeindustries.com\'s current US Shoes collection (11 products) no longer includes the Southside 3.0 Pro or any clipless-pedal sneaker at all - the live lineup is Storm 415 Traction Boot, Powell, Naito, Sylvan, Boyer and similar lifestyle sneakers. Genuinely discontinued, not just a fetch-wall. Left unverified sample (price from a US retailer, Brotures Global, $122; weight doubled from a Bike24 per-shoe spec).' },
  { id:'sho-chromeindustries-kursk-aw-pro', cat:'shoes', brand:'Chrome Industries', model:'Kursk AW Pro', price:140,
    soleType:'clipless', closure:'lace', disciplines:['trail'],
    desc:'Clipless pedal sneaker, weatherproof lace-up upper, SPD-compatible (Shimano/Time/Look/Crankbrothers cleat systems). CHECKED (2026-07-24): same finding as the Southside 3.0 Pro (sho-chromeindustries-southside3-pro) - chromeindustries.com\'s current US Shoes collection has no Kursk AW Pro or any clipless model; genuinely discontinued (a "Kursk AW 2.0 Pro" survives on the separate chromeindustries.com.au storefront, but that\'s a different regional site, not this row\'s US-catalog match). Left unverified sample: price is the EUR RRP shown on EU retailer pages (Rose Bikes, EUR140.00), no US MSRP found. No reliable weight found, left unset.' },
  ...
  { id:'hm-alpinestars-vectortech-a1', cat:'helmet', brand:'Alpinestars', model:'Vector Tech A1', price:179.95,
    type:'half-shell', rotational:'mips', disciplines:['trail','enduro'],
    desc:'kit-cross-category-1 (2026-07-24): Alpinestars had ZERO helmet rows -- confirmed gap. MIPS-equipped enduro/trail half-shell, 19 vents, reinforced air scoop, adjustable dial fit, visor with goggle-storage clearance. Sizes S/M/L. No CE/CPSC certification statement found on the fetched product page, so `certs` is left unset rather than assumed. Fetched live from alpinestars.com; site showed a $107.97 sale price off the $179.95 regular/MSRP price used here.',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://www.alpinestars.com/products/vector-tech-a1-helmet',
    sizes:['S','M','L'] },
  ...
  { id:'jsy-scott-trailverticpro-ss', cat:'jersey', brand:'Scott', model:'Trail Vertic Pro Short-sleeve Tee', mfgPn:'421411', family:'scott-trail-vertic', price:69.99,
    sleeve:'short', disciplines:['trail','enduro'],
    desc:'kit-cross-category-1 (2026-07-24): Scott had ZERO jersey rows despite being in 11 other kit categories -- confirmed gap. CORDURA construction, longer back coverage, sizes XS-XXL, Model 421411. Fetched live via scott-sports.com/us/en/products/bike-apparel-men-tops (browser pane, JS-rendered listing) then the product page itself. No weight published on the US page.',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://www.scott-sports.com/us/en/product/scott-trail-vertic-pro-short-sleeve-men-s-tee',
    sizes:['XS','S','M','L','XL','XXL'] },
  ...
  { id:'sht-oneal-pinit', cat:'shorts', brand:"O'Neal", model:'Pin-It Short', price:99.99, mfgPn:'1075-258',
    liner:false, fitCut:'mens',
    desc:'kit-cross-category-1 (2026-07-24): O\'Neal had ZERO shorts rows -- confirmed gap. O\'Neal\'s lightest MTB short, active cut, laser-cut ventilation, popper waist closure. No built-in chamois -- maker copy says "compatible with O\'Neal inner chamois shorts (available separately)", so liner:false. Sizes 28-38 (waist, in), SKU 1075-258. Fetched live from oneal.com; MSRP $99.99 (site was showing a $59.99 sale price at fetch time).',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://oneal.com/products/pin-it-short-black',
    sizes:['28','30','32','34','36','38'] },
  { id:'sht-gform-x4-liner', cat:'shorts', brand:'G-Form', model:'X4 MTB Liner Shorts with Chamois', price:139.99,
    liner:true, fitCut:'mens',
    desc:'kit-cross-category-1 (2026-07-24): G-Form had ZERO shorts rows despite padded liner shorts being a core G-Form product (its knee/elbow/shin SmartFlex pads were already cataloged) -- confirmed gap. Padded MTB liner short with integrated chamois, SmartFlex hip-pad protection. Sizes S-XL. Fetched live from g-form.com.',
    verified:true, priceBasis:'msrp-confirmed', lastChecked:'2026-07-24', source:'https://g-form.com/products/x4-bike-liner-shorts',
    sizes:['S','M','L','XL'] },
  { id:'sht-shimano-explorer', cat:'shorts', brand:'Shimano', model:'Explorer Shorts', price:99.99, status:'discontinued',
    liner:true, fitCut:'mens',
    desc:'kit-cross-category-1 (2026-07-24): part of the same Shimano gap as jkt-shimano-nagano (see that row for why ride.shimano.com carries no current apparel line). From the March-2021 Explorer Collection (also called "Fukui Shorts" in Shimano\'s own launch copy per bikeperfect.com); integrated seat cushion insert, 4-way stretch fabric, mud/water-treated fabric. mfgPn CWPATSMS12MHS. No longer sold anywhere on shimano-eu.com/ride.shimano.com; price is a EUR retailer RRP (sportokay.com, EU\'s SportOkay listing, €99.99) taken at par as an unverified sample -- not a confirmed US MSRP.',
    mfgPn:'CWPATSMS12MHS' },

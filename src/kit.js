...
var KIT_PARTS = [
  ...
  { id:'jsy-endura-singletrack', cat:'jersey', brand:'Endura', model:'SingleTrack S/S Jersey', price:55, weight:150,
    sleeve:'short', sizes:['S','M','L','XL','XXL'], fitCut:'womens',
    desc:'RESOLVED+RETARGETED grind-3 (2026-07-16): confirmed real, currently-sold as a WOMEN\'S-only SKU (us.endurasport.com lists Blue Steel/Paprika/Punch Pink/Pacific Blue colorways, all women\'s; no men\'s version exists). fitCut corrected to womens; price/weight kept as the prior sample (endurasport.com rate-limited/403d on every direct fetch attempt this session, so not upgraded to verified).' },
  ...
  { id:'jsy-raceface-indy-ss-womens', cat:'jersey', brand:'Race Face', model:'Indy SS Jersey - Women\'s', price:35,
    sleeve:'short', sizes:['XS','S','M','L','XL'], fitCut:'womens',
    desc:'Grind-3 breadth add (2026-07-16): fetched raceface.com Shopify product JSON for the real, currently-sold women\'s Indy SS Jersey (distinct SKU from the men\'s Indy SS at $70). No weight published on the page.' },
  { id:'jsy-raceface-traverse-34-womens', cat:'jersey', brand:'Race Face', model:'Traverse DriRelease 3/4 Jersey - Women\'s', price:61,
    sleeve:'long', sizes:['XS','S','M','L','XL'], fitCut:'womens',
    desc:'Grind-3 breadth add (2026-07-16): fetched raceface.com Shopify product JSON ($61 regular price; some colorways sit at a $27.45 clearance price, not used here). Modeled as long-sleeve - the schema\'s sleeve vocab has no 3/4 token (same convention as the catalog\'s other 3/4-sleeve rows). No weight published on the page.' },
  ...
  { id:'jsy-endura-singletrack-ls', cat:'jersey', brand:'Endura', model:'SingleTrack L/S Jersey', price:60, weight:175,
    sleeve:'long', sizes:['S','M','L','XL','XXL'], fitCut:'womens',
    desc:'RESOLVED+RETARGETED grind-3 (2026-07-16): confirmed real, currently-sold as a WOMEN\'S-only SKU (us.endurasport.com lists Blue/Harvest/Machair Green colorways, all women\'s; no men\'s version exists). fitCut corrected to womens; price/weight kept as the prior sample (endurasport.com rate-limited/403d on every direct fetch attempt this session, so not upgraded to verified).' },
  ...
  { id:'sht-dakine-syncline', cat:'shorts', brand:'Dakine', model:'Syncline 13" Bike Short', price:80, weight:260,
    ...
    desc:'RESOLVED+RETARGETED grind-3 (2026-07-16): the flagged men\'s Syncline Short row had no current SKU; retargeted to the real, currently-sold women\'s Syncline 13" Bike Short via its Shopify .js product JSON ($80 confirmed across all sizes/colorways; Dakine does not publish a per-variant weight for this SKU, so weight stays the prior sample figure, unverified).' },
  { id:'sht-dakine-thrillium', cat:'shorts', brand:'Dakine', model:'Thrillium Bike Short', price:130, weight:280,
    ...
    desc:'RESOLVED+RETARGETED grind-3 (2026-07-16): the flagged men\'s Thrillium Short row had no current SKU; retargeted to the real, currently-sold women\'s Thrillium Bike Short via its Shopify .js product JSON (current price $130; an older "S21" colorway sits at $120 but is sold out/inactive). No per-variant weight published, so weight stays the prior sample figure, unverified.' },
  ...
  { id:'sht-poc-motion-womens', cat:'shorts', brand:'POC', model:'Women\'s Motion Shorts', price:120,
    liner:false, sizes:['XS','S','M','L','XL'], fitCut:'womens', disciplines:['trail'],
    desc:'Grind-3 breadth add (2026-07-16): search-attributed poc.com pricing ($120 regular MSRP; currently on a $90 sale, not used here). Direct product-page fetch 404\'d this session (handle guesswork failed), so left unverified rather than claim a fetched confirmation.' },

...
var KIT_PARTS = [
  ...
  { id:'hm-fox-proframe-rs', cat:'helmet', brand:'Fox', model:'Proframe RS', price:399.95, weight:820,
    ...
    desc:'CORRECTED 2026-07-17: price is the fetched $399.95 list (was sample $420). Weight is size M, 820±5g maker-stated (was sample 750g; S 710±5g, L 910±5g). Sizes are S/M/L only (was sample S/M/L/XL — no XL SKU on the maker page across two colorways checked).',
    verified:true, lastChecked:'2026-07-17', source:'https://www.foxracing.com/product/proframe-rs-helmet/31107.html' },
  ...
  { id:'hm-giro-manifest-spherical-mips', cat:'helmet', brand:'Giro', model:'Manifest Spherical MIPS', price:279.95, weight:340,
    ...
    desc:'VERIFIED 2026-07-17 via bdata-rendered giro.com (Vista JS-wall bypassed): "Certifications & Weight" panel'
      + ' states CE EN 1078, 340 gr. (size M); MSRP corrected 260 -> $279.95 (page showed a 29%-off $195.99 sale'
      + ' price, list price confirmed elsewhere on the page as $279.95).',
    verified:true, lastChecked:'2026-07-17', source:'https://www.giro.com/product/manifest-spherical-helmet/100000000500000097.html' },
  { id:'hm-giro-tyrant-spherical-mips', cat:'helmet', brand:'Giro', model:'Tyrant Spherical MIPS', price:174.95, weight:600,
    type:'half-shell', rotational:'mips', certs:['cpsc'], disciplines:['enduro','dh'], sizes:['S','M','L'],
    desc:'VERIFIED 2026-07-17 via bdata-rendered giro.com (Vista JS-wall bypassed): "Certifications & Weight" panel'
      + ' states 600g (size Medium), complies with US CPSC + CE (no EN-1078 number stated, so only cpsc asserted).'
      + ' CORRECTED type half-shell (was mislabeled full-face - the page describes a Roc Loc Air DH fit system with'
      + ' no chin bar/removable-chinbar language anywhere); price corrected 160 -> $174.95, weight 600g confirmed'
      + ' (was already 600g).',
    verified:true, lastChecked:'2026-07-17', source:'https://www.giro.com/product/tyrant-spherical-helmet/100000000500000086.html' },
  { id:'hm-giro-switchblade-mips', cat:'helmet', brand:'Giro', model:'Switchblade MIPS', price:279.95, weight:975,
    ...
    desc:'VERIFIED 2026-07-17 via bdata-rendered giro.com (Vista JS-wall bypassed): "Certifications & Weight" panel'
      + ' states 975g (size Medium), complies with US CPSC + CE; page copy explicitly states "ASTM Downhill'
      + ' certified". MSRP $279.95 confirmed (list price, page showed a discounted $223.99 sale price); weight'
      + ' 975g confirmed. Convertible; weight is the full half-shell + chin-bar assembly, size M.',
    verified:true, lastChecked:'2026-07-17', source:'https://www.giro.com/product/switchblade-mips-helmet/100000001500000013.html' },
  { id:'hm-bell-4forty-air-mips', cat:'helmet', brand:'Bell', model:'4Forty Air MIPS', price:179.95, weight:394,
    type:'half-shell', rotational:'mips', disciplines:['trail'], sizes:['S','M','L','XL'],
    desc:'CORRECTED 2026-07-17: price is the fetched $179.95 list (was sample $150; the page shows a $98.97-179.95 range across colorways, list value used). Weight is MBR\'s measured 394g (size M) - Bell claims 360g on the maker page but publishes no per-SKU spec table, so the editorial measured figure is used per policy (was sample 380g, close already).',
    verified:true, lastChecked:'2026-07-17', source:'https://www.bellhelmets.com/product/4forty-air-mips/100000000500000111.html',
    sourceType:'measured', weightSource:'https://www.mbr.co.uk/reviews/helmets/bell-4forty-air-mips-helmet-review' },
  { id:'hm-bell-super-air-r-mips', cat:'helmet', brand:'Bell', model:'Super Air R Spherical', price:209.97, weight:640,
    type:'convertible', rotational:'mips', disciplines:['trail','enduro'], sizes:['S','M','L'],
    desc:'Convertible; weight is the full-face configuration, size M (lighter as a half-shell alone). CORRECTED 2026-07-17: current maker product is "Super Air R Spherical" (Spherical Technology powered by Mips - Bell renamed the line but it remains Mips-powered, so rotational stays mips). Price is the fetched $209.97 list (was sample $275; page shows a $197.97-209.97 range across colorways, higher/list value used). Weight is the maker-stated 640g (size M), from the Certifications & Weight accordion tab (was sample 685g).',
    verified:true, lastChecked:'2026-07-17', source:'https://www.bellhelmets.com/product/super-air-r-spherical/100000000500000093.html' },
  { id:'hm-bell-full9-fusion-mips', cat:'helmet', brand:'Bell', model:'Full-9 Fusion MIPS', price:349.95, weight:1080,
    type:'full-face', rotational:'mips', disciplines:['dh'], sizes:['XS','S','M','L','XL','XXL'],
    desc:'CORRECTED 2026-07-17: price is the fetched $349.95 list (was sample $280; page currently on sale at $279.98 and shown as Sold Out - still a real, currently-listed product, list price used per policy). Weight is the maker-stated 1080g (size M), confirming the existing sample exactly. Sizes widened to the fetched XS-XXL range.',
    verified:true, lastChecked:'2026-07-17', source:'https://www.bellhelmets.com/product/full-9-fusion-mips/100000001500000016.html' },
  { id:'hm-bell-sixer-mips', cat:'helmet', brand:'Bell', model:'Sixer MIPS', price:189.95, weight:395,
    type:'half-shell', rotational:'mips', disciplines:['trail'], sizes:['S','M','L','XL'],
    desc:'CORRECTED 2026-07-17: price is the fetched $189.95 list (was sample $150; page shows a $113.97-189.95 range across colorways, list value used). Weight is the maker-stated 395g (size M), from the Certifications & Weight accordion tab (was sample 400g, close already). Sizes widened to the fetched S-XL range.',
    verified:true, lastChecked:'2026-07-17', source:'https://www.bellhelmets.com/product/sixer-mips/100000000500000069.html' },
  ...
  { id:'hm-kaliprotectives-shiva2', cat:'helmet', brand:'Kali Protectives', model:'Shiva 2.0', price:350, weight:1190,
    type:'full-face', disciplines:['dh'], sizes:['S','M','L','XL'], status:'discontinued',
    desc:'Non-MIPS proprietary rotational system (RHEON LDL + Nano Fusion); weight is the standard (non-carbon) shell, size M. Confirmed discontinued (kit-fanout-1a re-check 2026-07-17): kaliprotectives.com/products/shiva-2-0 no longer resolves to a product page (redirects to the homepage/catalog), which now lists only Shiva Nano and Shiva 3.0 Carbon as current full-face helmets - no successor id exists in this catalog yet, so supersededBy is left unset. Stays unverified (no live maker page to confirm price/weight against).' },
  { id:'hm-met-roam-mips', cat:'helmet', brand:'MET', model:'Roam MIPS', price:160, weight:360,
    type:'half-shell', rotational:'mips', disciplines:['trail','enduro'], sizes:['S','M','L'],
    status:'discontinued',
    desc:'Discontinued: fetched met-helmets.com\'s MTB helmet category page 2026-07-17 - it lists'
      + ' 8 current models (Parachute MCR, Revo, Revo Kilian Bron, Terraæ, Veleno MIPS, Veleno'
      + ' Wander, Shelter MIPS, Shelter) and Roam MIPS is not among them, though it remains widely'
      + ' listed at retailers under MET\'s legacy catalog code (400015-1), confirming it was a real,'
      + ' now-retired SKU. Stays unverified sample data (no live maker page to confirm price/weight'
      + ' against).' },
  { id:'hm-lazer-jackal-mips', cat:'helmet', brand:'Lazer', model:'Jackal MIPS', price:180, weight:390,
    type:'half-shell', rotational:'mips', disciplines:['trail'], sizes:['S','M','L'],
    status:'discontinued',
    desc:'Discontinued: superseded by the Jackal KinetiCore (13% lighter, less plastic per Lazer\'s'
      + ' own environmental impact report). Confirmed 2026-07-17 - lazersport.us/products/jackalmips'
      + ' (the old MIPS-model handle) now 200s straight into the Jackal KinetiCore product JSON'
      + ' (same handle/title as hm-lazer-jackal-kineticore), i.e. it is a retired-handle redirect,'
      + ' not a live separate listing. Stays unverified sample data (no live MIPS-specific page to'
      + ' confirm price/weight against).' },
  ...
  { id:'sho-giro-latch', cat:'shoes', brand:'Giro', model:'Latch', price:159.95, weight:700,
    soleType:'flat', closure:'lace', disciplines:['trail','enduro'], sizes:['39','40','41','42','43','44','45','46','47'],
    desc:'VERIFIED 2026-07-17 via bdata-rendered giro.com: Tack Rubber flat sole, Laced Closure confirmed;'
      + ' MSRP $159.95 confirmed (price 160 -> 159.95). No weight published on the fetched page - stays the'
      + ' prior sample figure per THE BAR (interfaces/price fetched-confirmed, weight not blocking).',
    verified:true, lastChecked:'2026-07-17', source:'https://www.giro.com/product/latch-shoe/350060001200000001.html' },
  { id:'sho-giro-riddance', cat:'shoes', brand:'Giro', model:'Riddance', price:119.95, weight:860,
    ...
    desc:'VERIFIED 2026-07-17 via bdata-rendered giro.com: MSRP $119.95 confirmed; "Certifications & Weight"'
      + ' panel states 430 grams (size 43) per shoe, so 860g/pair (was sample 640g). Lightweight trail flat shoe.',
    verified:true, lastChecked:'2026-07-17', source:'https://www.giro.com/p/riddance-downhill-bike-shoes/350060001200000013.html' },
  ...
  { id:'sho-shimano-gr7', cat:'shoes', brand:'Shimano', model:'GR7 (SH-GR701)', price:130, weight:800,
    soleType:'flat', closure:'lace', disciplines:['trail','enduro'], sizes:['39','40','41','42','43','44','45','46','47'],
    status:'discontinued',
    desc:'Michelin rubber flat sole, gravity/trail shoe. Weight per pair (approx). Checked 2026-07-17 (kit-fanout-2): SH-GR701 (2020/2021 lineup) is absent from ride.shimano.com\'s current Gravity collection (only GE900/GE700/GE500/GF400 remain) and bike.shimano.com\'s own "Shimano\'s New Gravity Footwear Family" article confirms the GE/GF line replaced the prior GR-series flats. Flagged discontinued/superseded (likely successor: GF400 flat-pedal shoe); price/weight left as prior sample, not re-verified.' },
  { id:'sho-shimano-xc5', cat:'shoes', brand:'Shimano', model:'XC5 (SH-XC502)', price:175, weight:660,
    soleType:'clipless', closure:'boa', disciplines:['xc','trail'], sizes:['39','40','41','42','43','44','45','46','47'],
    desc:'2-bolt SPD clipless XC/trail shoe, Boa L6 dial. Verify pass (kit-fanout-2, 2026-07-17): fetched ride.shimano.com/products/sh-xc502 - CORRECTS price $100 -> $175 and closure velcro -> boa (single Boa L6 dial confirmed on the page, no velcro strap on the current SKU). No weight published; kept as sample (kit weight policy: never blocks verification).',
    verified:true, lastChecked:'2026-07-17', source:'https://ride.shimano.com/products/sh-xc502' },
  { id:'sho-shimano-me502', cat:'shoes', brand:'Shimano', model:'ME5 (SH-ME502)', price:120, weight:820,
    ...
    status:'discontinued',
    desc:'2-bolt SPD clipless trail/enduro shoe. Weight per pair (approx). Checked 2026-07-17 (kit-fanout-2): no ride.shimano.com page found for SH-ME502 (only ME702/ME502 predecessor listings on third-party retailers, 2021-2023 model years cited); the current site\'s ME-line entry is SH-ME702. Flagged discontinued/superseded by ME702; price/weight left as prior sample, not re-verified.' },
  ...
  { id:'sho-giro-chamber-2', cat:'shoes', brand:'Giro', model:'Chamber II', price:149.95, weight:1020,
    ...
    desc:'VERIFIED 2026-07-17 via bdata-rendered giro.com: MSRP $149.95 confirmed; "Certifications & Weight"'
      + ' panel states 510 grams (size 43) per shoe, so 1020g/pair (was sample 900g). 10mm cleat-setback,'
      + ' clipless gravity/DH shoe, laced closure.',
    verified:true, lastChecked:'2026-07-17', source:'https://www.giro.com/p/chamber-ii-downhill-bike-shoes/350060001200000006.html' },
  ...
  { id:'sho-shimano-am9', cat:'shoes', brand:'Shimano', model:'AM9 (SH-AM902)', price:230, weight:900,
    ...
    status:'discontinued',
    desc:'Gravity/DH clipless shoe, dual BOA dials. Weight per pair (approx). Checked 2026-07-17 (kit-fanout-2): SH-AM902 (2020/2021 lineup) is absent from ride.shimano.com\'s current Gravity collection; bike.shimano.com\'s "Shimano\'s New Gravity Footwear Family" article confirms the GE900/GE700/GE500 line replaced the prior AM-series clipless shoes. Flagged discontinued/superseded (likely successor: GE900); price/weight left as prior sample, not re-verified.' },
  { id:'sho-shimano-am7', cat:'shoes', brand:'Shimano', model:'AM7 (SH-AM702)', price:170, weight:850,
    ...
    status:'discontinued',
    desc:'Enduro/gravity clipless shoe. Weight per pair (approx). Checked 2026-07-17 (kit-fanout-2): SH-AM702 (2020/2021 lineup) is absent from ride.shimano.com\'s current Gravity collection; superseded by the GE700 per bike.shimano.com\'s gravity-footwear-family article. Price/weight left as prior sample, not re-verified.' },
  { id:'sho-shimano-ge7', cat:'shoes', brand:'Shimano', model:'GE7 (SH-GE700)', price:190, weight:900,
    soleType:'flat', closure:'lace', disciplines:['enduro','dh'], sizes:['39','40','41','42','43','44','45','46','47'],
    desc:'Gravity flat pedal shoe. Weight per pair (approx). Verify pass (kit-fanout-2, 2026-07-17): fetched ride.shimano.com/products/sh-ge700 - CORRECTS price $150 -> $190. No weight published; kept as sample (kit weight policy: never blocks verification).',
    verified:true, lastChecked:'2026-07-17', source:'https://ride.shimano.com/products/sh-ge700' },
  { id:'sho-shimano-gr9', cat:'shoes', brand:'Shimano', model:'GR9 (SH-GR901)', price:200, weight:800,
    ...
    status:'discontinued',
    desc:'Premium gravity flat shoe, BOA closure. Weight per pair (approx). Checked 2026-07-17 (kit-fanout-2): SH-GR901 (2020/2021 lineup) is absent from ride.shimano.com\'s current Gravity collection; superseded by the GE900/GF400 line per bike.shimano.com\'s gravity-footwear-family article. Price/weight left as prior sample, not re-verified.' },
  ...
  { id:'jsy-fox-flexair-pro-ls', cat:'jersey', brand:'Fox', model:'Flexair Pro Long Sleeve Jersey', price:75, weight:155,
    sleeve:'long', sizes:['S','M','L','XL','XXL'], disciplines:['trail','enduro'],
    desc:'Polartec Delta cooling panel + Dyneema shoulder abrasion reinforcement. UNVERIFIED 2026-07-17: no "Flexair Pro Long Sleeve Jersey" found in the current 106-item mtb-jerseys listing (only base "Flexair"/"Flexair Long Sleeve" tiers remain) and the last-known product-page URL (28865.html) now 404s - likely discontinued/renamed. Left as prior sample, not fabricated or marked discontinued on this evidence alone.' },
  { id:'jsy-fox-ranger-ss', cat:'jersey', brand:'Fox', model:'Ranger Jersey', price:45, weight:130,
    sleeve:'short', sizes:['S','M','L','XL','XXL'],
    desc:'UNVERIFIED 2026-07-17: no plain "Ranger Jersey" SS found in the current 106-item mtb-jerseys listing - only "Ranger TruDri Jersey" ($69.95), "Ranger Woven Jersey" ($99.95), "Ranger Jersey Tactile"/"Ranger Jersey Image Print" ($64.95 each) variants remain, none an unambiguous match for this plain-name row. Left as prior sample, not fabricated or marked discontinued on this weak evidence alone.' },
  { id:'jsy-fox-ranger-foxguard-ls', cat:'jersey', brand:'Fox', model:'Ranger Foxguard Jersey', price:70, weight:190,
    sleeve:'long', sizes:['S','M','L','XL','XXL'], disciplines:['trail','enduro'], desc:'Integrated elbow-guard-compatible sleeve construction. UNVERIFIED 2026-07-17: no "Ranger Foxguard Jersey" found anywhere in the current 106-item mtb-jerseys listing - likely discontinued/renamed. Left as prior sample, not fabricated or marked discontinued on this evidence alone.' },
  ...
  { id:'jsy-shimano-explorer-ss', cat:'jersey', brand:'Shimano', model:'Explorer SS', price:60, weight:145,
    sleeve:'short', sizes:['S','M','L','XL','XXL'], disciplines:['trail'],
    desc:'Checked 2026-07-17 (kit-fanout-2): no current ride.shimano.com jersey named "Explorer" was found; a 2021-era "Explorer Collection" existed (bikeperfect.com) with jerseys named Myoka/Kita, not "Explorer", and a Brazilian retailer lists an "Explore Jersey MS21M" (different spelling) with no confirmed price. Left unverified - identity/naming could not be pinned to a current SKU, not fabricated.' },
  ...
  { id:'ewr-fox-main-glasses', cat:'eyewear', brand:'Fox', model:'Main Sunglasses', price:150, weight:28,
    type:'glasses', sizes:['OSFA'],
    desc:'UNVERIFIED 2026-07-17: foxracing.com has no dedicated sunglasses category (/sunglasses/ 404s) and no "Main Sunglasses" SKU was found anywhere on the site this session - Fox appears to have exited direct-to-consumer sunglasses (third-party retailers still list old "The Moter"-family Fox sunglasses, a different product line). Likely discontinued; left as prior sample, not fabricated or marked discontinued on this evidence alone.' },

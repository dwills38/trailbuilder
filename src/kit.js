...
var KIT_PARTS = [
  ...
  { id:'sho-alpinestars-mesa', cat:'shoes', brand:'Alpinestars', model:'Mesa', price:150, weight:800,
    soleType:'flat', closure:'lace', disciplines:['trail','enduro'], sizes:['39','40','41','42','43','44','45','46','47'],
    desc:'Trail/enduro flat pedal shoe. Weight per pair (approx). PROVENANCE CONCERN (2026-07-16 recheck): could not confirm this product exists under this name - alpinestars.com/products/mesa-shoes 404s, the MTB nav has no footwear category, mountain-bike-past-collections lists no shoe SKUs, and "Mesa" only turns up as an Alpinestars shorts/jersey line, never a shoe, in any retailer or review search. Left unchanged (no source to correct against) but flagged for coordinator review - may be miscatalogued.' },
  { id:'sho-alpinestars-drop-pro', cat:'shoes', brand:'Alpinestars', model:'Drop Pro', price:130, weight:820,
    soleType:'flat', closure:'lace', disciplines:['trail','enduro'], sizes:['39','40','41','42','43','44','45','46','47'],
    desc:'Mid-tier flat pedal shoe. Weight per pair (approx). PROVENANCE CONCERN (2026-07-16 recheck): could not confirm this product exists under this name - alpinestars.com/products/drop-pro-shoes 404s, the MTB nav has no footwear category, and "Drop Pro" only turns up as an Alpinestars shorts/gloves line, never a shoe, in any retailer or review search. Left unchanged (no source to correct against) but flagged for coordinator review - may be miscatalogued.' },
  ...
  { id:'jsy-troyleedesigns-flowline', cat:'jersey', brand:'Troy Lee Designs', model:'Flowline SS', price:65, weight:145,
    sleeve:'short', sizes:['S','M','L','XL','XXL'],
    desc:'Corrected price ($45 sample -> $65 fetched regular price, troyleedesigns.com/products/sp24-flowline-ss-jersey-confined-black). No weight published on the page (145g is an unverified sample figure).' },
  ...
  { id:'jsy-troyleedesigns-skyline-ls', cat:'jersey', brand:'Troy Lee Designs', model:'Skyline LS', price:95, weight:180,
    sleeve:'long', sizes:['S','M','L','XL','XXL'],
    desc:'Corrected price ($88 sample -> $95 fetched regular price, troyleedesigns.com/products/sp24-skyline-ls-jersey-iconic-black). No weight published on the page (180g is an unverified sample figure).' },
  { id:'jsy-troyleedesigns-skylineair-ss', cat:'jersey', brand:'Troy Lee Designs', model:'Skyline Air SS', price:83, weight:130,
    sleeve:'short', sizes:['S','M','L','XL','XXL'], desc:'Warm-weather knit, more open mesh than the standard Skyline. Corrected price ($70 sample -> $83 fetched regular price, troyleedesigns.com/products/sp24-skyline-air-ss-jersey-sram-roots-cement). No weight published on the page (130g is an unverified sample figure).' },
  ...
  { id:'jsy-leatt-mtbgravity-ls', cat:'jersey', brand:'Leatt', model:'MTB Gravity 4.0 LS', price:51.99, weight:180,
    sleeve:'long', sizes:['S','M','L','XL','XXL','3XL'], disciplines:['enduro','dh'], status:'discontinued',
    desc:'CORRECTED 2026-07-16: fetched us.leatt.com prices Jersey MTB Gravity 4.0 at $51.99, sizes S-3XL, tagged Obsolete; the page does not explicitly state long vs short sleeve so `sleeve` stays prior sample (unconfirmed). No weight published there, stays prior sample.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/jersey-mtb-gravity-4-0-sale' },
  ...
  { id:'jsy-leatt-mtbtrail-ls', cat:'jersey', brand:'Leatt', model:'MTB Trail 3.0 LS', price:45.49, weight:165,
    sleeve:'short', sizes:['XS','S','M','L','XL','XXL','3XL'], disciplines:['trail'], status:'discontinued',
    desc:'CORRECTED 2026-07-16: fetched us.leatt.com describes Jersey MTB Trail 3.0 as a short-sleeve chest-zip jersey (sleeve long->short - the "LS" in the model name does not match a real long-sleeve SKU), priced $45.49, sizes XS-3XL, tagged Obsolete. No weight published there, stays prior sample.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/jersey-mtb-trail-3-0-sale' },
  ...
  { id:'jsy-poc-air-ss', cat:'jersey', brand:'POC', model:'Air Jersey SS', price:110, weight:120,
    sleeve:'short', sizes:['S','M','L','XL','XXL'],
    desc:'75gsm ultra-lightweight mesh fabric (per pocsports.com fabric spec). Fetched poc.com (men\'s, EUR site; sleeve length not stated on either the men\'s or women\'s page content pulled): corrected price $100 -> $110 (matches both the EUR list price and the US women\'s pre-sale price) and added the missing XXL size. Garment weight in grams still unpublished (only the 75gsm fabric spec is given), so this stays unverified.' },
  ...
  { id:'jsy-poc-essentialdh-ls', cat:'jersey', brand:'POC', model:'Essential DH LS', price:110, weight:180,
    sleeve:'long', sizes:['XS','S','M','L','XL','XXL'], disciplines:['dh'],
    desc:'Raglan-sleeve DH jersey designed to work with POC VPD body armor. Re-fetched poc.com/en-us (a real US listing exists after all): corrected price to the confirmed USD regular price $110.00 (page showed a 40%-off $66 sale price) and sizes to the full XS-XXL run. Weight still unpublished, stays a sample - so this stays unverified.' },
  ...
  { id:'jsy-alpinestars-drop-ss', cat:'jersey', brand:'Alpinestars', model:'Drop 6.0 SS', price:59.95, weight:135,
    sleeve:'short', sizes:['S','M','L','XL','XXL'],
    desc:'Weight is an approx sample figure - alpinestars.com does not publish a weight. Price corrected to the fetched maker MSRP (was $45).' },
  ...
  { id:'jsy-yeticycles-turqair-ss', cat:'jersey', brand:'Yeti Cycles', model:'Turq Air Jersey SS', price:75, weight:130,
    sleeve:'short', sizes:['S','M','L','XL','XXL'], disciplines:['trail'],
    desc:'Checked 2026-07-16: yeticycles.com confirms sizes XS-XXL (SM/MD/LG abbreviated) but shows no price - Yeti sells apparel through dealers only and every size is listed Not Available/Find A Dealer on the maker\'s own site right now, so no live MSRP to verify against. Price/weight stay prior sample.' },
  ...
  { id:'sht-troyleedesigns-ruckus', cat:'shorts', brand:'Troy Lee Designs', model:'Ruckus Short', price:140, weight:260,
    liner:false, disciplines:['trail'], sizes:['28','30','32','34','36','38'],
    desc:'Corrected price ($65 sample -> $140 fetched regular price for the Ruckus Short Shell, troyleedesigns.com/products/sp25-ruckus-short-shell-mono-steel-blue). No weight published (260g is an unverified sample figure).' },
  ...
  { id:'sht-leatt-mtbenduro3', cat:'shorts', brand:'Leatt', model:'MTB Enduro 3.0 Short', price:64.99, weight:320,
    liner:false, disciplines:['enduro'], sizes:['XS','S','M','L','XL','XXL'], status:'discontinued',
    desc:'CORRECTED 2026-07-16: fetched us.leatt.com prices Shorts MTB Enduro 3.0 at $64.99, sizes XS-XXL, tagged Obsolete. No weight published there, stays prior sample.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/shorts-mtb-enduro-3-0-sale' },
  ...
  { id:'sht-poc-resistanceultra', cat:'shorts', brand:'POC', model:'Resistance Ultra MTB Shorts', price:150, weight:290,
    liner:false, disciplines:['enduro'], sizes:['XS','S','M','L','XL','XXL'],
    desc:'Fetched poc.com: price $150 confirmed exactly, sizes corrected to the full XS-XXL run. Weight not published on the maker page, stays a sample - so this stays unverified.' },
  ...
  { id:'sht-alpinestars-drop6', cat:'shorts', brand:'Alpinestars', model:'Drop 6.0 Shorts', price:99.95, weight:290,
    liner:false, disciplines:['enduro'], sizes:['28','30','32','34','36','38','40'],
    desc:'Weight is an approx sample figure - alpinestars.com does not publish a weight or state liner presence. Price+sizes corrected against the fetched maker page (was $100, sizes stopped at 38).' },
  ...
  { id:'sht-yeticycles-enduro', cat:'shorts', brand:'Yeti Cycles', model:'Enduro Short', price:130, weight:290,
    liner:false, disciplines:['enduro'], sizes:['S','M','L','XL','XXL'],
    desc:'Race-team short (Yeti/Fox Factory) built for lightweight, full-day durability; 13in inseam, 88% recycled nylon/12% spandex. Checked 2026-07-16: yeticycles.com confirms sizes S-XXL but shows no price (dealer-only sales, currently Not Available on the maker\'s own site). Price/weight stay prior sample.' },
  ...
  { id:'pnt-fox-defend', cat:'pants', brand:'Fox', model:'Defend Pant', price:150, weight:430,
    liner:false, disciplines:['trail','enduro'], sizes:['28','30','32','34','36','38'] },
  { id:'pnt-troyleedesigns-sprint', cat:'pants', brand:'Troy Lee Designs', model:'Sprint Pant', price:165, weight:470,
    liner:false, disciplines:['trail','enduro'], sizes:['28','30','31','32','33','34','36','38','40'],
    desc:'Corrected price ($130 sample -> $165 fetched regular price, troyleedesigns.com/products/sp23-sprint-pant-mono-black) and sizes to the maker\'s full run. No weight published (470g is an unverified sample figure).' },
  ...
  { id:'pnt-dharco-gravity', cat:'pants', brand:'Dharco', model:'Gravity Pant', price:150, weight:440,
    liner:false, disciplines:['enduro','dh'], sizes:['S','M','L','XL','2XL','3XL'],
    desc:'Checked 2026-07-16: fetched dharco.com/products/mens-mtb-gravity-pants-black (95% nylon/5% spandex, water-resistant, Bluesign-approved fabric) confirms sizes S-3XL but the site is AUD-only (AUD$189.95; no working /en-us/ market path, US retailers 403d on fetch) with no manufacturer USD MSRP found, so price/weight stay prior USD sample rather than a converted figure.' },
  ...
  { id:'pnt-troyleedesigns-skyline', cat:'pants', brand:'Troy Lee Designs', model:'Skyline Pant', price:165, weight:440,
    liner:false, disciplines:['trail'], sizes:['28','30','32','34','36','38','40'],
    desc:'Corrected price ($150 sample -> $165 fetched regular price, troyleedesigns.com/products/sp23-skyline-pant-mono-black) and sizes to the maker\'s full run. No weight published (440g is an unverified sample figure).' },
  ...
  { id:'pnt-leatt-gravity-4', cat:'pants', brand:'Leatt', model:'MTB Gravity 4.0 Pant', price:144, weight:450,
    liner:false, disciplines:['enduro','dh'], sizes:['XS','S','M','L','XL','XXL'],
    desc:'CORRECTED 2026-07-16: fetched us.leatt.com (Current, non-Obsolete) prices this at $144.00, sizes XS-XXL. No trustworthy weight published (only an XS-only 360g figure that repeats identically across unrelated pant models, smelling like a Shopify placeholder), so weight stays prior sample.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/pant-mtb-gravity-4-0' },
  { id:'pnt-leatt-gravity-8', cat:'pants', brand:'Leatt', model:'MTB Gravity 8.0 Pant', price:175, weight:470,
    liner:false, disciplines:['enduro','dh'], sizes:['XS','S','M','L','XL','XXL'],
    desc:'Fetched us.leatt.com (Current, non-Obsolete) confirms $175-199 by colorway (base $175 matches prior sample) and sizes XS-XXL; developed with the Pivot Factory Racing DH team. No weight published there, stays prior sample.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/pants-mtb-gravity-8-0' },
  { id:'pnt-leatt-hydradri-3', cat:'pants', brand:'Leatt', model:'MTB HydraDri 3.0 Pant', price:164, weight:420,
    liner:false, disciplines:['trail','enduro'], sizes:['XS','S','M','L','XL','XXL'],
    desc:'2.5L waterproof/breathable shell, 20,000mm/20,000g² rating. Fetched us.leatt.com (Current, non-Obsolete) confirms the $164.00 price and sizes XS-XXL. No weight published there, stays prior sample.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/pant-mtb-hydradri-3-0' },
  { id:'pnt-leatt-hydradri-5', cat:'pants', brand:'Leatt', model:'MTB HydraDri 5.0 Pant', price:263, weight:460,
    liner:false, disciplines:['trail','enduro'], sizes:['XS','S','M','L','XL','XXL'],
    desc:'3-layer waterproof/breathable shell, 30,000mm/30,000g² rating. CORRECTED 2026-07-16: fetched us.leatt.com (Current, non-Obsolete) prices this at $263-264 by colorway, sizes XS-XXL. No trustworthy weight published (only an XS-only 360g figure that repeats identically across unrelated pant models, smelling like a Shopify placeholder), so weight stays prior sample.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/pant-mtb-hydradri-5-0' },
  { id:'pnt-leatt-enduro-3', cat:'pants', brand:'Leatt', model:'MTB Enduro 3.0 Pant', price:83.85, weight:400,
    liner:false, disciplines:['enduro'], sizes:['XS','S','M','L','XL','XXL'], status:'discontinued',
    desc:'CORRECTED 2026-07-16: fetched us.leatt.com prices this at $83.85, sizes XS-XXL, tagged Obsolete with every variant out of stock. No weight published there, stays prior sample.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/pant-mtb-enduro-3-0-sale' },
  { id:'pnt-leatt-trail-2', cat:'pants', brand:'Leatt', model:'MTB Trail 2.0 Pant', price:87.99, weight:380,
    liner:false, disciplines:['trail'], sizes:['XS','S','M','L','XL','XXL'],
    desc:'Fetched us.leatt.com (Current, non-Obsolete) confirms $87.99-89.99 by colorway (matches prior sample) and sizes XS-XXL. No weight published there, stays prior sample.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/pant-mtb-trail-2-0' },
  { id:'pnt-leatt-trail-8-cargo', cat:'pants', brand:'Leatt', model:'MTB Trail 8.0 Cargo Pant', price:164, weight:410,
    liner:false, disciplines:['trail'], sizes:['XS','S','M','L','XL','XXL'],
    desc:'Fetched us.leatt.com (Current, non-Obsolete) confirms $164-169 by colorway (matches prior sample) and sizes XS-XXL; integrated rear "Mission Pack" storage. No weight published there, stays prior sample.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/pant-mtb-trail-8-0-cargo' },
  { id:'pnt-leatt-allmtn-4', cat:'pants', brand:'Leatt', model:'MTB AllMtn 4.0 Pant', price:116.35, weight:430,
    liner:false, disciplines:['trail','enduro'], sizes:['S','M','L','XL','XXL'], status:'discontinued',
    desc:'CORRECTED 2026-07-16: fetched us.leatt.com prices this at $116.35, tagged Obsolete with every variant out of stock. No weight published there, stays prior sample.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/pant-mtb-allmtn-4-0-sale' },
  ...
  { id:'pnt-alpinestars-drop', cat:'pants', brand:'Alpinestars', model:'Drop Pants', price:149.95, weight:400,
    liner:false, disciplines:['trail','enduro'], sizes:['28','30','32','34','36','38','40'],
    desc:'Weight is an approx sample figure - alpinestars.com does not publish a weight or state liner presence. Price+sizes corrected against the fetched maker page (was $140, sizes stopped at 38).' },
  ...
  { id:'glv-troyleedesigns-ace', cat:'gloves', brand:'Troy Lee Designs', model:'Ace 2.0', price:47, weight:60, sizes:['S','M','L','XL','XXL'],
    desc:'Corrected price ($40 sample -> $47 fetched regular price, troyleedesigns.com/products/sp25-ace-2-0-glove-solid-turquoise) and sizes to the maker\'s SM-2X run. No weight published (60g is an unverified sample figure).' },
  ...
  { id:'glv-troyleedesigns-air', cat:'gloves', brand:'Troy Lee Designs', model:'Air Glove', price:43, weight:55,
    sizes:['S','M','L','XL','XXL'], desc:'Corrected price ($30 sample -> $43 fetched regular price, troyleedesigns.com/products/sp25-air-glove-mono-black). Weight per pair (approx, no weight published).' },
  { id:'glv-troyleedesigns-gambit', cat:'gloves', brand:'Troy Lee Designs', model:'Gambit Glove', price:65, weight:110,
    disciplines:['enduro','dh'], sizes:['S','M','L','XL','XXL'], desc:'Padded gravity/DH-oriented glove with D3O knuckle armor. Corrected price ($50 sample -> $65 fetched regular price, troyleedesigns.com/products/20s-gambit-glove-solid-black). Weight per pair (approx, no weight published).' },
  { id:'glv-troyleedesigns-flowline', cat:'gloves', brand:'Troy Lee Designs', model:'Flowline Glove', price:35, weight:60,
    sizes:['S','M','L','XL','XXL'], desc:'Corrected price ($28 sample -> $35 fetched regular price, troyleedesigns.com/products/sp24-flowline-glove-mono-black). Weight per pair (approx, no weight published).' },
  ...
  { id:'glv-dakine-crossx', cat:'gloves', brand:'Dakine', model:'Cross-X Glove', price:40, weight:70,
    sizes:['XS','S','M','L','XL','XXL'], desc:'Weight per pair (approx, unconfirmed -- not stated on the maker page). Price and sizes corrected from the fetched dakine.com product page (dakine.com/products/cross-x-bike-glove): $40.00, sizes XS-XXL.' },
  ...
  { id:'glv-dakine-boundary', cat:'gloves', brand:'Dakine', model:'Boundary Bike Glove', price:35, weight:68,
    sizes:['XS','S','M','L','XL','XXL'], desc:'Weight per pair (approx, unconfirmed -- not stated on the maker page). Price and sizes corrected from the fetched dakine.com product page (dakine.com/products/boundary-bike-glove): $35.00 regular price (some colorways $40/$55), sizes XS-XXL in black.' },
  { id:'glv-dakine-synclinegel', cat:'gloves', brand:'Dakine', model:'Syncline Gel Bike Glove', price:40, weight:72,
    sizes:['XS','S','M','L','XL'], desc:'Weight per pair (approx, unconfirmed -- not stated on the maker page). Price and sizes corrected from the fetched dakine.com product page (dakine.com/products/syncline-gel-bike-glove): $40.00 regular price, sizes XS-XL (no XXL currently offered).' },
  { id:'glv-dakine-covert', cat:'gloves', brand:'Dakine', model:'Covert Bike Glove', price:25, weight:60,
    fitCut:'womens', sizes:['XS','S','M','L','XL'], desc:'Weight per pair (approx, unconfirmed -- not stated on the maker page). Price and sizes corrected from the fetched dakine.com product page (dakine.com/products/covert-bike-glove-womens): $25.00, sizes XS-XL (adds XL).' },
  { id:'glv-dakine-crossx2', cat:'gloves', brand:'Dakine', model:'Cross-X 2.0 Bike Glove', price:40, weight:68,
    sizes:['XS','S','M','L','XL'], desc:'Weight per pair (approx, unconfirmed -- not stated on the maker page). Price and sizes corrected from the fetched dakine.com product page (dakine.com/products/cross-x-2-0-bike-glove): $40.00, sizes XS-XL (no XXL currently offered).' },
  { id:'glv-dakine-vectra2', cat:'gloves', brand:'Dakine', model:'Vectra 2.0 Bike Glove', price:35, weight:75,
    sizes:['S','M','L','XL'], desc:'Weight per pair (approx, unconfirmed -- not stated on the maker page). Price and sizes corrected from the fetched dakine.com product page (dakine.com/products/vectra-2-0-bike-glove): $35.00, sizes S-XL (no XXL currently offered).' },
  { id:'glv-dakine-syncline', cat:'gloves', brand:'Dakine', model:'Syncline Bike Glove', price:25, weight:65,
    sizes:['XS','S','M','L','XL'], desc:'Weight per pair (approx, unconfirmed -- not stated on the maker page). Price and sizes corrected from the fetched dakine.com product page (dakine.com/products/syncline-bike-glove): $25.00, sizes XS-XL (no XXL currently offered).' },
  ...
  { id:'glv-alpinestars-drop4', cat:'gloves', brand:'Alpinestars', model:'Drop 4.0 Glove', price:34.95, weight:65,
    sizes:['S','M','L','XL','XXL','XXXL'],
    desc:'Weight per pair (approx). Price+sizes corrected against the fetched maker page (was $35, sizes stopped at XXL - the maker also offers XXXL).' },
  ...
  { id:'glv-troyleedesigns-luxe', cat:'gloves', brand:'Troy Lee Designs', model:'Luxe Glove', price:40, weight:58,
    sizes:['S','M','L','XL','XXL'], desc:'Corrected price ($32 sample -> $39.99 fetched regular price rounded to $40, troyleedesigns.com/products/sp22-womens-luxe-solid-glove-black); TLD sells this as a womens-specific glove. Weight per pair (approx, no weight published).' },
  ...
  { id:'knp-troyleedesigns-speed', cat:'kneepad', brand:'Troy Lee Designs', model:'Speed Knee Sleeve', price:69, weight:300,
    disciplines:['trail','enduro'], sizes:['XS/SM','MD/LG','XL/2XL'],
    desc:'Corrected price ($60 sample -> $69 fetched regular price, troyleedesigns.com/products/speed-knee-sleeve-black) and sizes to the maker\'s labels. No cert standard or weight published on the page (300g remains an unverified sample figure).' },
  ...
  { id:'knp-troyleedesigns-stage', cat:'kneepad', brand:'Troy Lee Designs', model:'Stage Knee Guard', family:'troyleedesigns-stage', price:112, weight:380,
    disciplines:['enduro','dh'], sizes:['XS/SM','M/L','XL/2XL'],
    desc:'Heavier-duty sibling of the Speed Knee Sleeve above. Corrected price ($90 sample -> $112 fetched regular price, troyleedesigns.com/products/20s-stage-knee-guards-black) and sizes to the maker\'s labels. No cert standard or weight published on the page (380g remains an unverified sample figure).' },
  ...
  { id:'elp-troyleedesigns-speed-sleeve', cat:'elbowpad', brand:'Troy Lee Designs', model:'Speed Elbow Sleeve', price:49, weight:120,
    disciplines:['trail','enduro'], sizes:['XS/SM','MD/LG','XL/2X'],
    desc:'Slip-on sleeve, foam padding. Corrected price ($45 sample -> $49 fetched regular price, troyleedesigns.com/products/speed-elbow-sleeve-black) and sizes to the maker\'s labels. No cert standard or weight published on the page (120g remains an unverified sample figure).' },
  { id:'elp-troyleedesigns-stage', cat:'elbowpad', brand:'Troy Lee Designs', model:'Stage Elbow Guard', price:100, weight:200,
    ...
    desc:'D3O pad, sleeve construction. Weight per pair (approx - not stated on the fetched page). MSRP ($100) and sizes re-confirmed via fetched troyleedesigns.com/products/20s-stage-elbow-guards-black on 2026-07-16 (unchanged from prior check); still unverified since no cert standard or trustworthy weight is published.', source:'https://troyleedesigns.com/products/20s-stage-elbow-guards-black', lastChecked:'2026-07-16' },
  ...
  { id:'arm-troyleedesigns-rockfight-ce', cat:'bodyarmor', brand:'Troy Lee Designs', model:'Rockfight CE', price:195, weight:450,
    coverage:'chest', disciplines:['enduro','dh'], sizes:['XS/SM','MD/LG','XL/2X'],
    desc:'Corrected price ($150 sample -> $195 fetched regular price, troyleedesigns.com/products/rockfight-ce-chest-protector-black) and sizes to the maker\'s labels. Maker states a CE EN14021 Stone Shield front plate and a D3O back insert exceeding "CE EN1621 Level 1" without naming the exact -2/-3 sub-standard, so no `certs` token is asserted (would be a guess). No weight published (450g remains an unverified sample figure).' },
  ...
  { id:'nkb-leatt-gpx-55', cat:'neckbrace', brand:'Leatt', model:'GPX 5.5 Neck Brace', price:203.99, weight:600,
    disciplines:['dh'], sizes:['S/M','L/XL'], status:'discontinued',
    desc:'Composite flagship brace. CORRECTED 2026-07-16: fetched us.leatt.com prices this SKU $203.99 (Black) to $272.35 (Blue/Citrus/Forge) by colorway, tagged Obsolete with every variant out of stock and no published weight - the prior $461/$474 figures don\'t match any colorway on the live page and are dropped. Price set to the Black-colorway figure as the representative sample; weight stays prior sample; stays unverified.',
    lastChecked:'2026-07-16', source:'https://us.leatt.com/products/neck-brace-5-5-sale' },
  ...
  { id:'ewr-bolle-shifter', cat:'eyewear', brand:'Bolle', model:'Shifter', price:149, weight:30,
    type:'glasses', sizes:['OSFA'],
    desc:'Checked 2026-07-16: bolle.com returns 403 Forbidden on every product URL tried (bot-walled, like Shimano/Pinkbike elsewhere in this catalog). Price is corroborated by multiple retailers (Sport Eyes $140, Incycle C-Shifter variant $170) as in the right range - kept unchanged, still unverified.' },
  { id:'ewr-bolle-chronoshield', cat:'eyewear', brand:'Bolle', model:'Chronoshield', price:199, weight:34,
    type:'glasses', sizes:['OSFA'],
    desc:'Checked 2026-07-16: bolle.com returns 403 Forbidden on every product URL tried (bot-walled). Retailer prices vary widely by lens tier ($154-$230+), consistent with the catalog\'s $199 sample - kept unchanged, still unverified.' },
  ...
  { id:'ewr-blenderseyewear-echo', cat:'eyewear', brand:'Blenders Eyewear', model:'Echo', price:60, weight:28,
    type:'glasses', sizes:['OSFA'],
    desc:'FLAG for coordinator review (2026-07-16): could not confirm an "Echo" sunglasses model exists at Blenders Eyewear at all - not found on blenderseyewear.com (product URL guess 404s, and it does not appear among the Active Sport / Eclipse / Wraparound / Running collections) or via general web search. Possibly discontinued, misnamed, or fabricated - this is the third such case found this cluster (alongside TLD Grind/Roost shoes and Bolle React Air / Alpina Realm Q-Lite goggles). Left as an unverified sample pending a decision to retarget or remove this row.' },
  ...
  { id:'ewr-bolle-reactair', cat:'eyewear', brand:'Bolle', model:'React Air', price:60, weight:130,
    type:'goggles', disciplines:['enduro','dh'], sizes:['OSFA'],
    desc:'FLAG for coordinator review (2026-07-16): could not confirm a "React Air" goggle exists at Bolle at all. Bolle\'s "REACT" name is used for a bike HELMET line (React MIPS, Halo React MIPS, React Visor), not a goggle; no MTB goggle product line matching this name was found anywhere on bolle.com or via retailers. May be confused with the React helmet line or simply fabricated. Left as an unverified sample pending a decision to retarget or remove this row.' },
  ...
  { id:'ewr-alpina-realm-qlite', cat:'eyewear', brand:'Alpina', model:'Realm Q-Lite', price:65, weight:135,
    type:'goggles', disciplines:['enduro','dh'], sizes:['OSFA'],
    desc:'FLAG for coordinator review (2026-07-16): could not confirm a "Realm Q-Lite" goggle exists at Alpina at all. Alpina\'s real MTB goggle lineup is CIRCUS Q-LITE (confirmed: EUR89.95, 230g, "The MTB goggle" per fetched alpina-sports.com page) and SCARABEO MTB - no "Realm" name found on alpina-sports.com or any retailer searched. Possibly a misremembered Circus/Scarabeo row, or fabricated. Left as an unverified sample pending a decision to retarget or remove this row.' },
  { id:'ewr-cratoni-cairy-reflectix', cat:'eyewear', brand:'Cratoni', model:'C-Airy Reflectix', price:55, weight:130,
    type:'goggles', disciplines:['enduro','dh'], sizes:['OSFA'],
    desc:'FLAGGED 2026-07-16: no product named "C-Airy" or "Reflectix" was found anywhere on cratoni.com after fetching the full sport-performance, sport-active and eye-protection catalog pages (real current lineup: C-Matic/C-Lite/C-Ice/C-Active/Skyvision/Futuro/Raw/C-Shade families) - this row may be a fabricated/nonexistent SKU from an earlier data-entry pass rather than a spec error. Left unchanged pending a coordinator call on whether to replace it with a real Cratoni model or retire the id (do not silently delete an append-only id).' },

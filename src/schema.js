...
var VOCAB = {
  ...
  casing:       ['exo', 'exo-plus', 'doubledown', 'dh',            // Maxxis
                 ...
                 'trail-pro',                                       // Schwalbe Magic Mary Radial (catalog-complete-bikes-grind-2-commencal, 2026-07-15, Commencal's own Clash V3 build sheet names "Trail Pro" as the front tire's casing tier - the lighter sibling of 'gravity-pro' in Schwalbe's new radial-carcass generation, confirmed as a real distinct Schwalbe tier name via schwalbetires.com SKU listings (e.g. article 11654597, "TRAIL PRO"))
